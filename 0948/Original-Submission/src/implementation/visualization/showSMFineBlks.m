function showSMFineBlks(sadata, rc)
...
% else
%       figureSize = [scrsz(3)/2-scrsz(4)/4-scrsz(4)/200*40 ...
%           scrsz(4)/2-scrsz(4)/4-scrsz(4)/200*40 ...
%           scrsz(4)/2+scrsz(4)/100*40 ...
%           scrsz(4)/2-30+scrsz(4)/100*40];
% end
