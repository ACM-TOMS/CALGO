...
namespace NOMAD {
  ...
  private:
    ...
    */
    ...
    /**
       ...
       \param new_inc    Pointer to the new incumbent -- \b IN/OUT (may be \c NULL).
       \param signatures List of signatures to update -- \b IN/OUT.
  ...
  public:
    ...
    */
	...
	_cache_search          ( NULL                                 ) ,
	_L_curve               ( NULL                                 ) ,
	_extended_poll         ( extended_poll                        )   { init(); }
