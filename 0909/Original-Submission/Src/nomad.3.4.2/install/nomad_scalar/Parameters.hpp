...
namespace NOMAD {
  ...
  public:
    ...
    /// Constructor #1.
    /**
       From a standard signature.
       \param out Display -- \b IN.
    */
    explicit Parameters ( NOMAD::Display & out )
      : _out              ( out  ) ,
	_std_signature    ( NULL ) ,
    ...
    */
    void help ( int argc , char ** argv ) const;
    ...
    */
    void help ( const std::string & param_name ) const;
    ...
    */
    void help ( const std::list<std::string> & param_names_list ) const;
