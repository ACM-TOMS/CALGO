function test_skewHamildefl_nb
% Function for testing the routine DGHUDP (block code). Random matrices of all
...
%
%   Revisions:
%   V. Sima, July 2013, June 2014, July 2014.
%   M. Voigt, July 2013.
%

disp(' ')
disp('Random tests of the routine DGHUDP')
disp(' ')
...
[ Alphar1,  Alphai1,  Beta1, Q1        ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq1 );
[ Alphar2,  Alphai2,  Beta2            ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq0 );
[ Alphar3,  Alphai3,  Beta3            ] = skewHamildefl_nb( A, DE, B, FG, nb );
[ Alphar4,  Alphai4,  Beta4, Q2, neig1 ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq1, orth0 );
[ Alphar5,  Alphai5,  Beta5, Q3, neig2 ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq1, orth1 );
[ Alphar6,  Alphai6,  Beta6, Q4, neig3 ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq1, orth2 );
%
...
for m = [ 0 : 20, 210 ]
    ...
    for nb = 0 : nbmax,
        for orthm = 0 : 2,
            count = count + 1;
            [ Alphar, Alphai, Beta, Q, neig ] = skewHamildefl_nb( A, DE, B, FG, nb, cmpq1, orthm );
