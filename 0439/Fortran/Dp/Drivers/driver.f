...
c***********************************************************************
c
cc TOMS439_PRB tests TOMS439.
c
      implicit none

      write ( *, '(a)' ) ' '
      write ( *, '(a)' ) 'TOMS439_PRB'
      write ( *, '(a)' ) '  Test TOMS algorithm 439, product-type'
      write ( *, '(a)' ) '  three point Gauss-Legendre Simpson'
      write ( *, '(a)' ) '  integration.'
...
c
      ...
      do n = 1, 10
        call p3pgs ( a, b, n, fn00, gn00, vint )
...
c
     ...
     &      - ( 0.5 * exp ( -a ) * ( sin ( a ) - cos ( a ) ) )
      ...
      do n = 1, 10
        call p3pgs ( a, b, n, gn01, gn02, vint )
        write ( *, '(2x,i6,2x,g14.6)' ) n, vint
      end do
