...
//******************************************************************************
// EquidistPanel class defines a panel for entering and translating parameters
// of "Equidistribution Test".
//******************************************************************************

public class EquidistPanel
       extends ParmGrpPanel
{
   ...
   //***************************************************************************
   // The constructor constructs EquidistPanel with owner <wizard>.
   //---------------------------------------------------------------------------
   public EquidistPanel(TestWizard wizard) {
      // Set up a group panel that will contain two parameter fields.
      super("Equidistribution Test", 2);
      // Set the command line id.
      super.cmdId = "equidist";

      // Create the parameter fields.
      numDivnField = new IntParmField("     Number of Bins",
                                      2, Integer.MAX_VALUE, 100);
      numSampField = new IntParmField("Number of Random Numbers",
                                      1, Integer.MAX_VALUE,1000000);
