...
*     .. Local Scalars ..
      ...
      DOUBLE PRECISION   CS, OVFL, RTEMP, S, SMLNUM, TST1, ULP, UNFL
      COMPLEX*16         CDUM, H00, H10, H11, H11S, H12, H21, H22, H33,
     $                   H33S, H43H34, H44, H44S, SN, SUM, TEMP, T1, T2,
     $                   T3, V1, V2, V3
*     ..
*     .. Local Arrays ..
...
*     .. External Subroutines ..
      EXTERNAL           DLABAD, ZCOPY, ZLANV2, ZLARFG, ZSCAL
*     ..
*     .. Intrinsic Functions ..
...
*           Exceptional shift.
*
C            S = ABS( DBLE( H( I,I-1 ) ) ) + ABS( DBLE( H( I-1,I-2 ) ) )
...
*
               DO 60 J = K, I2
                  SUM = DCONJG( T1 )*H( K, J ) + 
     $               DCONJG( T2 )*H( K+1, J ) + DCONJG( T3 )*H( K+2, J )
                  H( K, J ) = H( K, J ) - SUM
...
*
               DO 61 J = K, I2
                  SUM = DCONJG( T1 )*H( K, J ) + DCONJG(T2)*H( K+1, J )
                  H( K, J ) = H( K, J ) - SUM
                  H( K+1, J ) = H( K+1, J ) - SUM*V2
   61          CONTINUE
*
