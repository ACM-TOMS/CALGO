function[Theta] =  CalculateThetaParameterGK_Weighted(ConsensusRanking,Pop,initialTheta,upperTheta,maxit,W)
% [Theta] =  CalculateThetaParameterGK_Weighted(ConsensusRanking,Pop,initialTheta,upperTheta,maxit,W)
% CalculateThetaParameterGK_Weighted:  Calculates the the Theta Parameter according
% to the given weight W for the generalized Kendall model
%         
% INPUTS
