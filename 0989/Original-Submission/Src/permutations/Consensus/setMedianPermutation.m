function[ConsensusRanking] = setMedianPermutation(DistanceFun,SelPop,NSel)
% [ConsensusRanking] = setMedianPermutation(DistanceFun,SelPop,NSel)
% setMedianPermutation:  Calculates the consensus ranking from permutations
