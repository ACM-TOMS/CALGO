 ...
 Fibbonacci_n = 5; % Fibbonacci_n: Value n for the construction of the Fibbonacci sequence. NumbVar = F(n)
 global HPInitConf;
 ...
 edaparams{1} = {'seeding_method','InitPermutations',{}}; % The initial population is uniquely composed of permutations
 ...
 edaparams{5} = {'stop_cond_method','max_gen',{50}};
