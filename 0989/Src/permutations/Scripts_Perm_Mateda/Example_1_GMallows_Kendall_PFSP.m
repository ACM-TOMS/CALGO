...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  ReadPFSPInstance('../Problems/Instances/PFSP/tai50_20_0');        % PFSP (Taillard Benchmark -> tai50_20_0.fsp, n=50).
 ...
 edaparams{2} = {'learning_method','GMallows_kendall_learning',{0.001,10,100,'setMedianPermutation',0.1}};          % Parameters of the learning algorithm
...
%%%% Run EDA executions and collect optimization statistics, execution times, and the models learn at each generation.
 ...
 fname = ['Results_GMallows_Kendall_PFSP.mat']
