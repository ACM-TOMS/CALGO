...
--   facets of a certain type of the sum of a tuple of polytopes.
  ...
  procedure Enumerate_Vertices ( pts : in Integer_Vectors_of_Vectors.Vector );
  ...
  procedure Enumerate_Edges ( pts : in Integer_Vectors_of_Vectors.Vector );
