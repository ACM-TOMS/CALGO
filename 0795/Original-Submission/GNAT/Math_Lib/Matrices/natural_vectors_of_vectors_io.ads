...
with Natural_Vectors_of_Vectors;       use Natural_Vectors_of_Vectors;

package Natural_Vectors_of_Vectors_io is

 -- DESCRIPTION :
 --   This package contains routines for input and output
 --   of vectors of vectors with natural entries.
  ...
  procedure get ( file : in file_type; n,m : in natural;
   ...
   -- DESCRIPTION :
   --   n natural vectors of dimension m are read from standard input
   --   or from file.
...
end Natural_Vectors_of_Vectors_io;
