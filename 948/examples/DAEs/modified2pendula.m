function f = modified2pendula(t, z, G, L, c)
% f = modified2pendula(t, z, G, L, c) evaluates the modified coupled
% pendula problem, used in Section 5.1 of R. McKenzie, J. Pryce, 
...
f(4) = Dif(u,2)  +u*mu;      % $u'' + u\mu =0$
f(5) = Dif(v,3)^2+v*mu-G;    % $(v''')^2 + v\mu - G = 0$
