      SUBROUTINE CGBTP1( TABSUB, SIDE, NSIDE, UPLO, NUPLO, TRNS, NTRNS,
...
*
*
*  CGBTP1 prints the collected benchmark result which is calculated from
...
*  the mean value of the performance of CGEMM in megaflops. CGEMM is
...
*     .. Parameters ..
      REAL               ZERO
      INTEGER            MXBSUB
      PARAMETER        ( ZERO = 0.0E+0, MXBSUB = 8 )
*     ..
...
*
*
*     Compute the sum of the performance of CGEMM in megaflops (MMSUM)
...
*
 ...
 9010 FORMAT(  1X, 'Error: The collected benchmark result could not ',
     $             'be obtained.',/,
     $         1X, 'Execution time for CGEMM is zero.' )
 ...
 9040 FORMAT(  2X, 'The collected benchmark result is a tuple ',
     ...
     $         2X, 'of CGEMM in megaflops (see the README file). The ',
     $             'benchmark result is',/,
