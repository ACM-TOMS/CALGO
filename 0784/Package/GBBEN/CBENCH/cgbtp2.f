      SUBROUTINE CGBTP2( TAB, TABSUB, SIDE, NSIDE, UPLO, NUPLO, TRNS,
...
*
*
*  CGBTP2 prints tables showing detailed performance results and
...
*     .. Parameters ..
      INTEGER            MXTOTS, LLN
      REAL               ZERO, HUGE
      PARAMETER        ( MXTOTS = 6, LLN = 256, ZERO = 0.0E+0,
     $                   HUGE = 1.0E+10 )
...
*     .. Local Arrays ..
      ...
      REAL               MI( MXTOTS ), MA( MXTOTS ), SU( MXTOTS )
*     ..
...
*
      ...
      WRITE( NOUT, FMT = * )
*
*     Print result tables for CSYMM.
*
      IF( TABSUB( 1 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CSYMM ',
     $                                 '           OPTIONS  = SIDE,UPLO'
         WRITE( NOUT, FMT = * )
...
*
   ...
   50    CONTINUE
      ...
      END IF
*
*     Print result tables for CHEMM.
*
      IF( TABSUB( 2 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CHEMM ',
     $                                 '           OPTIONS  = SIDE,UPLO'
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9110 ) 'M', 'N'
         DO 100, L = 1, NLDA
...
*
  ...
  100    CONTINUE
      ...
      END IF
*
*     Print result tables for CSYRK.
*
      IF( TABSUB( 3 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CSYRK ',
     $                                 '          OPTIONS  = UPLO,TRANS'
         WRITE( NOUT, FMT = * )
...
*
  ...
  150    CONTINUE
      ...
      END IF
*
*     Print result tables for CHERK.
*
      IF( TABSUB( 4 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CHERK ',
     $                                 '          OPTIONS  = UPLO,TRANS'
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9110 ) 'N', 'K'
         DO 200, L = 1, NLDA
...
*
  ...
  200    CONTINUE
      ...
      END IF
*
*     Print result tables for CSYR2K.
*
      IF( TABSUB( 5 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CSYR2K',
     $                                 '          OPTIONS  = UPLO,TRANS'
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9110 ) 'N', 'K'
         DO 250, L = 1, NLDA
...
*
  ...
  250    CONTINUE
      ...
      END IF
*
*     Print result tables for CHER2K.
*
      IF( TABSUB( 6 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CHER2K',
     $                                 '          OPTIONS  = UPLO,TRANS'
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9110 ) 'N', 'K'
         DO 300, L = 1, NLDA
...
*
  ...
  300    CONTINUE
      ...
      END IF
*
*     Print result tables for CTRMM.
*
      IF( TABSUB( 7 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CTRMM ',
...
*
  ...
  370    CONTINUE
      ...
      END IF
*
*     Print result tables for CTRSM.
*
      IF( TABSUB( 8 ) )THEN
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9100 ) 'CTRSM ',
     $                                 'OPTIONS  = SIDE,UPLO,TRANS,DIAG'
         WRITE( NOUT, FMT = * )
         WRITE( NOUT, FMT = 9110 ) 'M', 'N'
         DO 440, L = 1, NLDA
...
*
 ...
 9070 FORMAT( 27X, 'Performance of a user-supplied',/,
     ...
     $        27X, 'CGEMM routine (megaflops).' )
 9080 FORMAT( 22X, 'Performance for the internal GEMM-Based',/,
     $        22X, 'Level 3 BLAS routine Cxxxx (megaflops).',/,
     $         8X, 'GEMM-Ratio = ------------------------------------',
     $             '-----',/,
 ...
 9110 FORMAT( 31X, 'GEMM-      User-', /,
     $        29X,'Based lib  suppl lib   CGEMM      GEMM-    GEMM-', /,
     $         2X, 'OPTIONS       ', A,'      ', A,'      ',
