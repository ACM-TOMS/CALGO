      SUBROUTINE SGB08( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, LDA,
     $                   C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  SGB08 (STRMM) performs one of the matrix-matrix operations
*
...
*     .. User specified parameters for SGB08 ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.SGB90( SIP81, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.SGB90( SIP82, M, N )
                  DO 40, II = 1, M, RCB
                     ISEC = MIN( RCB, M-II+1 )
*
