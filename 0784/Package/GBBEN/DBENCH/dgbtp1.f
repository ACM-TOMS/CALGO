      SUBROUTINE DGBTP1( TABSUB, SIDE, NSIDE, UPLO, NUPLO, TRNS, NTRNS,
...
*
*
*  DGBTP1 prints the collected benchmark result which is calculated from
...
*  the mean value of the performance of DGEMM in megaflops. DGEMM is
...
*     .. Parameters ..
      ...
      INTEGER            MXBSUB
      PARAMETER        ( ZERO = 0.0D+0, MXBSUB = 5 )
*     ..
...
*
*
*     Compute the sum of the performance of DGEMM in megaflops (MMSUM)
...
*
 ...
 9010 FORMAT(  1X, 'Error: The collected benchmark result could not ',
     $             'be obtained.',/,
     $         1X, 'Execution time for DGEMM is zero.' )
 ...
 9040 FORMAT(  2X, 'The collected benchmark result is a tuple ',
     ...
     $         2X, 'of DGEMM in megaflops (see the README file). The ',
     $             'benchmark result is',/,
