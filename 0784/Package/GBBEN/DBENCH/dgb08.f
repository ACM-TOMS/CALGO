      SUBROUTINE DGB08( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, LDA,
     $                   C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  DGB08 (DTRMM) performs one of the matrix-matrix operations
*
...
*     .. User specified parameters for DGB08 ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.DGB90( DIP81, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.DGB90( DIP82, M, N )
                  DO 40, II = 1, M, RCB
                     ISEC = MIN( RCB, M-II+1 )
*
