...
*     .. External Functions ..
      LOGICAL            LSAME, ZBIGP, ZCLD
      EXTERNAL           LSAME, ZBIGP, ZCLD
...
*     .. User specified parameters for ZTRSM ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.ZBIGP( ZIP91, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.ZBIGP( ZIP92, M, N )
