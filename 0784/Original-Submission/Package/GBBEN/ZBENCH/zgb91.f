...
*  system.
*
*  The function ZGB91 returns .TRUE. if the leading dimension LD is
*  critical and .FALSE. if it is not critical. In this implementation
*  ZGB91 is designed to detect critical leading dimensions in an
...
*  It may be rewarding to rewrite ZGB91 for a machine with a different
*  cache policy.
*
...
*
*
*  User specified parameters for ZGB91
*  ================================
*
...
*           considered critical.
*
*  ZP     - Number of bytes in a double complex-precision word.
*
*
...
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MOD
*     .. User specified parameters for ZGB91 ..
      INTEGER            LOLIM, LNSZ, NPRT, PRTSZ, ZP
      PARAMETER        ( LNSZ = 64, NPRT = 128, PRTSZ = 3,
     $                   LOLIM = 32, ZP = 16 )
*     .. Parameters ..
      INTEGER            ONEWAY, MXDIF
      PARAMETER        ( ONEWAY = ( LNSZ*NPRT )/ZP,
     $                   MXDIF = LNSZ/( ZP*PRTSZ ) )
*     ..
...
*
      ...
      ELSE
         ...
         ZGB91 = MIN( UPDIF, LD-UPDIF ).LE.MXDIF
      END IF
*
      RETURN
*
