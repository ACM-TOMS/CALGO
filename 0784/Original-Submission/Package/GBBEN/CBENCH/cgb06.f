      SUBROUTINE CGB06 ( UPLO, TRANS, N, K, ALPHA, A, LDA, B, LDB,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB06 (CSYR2K)  performs one of the symmetric rank 2k operations
*
...
*     .. Parameters ..
     ...
     $                   ZERO = ( 0.0E+0, 0.0E+0 ) )
*     .. User specified parameters for CGB06  ..
      INTEGER            RCB, CB
