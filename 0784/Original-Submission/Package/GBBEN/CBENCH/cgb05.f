      SUBROUTINE CGB05 ( UPLO, TRANS, N, K, ALPHA, A, LDA,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB05 (CHERK)  performs one of the hermitian rank k operations
*
...
*     .. Parameters ..
     ...
     $                   CONE = ( 1.0E+0, 0.0E+0 ),
     $                   CIP51 = 51, CIP52 = 52 )
*     .. User specified parameters for CGB05 ..
      INTEGER            RB, CB, RCB
...
*
            SMALLN = .NOT.CGB90( CIP51 , N, K )
            IF( SMALLN )THEN
               TINYK = .NOT.CGB90( CIP52 , N, K )
               DO 90, II = 1, N, RCB
                  ISEC = MIN( RCB, N-II+1 )
*
