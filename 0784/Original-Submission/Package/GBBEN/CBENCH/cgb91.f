...
*  system.
*
*  The function CGB91 returns .TRUE. if the leading dimension LD is
*  critical and .FALSE. if it is not critical. In this implementation
*  CGB91 is designed to detect critical leading dimensions in an
...
*  It may be rewarding to rewrite CGB91 for a machine with a different
*  cache policy.
*
...
*
*
*  User specified parameters for CGB91
*  ================================
*
...
*           considered critical.
*
*  CP     - Number of bytes in a complex-precision word.
*
*
*  Local Variables and Parameters
*  ==============================
*
*  ONEWAY - The maximum number of real words that can be
...
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MOD
*     .. User specified parameters for CGB91 ..
      INTEGER            LOLIM, LNSZ, NPRT, PRTSZ, CP
      PARAMETER        ( LNSZ = 64, NPRT = 128, PRTSZ = 3,
     $                   LOLIM = 64, CP = 8 )
*     .. Parameters ..
      INTEGER            ONEWAY, MXDIF
      PARAMETER        ( ONEWAY = ( LNSZ*NPRT )/CP,
     $                   MXDIF = LNSZ/( CP*PRTSZ ) )
*     ..
...
*
      ...
      ELSE
         ...
         CGB91 = MIN( UPDIF, LD-UPDIF ).LE.MXDIF
      END IF
*
      RETURN
*
