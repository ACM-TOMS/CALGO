      SUBROUTINE CGB07 ( UPLO, TRANS, N, K, ALPHA, A, LDA, B, LDB,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB07 (CHER2K)  performs one of the hermitian rank 2k operations
*
...
*     .. Parameters ..
     ...
     $                   CONE = ( 1.0E+0, 0.0E+0 ),
     $                   CZERO = ( 0.0E+0, 0.0E+0 ) )
*     .. User specified parameters for CGB07  ..
      INTEGER            RCB, CB
