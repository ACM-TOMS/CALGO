      SUBROUTINE CGB04 ( UPLO, TRANS, N, K, ALPHA, A, LDA,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB04 (CSYRK)  performs one of the symmetric rank k operations
*
*     C := alpha*A*A' + beta*C,
*
*  or
...
*     .. Parameters ..
     ...
     $                   ZERO = ( 0.0E+0, 0.0E+0 ),
     $                   CIP41 = 41, CIP42 = 42 )
*     .. User specified parameters for CGB04 ..
      INTEGER            RB, CB, RCB
...
*
            SMALLN = .NOT.CGB90( CIP41 , N, K )
            IF( SMALLN )THEN
               TINYK = .NOT.CGB90( CIP42 , N, K )
               DO 110, II = 1, N, RCB
                  ISEC = MIN( RCB, N-II+1 )
*
