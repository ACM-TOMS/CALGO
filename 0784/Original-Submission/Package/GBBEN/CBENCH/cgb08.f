      SUBROUTINE CGB08 ( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, LDA,
     $                   C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB08 (CTRMM) performs one of the matrix-matrix operations
*
...
*     .. User specified parameters for CGB08 ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.CGB90( CIP81, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.CGB90( CIP82, M, N )
                  DO 40, II = 1, M, RCB
                     ISEC = MIN( RCB, M-II+1 )
*
