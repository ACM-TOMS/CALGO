      PROGRAM SSBPM
*
*  SSBPM re-writes GEMM-Based Level 3 BLAS source files replacing lines
...
*  statements in the input file, and then run SSBPM to distribute these
...
*     .. Data statements ..
      DATA               BNAM/
     $'sgb02.f'   ,'sgb04.f'   ,'sgb06.f'   ,'sgb08.f'   ,'sgb09.f'   ,
     $'sgb90.f'   ,'          ','          ','sgb91.f'   ,'          '/
      DATA               STRS/
     $'ssymm.f'   ,'ssyrk.f'   ,'ssyr2k.f'  ,'strmm.f'   ,'strsm.f'   ,
     $'sbigp.f'   ,'          ','          ','scld.f'    ,'          ',
     $'PARAMETER ( RCB = $$ , CB = $$ )',
     $'PARAMETER ( RCB = $$ , RB = $$ , CB = $$ )',
     $'PARAMETER ( RCB = $$ , CB = $$ )',
...
*
   20 NAM = -1
     ...
     $            GBNAM( IB:IE ), ' is missing in SSBPM.'
               STOP
            END IF
         END IF
   30 CONTINUE
