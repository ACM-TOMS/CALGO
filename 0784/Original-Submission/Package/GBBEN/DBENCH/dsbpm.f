      PROGRAM DSBPM
*
*  DSBPM re-writes GEMM-Based Level 3 BLAS source files replacing lines
...
*  statements in the input file, and then run DSBPM to distribute these
...
*     .. Data statements ..
      DATA               BNAM/
     $'dgb02.f'   ,'dgb04.f'   ,'dgb06.f'   ,'dgb08.f'   ,'dgb09.f'   ,
     $'dgb90.f'   ,'          ','          ','dgb91.f'   ,'          '/
      DATA               STRS/
     $'dsymm.f'   ,'dsyrk.f'   ,'dsyr2k.f'  ,'dtrmm.f'   ,'dtrsm.f'   ,
     $'dbigp.f'   ,'          ','          ','dcld.f'    ,'          ',
     $'PARAMETER ( RCB = $$ , CB = $$ )',
     $'PARAMETER ( RCB = $$ , RB = $$ , CB = $$ )',
     $'PARAMETER ( RCB = $$ , CB = $$ )',
...
*
   20 NAM = -1
     ...
     $            GBNAM( IB:IE ), ' is missing in DSBPM.'
               STOP
            END IF
         END IF
   30 CONTINUE
