      SUBROUTINE ILU (N, NPDE, A, LLDG, LSL, LLSL)
C
C-----------------------------------------------------------------------
C
Ccc PARAMETER SPECIFICATION:
      INTEGER N, NPDE, LLDG(N,-4:-2), LSL(*), LLSL(0:*)
...
C
      RETURN
      END
      SUBROUTINE BCKSLV (N, NPDE, A, LLDG, LUDG, LSL, LLSL, LSU, LLSU,
     +   B)
C
C-----------------------------------------------------------------------
C
Ccc PARAMETER SPECIFICATION:
      INTEGER N, NPDE, LLDG(N,-4:-2), LUDG(N,2:4),
