If you don't make a call to get_smessy_defaults, before the first call to
smessy you will get an error message telling you that a call to
get_smessy_defaults was made within cmessy, and settings in struct
smessy_ty may be overwritten.

Default line lengths have been changed from 128 to 75.This change makes it
easier to show some of the features of smessy that would not be illustrated
as nicely with the longer line lengths. Below is an example of a
non-stopping error in the integration program diva.

$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
ctmessy reports error: Stop level=2 Print level=5 Error index=2
At: TN=0., KSTEP=1, with H=2.328306E-10, Error tolerances are too small. 
(Estimated Error) / (Requested Error) for equation 1 is 44408.92. 
Tolerance 1 for F(6) = 1.000000E-20.  Replacing F(6) with 1.421085E-14.
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
rdat(1:6) is: r1=0. r2=0. r3=17.12346 r4=-.1712346 r5=4.123457E+6
r6=3.123457E-4
rdat(1:6) is: r1=0. r2=0. r3=17.1235 r4=-0.1712 r5=4123456.7500 r6=.0003
rdat(1:6) is: r1=  0.0000 r2=  0.0000 r3= 17.1235, r4= -0.1712 r5=********
r6=  0.0003

To show how C handles cases with (a possibly) negative 0, here are
results for the same idat(2) and rdat(2) with a C printf statement
  0   -0.00
messy avoids printing the "-", C may not.

rdat as a vector with a starting index of -3:            0.000000E+0
-2: -0.000000E+0  1.712346E+1 -1.712346E-1  4.123457E+6  3.123457E-4
...
wider field that would be absolutely necessary.  We are asking for 4
significant figures.  Imagine what you would want to see for the numbers:
9.994, 9.9996, .99994999, .999999999999999, 9.99949999

rdat(1:5) is:  r1=9.994 r2=10.000 r3=0.9999 r4=1.000 r5=10.000
...
10:   -12    16   -26    13   267    48     9
Same with offset:   0     0    17   -17  8922 -8922     7   123     5   -12
20:    16   -26    13   267    48     9
...
fpprec=7      line_len=75   maxerr=25002  lstop=3       lprint=3     
errcnt=1      dblev=3
...
KSTEP=13 T=.06635685 H=.0278940 LSC=2 EIMIN=.159 EAVE=.0271 KSC=1 SIGMA(8)
RQ=79.1000
    I KQ LI    E      EI      EPS         F      
    1  6  1 7.1E-03 1.0E+00 1.0E-09  9.933207E-01
    2  7  1 2.8E-04 8.1E-03 1.0E-09 -9.382837E-02
    3  7  1 2.4E-04 6.9E-03 1.0E-09 -4.774820E-02
...
KSTEP=14 T=.09425087 H=.0313808 LSC=2 EIMIN=.0657 EAVE=.0948 KSC=1 SIGMA(8)
RQ=32.9000
The following is just to illustrate $Y...$y actions.
    I KQ LI    E      EI      EPS         F           D6         D7    
    1  7  0 5.1E-03 7.3E-02 1.0E-09  9.881702E-01 -8.535E-08 -2.466E-08
    2  7  0 2.6E-03 3.7E-02 1.0E-09 -1.246341E-01 -3.498E-07  6.896E-09
    3  7  0 1.5E-03 2.1E-02 1.0E-09 -6.331712E-02 -2.503E-07  4.775E-09
...
The same no leading 0's and hex output:  nodec=Z"1555 55555555"
noinc=Z"CCC CCCCCCCC" nodecx=Z"1234 56789ABC" noincx=Z"EEE EEEEEEEE"

The same no leading 0's and octal output:  nodec=O"5252525 25252525"
...
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
ssample reports error: Stop level=3 Print level=4 Error index=1
Start of error message from ssample what=1.
I want some 3.141593!
Finish with what=2.
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$

Finished first error message for ssample,  count=1 maxerr=34001

$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
ssample reports error: Stop level=5 Print level=6 Error index=99
Fatal error called ssample with what = 17.
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$


$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
ctmessy reports error: Stop level=8 Print level=8 Error index=999
This error message illustates how an error message ends things,ctmessy is
done.
