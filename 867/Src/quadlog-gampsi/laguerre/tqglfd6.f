...
*
      ...
      REAL*16             qgamma,      qsin,        qnan,        qvsum
*
*     Statement functions
*
      REAL*16             f
...
*
      ...
      REAL*16             result,      sigarg,      sigma,       sigmax
      REAL*16             sigmin,      theta,       ulp
      REAL*16             v(MAXPTS),   w(MAXPTS),   x(MAXPTS),   xarg
      REAL*16             zinit(1)
*
...
*
      ...
      exact = qgamma(onepa) * qsin(onepa * theta) /
     X    oneps2**(HALF * onepa)
