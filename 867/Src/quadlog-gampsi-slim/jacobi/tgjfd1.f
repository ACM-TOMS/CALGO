...
*
      ...
      DOUBLE PRECISION    deltaw(MAXPTS),           exact,       pp1
      DOUBLE PRECISION    relavg,      relerr,      relmax,      relmin
      DOUBLE PRECISION    relulp,      result,      ulp
      DOUBLE PRECISION    v(3,MAXPTS), w(MAXPTS),   x(MAXPTS),   xarg
...
*
      ...
      fprime(xarg,karg) = dfloat(karg) * (ONE + xarg)**(karg - 1)
*
