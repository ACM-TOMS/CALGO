...
*
      ...
      DOUBLE PRECISION    dfloat,      dgamma,      dlog,        dpsi
      DOUBLE PRECISION    dsin,        dtan,        dnan,        dvsum
*
*     Statement functions
*
      DOUBLE PRECISION    f
...
*     Local variables
*
      DOUBLE PRECISION    alfmax,      alfmin,      alpha,       dsda
      DOUBLE PRECISION    exact,       onepa,       oneps2,      relavg
      DOUBLE PRECISION    relerr,      relmax,      relmin,      relulp
      DOUBLE PRECISION    result,      s,           sigarg,      sigma
      DOUBLE PRECISION    sigmax,      sigmin,      theta,       ulp
