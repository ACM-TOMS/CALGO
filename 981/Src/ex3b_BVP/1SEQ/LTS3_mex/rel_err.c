...
void mexFunction (int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    switch (jFUN)
    {
        case 1 : /* MODIFIED TALBOT'S METHOD */
            IFAIL_tot = SEQ_Talbot1_DE ( SEQ_LTsamples_bvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax);
            break;

        case 2 : /* CLASSICAL TALBOT'S METHOD */
            IFAIL_tot = SEQ_Talbot2_DE ( SEQ_LTsamples_bvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT);
            break;
