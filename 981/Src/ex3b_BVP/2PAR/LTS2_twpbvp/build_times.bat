...
echo.
@echo on
gcc -o ex3_time.exe ./OMP_main_TIMES.o ./OMP_LTsamples_twpbvp.o ./LTsings2.o ./COM_Talbot_pack.o ./COM_Talbot_pack_DE.o ./OMP_Talbot_pack_DE.o twpbvp.o prtfun.o testfun.o -lm -lgfortran -lgomp
