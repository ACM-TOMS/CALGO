...
*             (DESCW(LLD_),*).  Not used in the current version.
*
...
*     .. Local Scalars ..
     ...
     $                   SAFMAX, SAFMIN, SMLNUM, SN, ULP,
     $                   ELEM, ELEM1, ELEM2, ELEM3
      INTEGER            I, IFST, ILST, INFO, INFQR, J, JW, K,
     $                   KEND, KLN, KWTOP, LTOP, LWK1, LWK2, LWK3,
     ...
     $                   IPZ0, IPW0, ROUND, LILST, LILST0,
     $                   IWRK1, RSRC, CSRC, LWK4, LWK5, IWRK2, LWK6,
     $                   LWK7, ILWKOPT, TZROWS, TZCOLS, NSEL,
...
*     .. External Functions ..
      ...
      EXTERNAL           DLAMCH, PILAENVX, NUMROC, INDXG2P, ICEIL,
     $                   BLACS_PNUM
*     ..
*     .. External Subroutines ..
     ...
     $                   BLACS_GRIDEXIT, PDGEMR2D, DGSUM2D, IGAMX2D
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $           WORK, -1, IWORK, -1, INFQR, RECLEVEL+1 )
            LWK3 = INT( WORK( 1 ) )
            IWRK1 = IWORK( 1 )
         ELSE
            LWK3 = 1
...
*        Optimal workspace.
*
         LWKOPT = MAX( LWK1, LWK2, LWK3+LWK4, LWK5, LWK6, LWK7 )
...
*
     ...
     $                    1+IROFFH, JW+IROFFH, V, DESCV(LLD_), INFQR )
                  ...
                  END IF
                  IF( NPROCS.GT.1 )
     $               CALL IGAMX2D( ICTXT, 'All', '1-Tree', 1, 1, INFQR,
     $                    1, -1, -1, -1, -1, -1 )
               END IF
...
c         IF( MYROW.GE.NPMIN .OR. MYCOL.GE.NPMIN ) ICTXT_NEW = -1
 ...
 40         CONTINUE
         END IF
         CALL IGAMX2D( ICTXT, 'All', '1-Tree', 1, 1, INFQR, 1, -1, -1,
     $        -1, -1, -1 )
