      SUBROUTINE CQRT25( SCALE, RANK, M, N, NRHS, A, LDA, B, LDB, S,
...
*     03/05/2004
*
*  -- Modification of LAPACK test routine (version 3.0) CQRT15 --
*     Univ. of Tennessee, Univ. of California Berkeley, NAG Ltd.,
*     Courant Institute, Argonne National Lab, and Rice University
*     September 30, 1994
*
*     .. Scalar Arguments ..
      INTEGER            LDA, LDB, LWORK, M, N, NRHS, RANK, SCALE
      REAL               NORMA, NORMB
*     ..
*     .. Array Arguments ..
      INTEGER            ISEED( 4 )
...
*  =======
*
*  CQRT25 generates a matrix with full or deficient rank and of various
*  norms.
*
*  Arguments
*  =========
...
*
*  RANK    (input)  INTEGER
*          The rank or number of nonzero singular values of A.
*
*  M       (input) INTEGER
...
*
      MN = MIN( M, N )
      IF( RANK.LT.0 .OR. RANK.GT.MN ) THEN
         CALL XERBLA( 'CQRT25', 2 )
         RETURN
      END IF
      IF( LWORK.LT.MAX( M+MN, MN*NRHS, 2*N+M ) ) THEN
         CALL XERBLA( 'CQRT25', 16 )
         RETURN
      END IF
*
      ...
      BIGNUM = ONE / SMLNUM
*
*     Determine (unscaled) singular values
*
      DO 10 J = RANK + 1, MN
         S( J ) = ZERO
   10 CONTINUE
