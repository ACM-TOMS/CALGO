      SUBROUTINE DQRT25( SCALE, RANK, M, N, NRHS, A, LDA, B, LDB, S,
...
*     03/05/2004
*
*  -- Modification of LAPACK test routine (version 3.0) DQRT15 --
...
*  =======
*
*  DQRT25 generates a matrix with full or deficient rank and of various
*  norms.
*
*  Arguments
*  =========
...
*
      IF( RANK.LT.0 .OR. RANK.GT.MN ) THEN
         CALL XERBLA( 'DQRT25', 2 )
         RETURN
      END IF
      IF( LWORK.LT.MAX( M+MN, MN*NRHS, 2*N+M ) ) THEN
         CALL XERBLA( 'DQRT25', 25 )
         RETURN
      END IF
*
