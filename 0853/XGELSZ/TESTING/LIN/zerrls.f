...
*  driver routines (ZGELS, ZGELSS, ZGELSX, ZGELSY, ZGELSZ, ZGELSD).
*
*  Arguments
*  =========
*
...
*
         SRNAMT = 'ZGELSZ'
         INFOT = 1
         CALL ZGELSZ( -1, 0, 0, A, 1, B, 1, IP, RCOND, IRNK, W, 10, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
         INFOT = 2
         CALL ZGELSZ( 0, -1, 0, A, 1, B, 1, IP, RCOND, IRNK, W, 10, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
         INFOT = 3
         CALL ZGELSZ( 0, 0, -1, A, 1, B, 1, IP, RCOND, IRNK, W, 10, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
         INFOT = 5
         CALL ZGELSZ( 2, 0, 0, A, 1, B, 2, IP, RCOND, IRNK, W, 10, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
         INFOT = 7
         CALL ZGELSZ( 2, 0, 0, A, 2, B, 1, IP, RCOND, IRNK, W, 10, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
         INFOT = 12
         CALL ZGELSZ( 0, 3, 0, A, 1, B, 3, IP, RCOND, IRNK, W, 1, RW,
     $                INFO )
         CALL CHKXER( 'ZGELSZ', INFOT, NOUT, LERR, OK )
*
*        ZGELSD
