      SUBROUTINE SLAQPQ( M, N, OFFSET, A, LDA, JPVT, RCOND, RANK, TAU,
...
*  =======
*
*  SLAQPQ uses a partial QR factorization with column pivoting applied
...
*  passed into SLAQPQ; however estimates of largest and smallest
*  singular values and corresponding approximate singular vectors
*  of R00 are supplied to SLAQPQ and these are used to estimate
*  the condition number of R1. On output RANK is the order of R1.
*
*  SLAQPQ uses Level 2 BLAS.
*
*  Arguments
*  =========
*
...
*     .. Local Scalars ..
      ...
      REAL               AII, C1, C2, S1, S2, SMAXPR, SMINPR, TEMP,
     $                   TEMP2
*     ..
*     .. External Subroutines ..
      EXTERNAL           SLAIC1, SLARF, SLARFG, SSWAP
*     ..
*     .. Intrinsic Functions ..
...
*              the calculated rank is zero
         ...
         ELSE
*
            CALL SLAIC1( IMIN, RANK, XMIN, SMIN, A( 1, I ),
     $                   A( RANK+1, I ), SMINPR, S1, C1 )
            CALL SLAIC1( IMAX, RANK, XMAX, SMAX, A( 1, I ),
