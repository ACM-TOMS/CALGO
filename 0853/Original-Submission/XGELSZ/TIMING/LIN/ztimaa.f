...
*     .. Parameters ..
      ...
      PARAMETER          ( NMAX = 512, LDAMAX = NMAX+20,
     $                   NMAXB = 13*NMAX )
      INTEGER            LA
      PARAMETER          ( LA = NMAX*LDAMAX )
      INTEGER            MAXVAL, MXNLDA
      PARAMETER          ( MAXVAL = 12, MXNLDA = 2 )
      INTEGER            MAXPRM
...
*     .. Local Arrays ..
     ...
     $                   NXVAL( MAXVAL )
      DOUBLE PRECISION   D( 2*NMAX ), FLPTBL( 6*6*MAXSZS*MAXPRM*6 ),
     $                   OPCTBL( 6*6*MAXSZS*MAXPRM*6 ),
     $                   RESLTS( MAXVAL, MAXVAL, 2*MXNLDA, 4*MAXVAL ),
     $                   RWORK( 150*NMAX+2*MAXVAL ), S( NMAX*2 ),
     $                   TIMTBL( 6*6*MAXSZS*MAXPRM*6 )
