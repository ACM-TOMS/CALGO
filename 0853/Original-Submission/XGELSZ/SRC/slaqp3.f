      SUBROUTINE SLAQP3( M, N, A, LDA, JPVT, RCOND, RANK, TAU, WORK,
     $                   LWORK, INFO )
*
...
*  =======
*
*  SLAQP3 uses Level 3 BLAS to compute enough of a QR factorization
...
*     .. Local Scalars ..
     ...
     $                   TOPBMN
      REAL               C1, C2, S1, S2, SMAX, SMAXPR, SMIN, SMINPR
*
*     ..
*     .. External Subroutines ..
      EXTERNAL           SGEQRF, SLAIC1, SLAQPP, SLAQPQ, SORMQR, SSWAP,
     $                   XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
...
*
         DO 40 J = NFXD + 1, N
            WORK( 2*MN+J ) = SNRM2( SM, A( NFXD+1, J ), 1 )
...
*
               CALL SLAQPP( M, N-J+1, J-1, JB, FJB, A( 1, J ), LDA,
...
*
         IF( J.LE.MN )
     $      CALL SLAQPQ( M, N-J+1, J-1, A( 1, J ), LDA, JPVT( J ),
