...
*
*  The program writes the results to a file sfig12.out.  In
*  sfig12.out for each matrix m, n, the rank and times for xGELSD,
*  xGELSY and xGELSZ are printed.  A matlab program plotfig12.m
*  can be used to read sfig12.out and plot the times.
*
*
*  Internal Parameters
*  ===================
...
*
      CHARACTER*80       LINE
*
      REAL               EPS, NORMA, NORMB, TREP, TIMEC, TIMED, TIMEY,
     $                   TIMEZ, RCOND, S1, S2
...
*     .. External Subroutines ..
      EXTERNAL           SGELSD, SGELSY, SGELSZ, SQRT25
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          SQRT
*     ..
...
*     Initialize seed for random number geneerator
      ...
      ISEED( 3 ) = RANK
      ISEED( 4 ) = 13
      CALL SQRT25( SCALE, RANK, M, N, NRHS, A0, LDA, B0, LDB, S, NORMA,
...
*
  ...
  180 CONTINUE
*
      CALL SGELSY( M, N, NRHS, A, LDA, B, LDB, IPVT, RCOND, RANK, WORK,
     $             LWORK, INFO )
      IREP = IREP + 1
      S2 = SECOND( )
      GO TO 140
...
*           Top of loop
  ...
  300 CONTINUE
*
      CALL SGELSZ( M, N, NRHS, A, LDA, B, LDB, IPVT, RCOND, RANK, WORK,
     $             LWORK, INFO )
      IREP = IREP + 1
      S2 = SECOND( )
      GO TO 260
