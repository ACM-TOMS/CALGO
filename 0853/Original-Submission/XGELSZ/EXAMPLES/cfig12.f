...
*
*  The program writes the results to a file cfig12.out.  In
*  fig12.out for each matrix m, n, the rank and times for xGELSD,
*  xGELSY and xGELSZ are printed.  A matlab program plotfig12.m
*  can be used to read fig12.out and plot the times.
*
*
*  Internal Parameters
*  ===================
...
*     .. External Subroutines ..
      EXTERNAL           CGELSD, CGELSY, CGELSZ, CQRT25
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          SQRT
*     ..
...
*     Initialize seed for random number geneerator
      ...
      ISEED( 3 ) = RANK
      ISEED( 4 ) = 13
      CALL CQRT25( SCALE, RANK, M, N, NRHS, A0, LDA, B0, LDB, S, NORMA,
...
*
  ...
  180 CONTINUE
*
      CALL CGELSY( M, N, NRHS, A, LDA, B, LDB, IPVT, RCOND, RANK, WORK,
     $             LWORK, RWORK, INFO )
      IREP = IREP + 1
      S2 = SECOND( )
      GO TO 140
...
*           Top of loop
  ...
  300 CONTINUE
*
      CALL CGELSZ( M, N, NRHS, A, LDA, B, LDB, IPVT, RCOND, RANK, WORK,
     $             LWORK, RWORK, INFO )
      IREP = IREP + 1
      S2 = SECOND( )
      GO TO 260
