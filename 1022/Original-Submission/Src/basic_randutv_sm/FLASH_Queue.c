...
//static FLASH_Data_aff flash_queue_data_affinity   = FLASH_QUEUE_AFFINITY_1D_COLUMN_BLOCK_CYCLIC;
...
----------------------------------------------------------------------------*/
{
   ...
   // New UTV.
   typedef FLA_Error(*flash_svd_p)(FLA_Obj U, FLA_Obj A, FLA_Obj VT);
   typedef FLA_Error(*flash_normal_random_matrix_p)(FLA_Obj A);
   typedef FLA_Error(*flash_CPU_Compute_td_QR_UT_inner_utv_p)(FLA_Obj U, FLA_Obj D, FLA_Obj S, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Apply_right_Q_of_dense_QR_UT_inner_utv_p)(FLA_Obj U, FLA_Obj S, FLA_Obj C, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Apply_left_Qt_of_dense_QR_UT_inner_utv_p)(FLA_Obj U, FLA_Obj S, FLA_Obj C, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Apply_right_Q_of_td_QR_UT_inner_utv_p )(FLA_Obj D, FLA_Obj S, FLA_Obj F, FLA_Obj G, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Apply_left_Qt_of_td_QR_UT_inner_utv_p)(FLA_Obj D, FLA_Obj S, FLA_Obj F, FLA_Obj G, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Keep_upper_triang_inner_utv_p )(FLA_Obj A);
   typedef FLA_Error(*flash_CPU_Set_to_zero_inner_utv_p )(FLA_Obj A);
   typedef FLA_Error(*flash_CPU_Compute_dense_QR_UT_inner_utv_p )(FLA_Obj A, FLA_Obj S, dim_t nanoblock);
   typedef FLA_Error(*flash_CPU_Mycopy_inner_utv_p)(FLA_Obj A, FLA_Obj B);
   typedef FLA_Error(*flash_CPU_Gemm_abta_p)(FLA_Obj A, FLA_Obj B);
   typedef FLA_Error(*flash_CPU_Gemm_aabt_p)(FLA_Obj A, FLA_Obj B);
   typedef FLA_Error(*flash_CPU_Gemm_aab_p)(FLA_Obj A, FLA_Obj B);
   typedef FLA_Error(*flash_CPU_Gemm_aab_p)(FLA_Obj A, FLA_Obj B);
   ...
   else if ( t->func == (void *) MyFLA_Normal_random_matrix ) {
      flash_normal_random_matrix_p func;
      func = (flash_normal_random_matrix_p) t->func;

      func( t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Compute_td_QR_UT_inner_utv) {
      flash_CPU_Compute_td_QR_UT_inner_utv_p func;
      func = (flash_CPU_Compute_td_QR_UT_inner_utv_p) t->func;

      func( t->output_arg[0], t->output_arg[1], t->output_arg[2], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Apply_right_Q_of_td_QR_UT_inner_utv) {
      flash_CPU_Apply_right_Q_of_td_QR_UT_inner_utv_p func;
      func = (flash_CPU_Apply_right_Q_of_td_QR_UT_inner_utv_p) t->func;

      //func( t->output_arg[0], t->output_arg[1], t->input_arg[0], t->input_arg[1], 32 );
      func( t->input_arg[0], t->input_arg[1], t->output_arg[0], t->output_arg[1], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Apply_right_Q_of_dense_QR_UT_inner_utv) {
      flash_CPU_Apply_right_Q_of_dense_QR_UT_inner_utv_p func;
      func = (flash_CPU_Apply_right_Q_of_dense_QR_UT_inner_utv_p) t->func;

      //func( t->output_arg[0], t->input_arg[0], t->input_arg[1], 32 );
      func( t->input_arg[0], t->input_arg[1], t->output_arg[0], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Apply_left_Qt_of_dense_QR_UT_inner_utv) {
      flash_CPU_Apply_left_Qt_of_dense_QR_UT_inner_utv_p func;
      func = (flash_CPU_Apply_left_Qt_of_dense_QR_UT_inner_utv_p) t->func;

      //func( t->output_arg[0], t->input_arg[0], t->input_arg[1], 32 );
      func( t->input_arg[0], t->input_arg[1], t->output_arg[0], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Apply_left_Qt_of_td_QR_UT_inner_utv) {
      flash_CPU_Apply_left_Qt_of_td_QR_UT_inner_utv_p func;
      func = (flash_CPU_Apply_left_Qt_of_td_QR_UT_inner_utv_p) t->func;

      func( t->input_arg[0], t->input_arg[1], t->output_arg[0], t->output_arg[1], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Keep_upper_triang_inner_utv) {
      flash_CPU_Keep_upper_triang_inner_utv_p func;
      func = (flash_CPU_Keep_upper_triang_inner_utv_p) t->func;

      func( t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Set_to_zero_inner_utv) {
      flash_CPU_Set_to_zero_inner_utv_p func;
      func = (flash_CPU_Set_to_zero_inner_utv_p) t->func;

      func( t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Mycopy_inner_utv) {
      flash_CPU_Mycopy_inner_utv_p func;
      func = (flash_CPU_Mycopy_inner_utv_p) t->func;

      func( t->input_arg[0], t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Compute_dense_QR_UT_inner_utv) {
      flash_CPU_Compute_dense_QR_UT_inner_utv_p func;
      func = (flash_CPU_Compute_dense_QR_UT_inner_utv_p) t->func;

      func( t->output_arg[0], t->output_arg[1], (dim_t)32 );
   }
   else if ( t->func == (void *) CPU_Gemm_abta_inner_utv) {
      flash_CPU_Gemm_abta_p func;
      func = (flash_CPU_Gemm_abta_p) t->func;

      func( t->output_arg[0], t->input_arg[0] );
      //func( t->input_arg[0], t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Gemm_aabt_inner_utv) {
      flash_CPU_Gemm_aabt_p func;
      func = (flash_CPU_Gemm_aabt_p) t->func;

      //func( t->output_arg[0], t->input_arg[0] );
      func( t->input_arg[0], t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Gemm_aab_inner_utv) {
      flash_CPU_Gemm_aab_p func;
      func = (flash_CPU_Gemm_aab_p) t->func;

      //func( t->output_arg[0], t->input_arg[0] );
      func( t->input_arg[0], t->output_arg[0] );
   }
   else if ( t->func == (void *) CPU_Compute_svd_inner_utv )
   {
      flash_svd_p func;
      func = (flash_svd_p) t->func;
