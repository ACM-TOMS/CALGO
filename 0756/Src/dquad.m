...
%DQUAD  (not intended for calling directly by the user)
...
%	sing1(5) = 3, then z1(5) = z(3).  A zero means no singularity. 
%	z is the vector of singularities;  beta is the vector of
