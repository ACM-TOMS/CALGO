...
%       point source located in a polygonal region.  This is equivalent
%       to the disk map with conformal center at the source.  With no
%       arguments the user draws the polygon and clicks the mouse at the
%       source.
%
%       PTSOURCE(W,BETA) uses the polygon described by W and BETA.
%
%       PTSOURCE(W,BETA,Z,C) assmues that Z and C comprise the solution
%       to the disk mapping parameter problem, as returned by DPARAM.
%      
