...
%
%   DISP(T) displays a Tucker tensor with no name.
%
%   DISP(T,NAME) display a Tucker tensor with the given name.
%
...
fprintf(1,'%s is a Tucker tensor of size ', name);
printsize(size(t));
