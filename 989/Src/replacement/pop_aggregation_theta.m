function [NewPop,NewFunVal] = pop_aggregation_theta(Pop,SelPop,SampledPop,FunVal,SelFunVal,SampledFunVal,replacement_params)
...
if (max(SampledFunVal)<=max(FunVal))
    FitnessImprovement = FitnessImprovement + 1;
