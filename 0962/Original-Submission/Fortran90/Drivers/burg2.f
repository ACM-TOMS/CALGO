...
c           a2 = (-x + 0.5d0 - 0.75d0 * t) * 0.25d0 / eps,
c           a3 = (-x + 0.375d0) * 0.5 / eps,
c           expa1 = 0.d0, expa2 = 0.d0, expa3 = 0.d0, temp = max(a1, a2, a3).
...
c
      ...
      do i = 1, npde
         bval(i) = u(i) - (0.1d0*expa1+0.5d0*expa2+expa3)
     &                    / (expa1+expa2+expa3)
      end do
c
      return
...
c
      do i = 1, npde
         ...
         dbdu(i,i) = 1.0d0
         dbdt(i) = -(0.24d-1*expa1*expa2 + 0.22275d0*expa1*expa3
     &               + 0.9375d-1*expa2*expa3)
     &             /eps/(expa1+expa2+expa3)**2
      end do
c
      return
      end
...
c-----------------------------------------------------------------------
      ...
      do i = 1, npde
         u(i) = (0.1d0*expa1+0.5d0*expa2+expa3) / (expa1+expa2+expa3)
      end do
c
      return
      end
...
c loop indices:
        integer                 i
c-----------------------------------------------------------------------
      a1 = (-x + 0.5d0 - 4.95d0 * t) * 0.5d-1 / eps
      a2 = (-x + 0.5d0 - 0.75d0 * t) * 0.25d0 / eps
      a3 = (-x + 0.375d0) * 0.5 / eps
      expa1 = 0.d0
      expa2 = 0.d0
      expa3 = 0.d0
