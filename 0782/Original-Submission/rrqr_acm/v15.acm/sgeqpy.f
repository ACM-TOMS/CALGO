      SUBROUTINE SGEQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  SGEQPY computes a QR factorization
*       A*P = Q*[ R11 R12 ]
*               [  0  R22 ]
...
*
      IF( RANK.GT.0 ) THEN
         CALL STRQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
     $                ORCOND, RANK, SVLUES, WORK, LWORK, INFO )
      END IF
*
      WORK( 1 ) = WSIZE
