...
*  SRR    3               List types on next line if 0 < NTYPES <  3
*
*  Internal Parameters
*  ===================
*
...
*
      IF( .NOT.LSAME( C1, 'S precision' ) ) THEN
...
*
         IF( TSTCHK ) THEN
            CALL SCHKRR( DOTYPE, NM, MVAL, NN, NVAL, NNB, NBVAL,
...
*
 ...
 9995 FORMAT( ' Invalid input value: ', A4, '=', I6, '; must be <=',
     $      I6 )
 9994 FORMAT( ' RRQR Tests. REAL routines ',
