      SUBROUTINE ZTRQPX( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
     $                   ORCOND, RANK, SVLUES, WORK, RWORK, INFO )
*
...
*  =======
*
*  ZTRQPX detects the right rank for upper triangular matrix A.
...
*
      CALL ZTRRNK( MN, A, LDA, RCOND, RANK, WORK, INFO )
*
*     ************************
...
*
      CALL ZTRQXC( JOB, M, N, K, A, LDA, C, LDC, JPVT,
