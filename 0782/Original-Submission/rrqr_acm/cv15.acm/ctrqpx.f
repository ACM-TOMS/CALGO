      SUBROUTINE CTRQPX( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  CTRQPX detects the right rank for upper triangular matrix A.
...
*
      CALL CTRRNK( MN, A, LDA, RCOND, RANK, WORK, INFO )
*
*     ************************
...
*
      CALL CTRQXC( JOB, M, N, K, A, LDA, C, LDC, JPVT,
