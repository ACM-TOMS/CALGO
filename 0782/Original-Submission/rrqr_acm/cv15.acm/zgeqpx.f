      SUBROUTINE ZGEQPX( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  ZGEQPX computes a QR factorization
*       A*P = Q*[ R11 R12 ]
*               [  0  R22 ]
...
*
      IF( RANK.GT.0 ) THEN
         CALL ZTRQPX( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
