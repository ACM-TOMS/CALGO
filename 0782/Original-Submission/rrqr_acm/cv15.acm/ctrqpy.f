      SUBROUTINE CTRQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  CTRQPY detects the right rank for upper triangular matrix A.
...
*
      CALL CTRQYC( JOB, M, N, K, A, LDA, C, LDC, JPVT,
