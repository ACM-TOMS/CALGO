      SUBROUTINE ZTRQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  ZTRQPY detects the right rank for upper triangular matrix A.
...
*
      CALL ZTRQYC( JOB, M, N, K, A, LDA, C, LDC, JPVT,
