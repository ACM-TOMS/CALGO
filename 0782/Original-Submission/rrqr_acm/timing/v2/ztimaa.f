...
*     .. External Subroutines ..
      EXTERNAL           ZTIMMM, ZTIMMV,
     $                   ZTIMQP, ZTIMQR, ZTIMRR
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*     next line but don't time ZGEMV and ZGEMM.
*
      ...
      ELSE
         WRITE( NOUT, FMT = 9990 )
*
*        Time ZGEMV and ZGEMM.
*
         CALL ZTIMMV( 'ZGEMV ', NN, NVAL, NNB, NBVAL, NLDA,
     $                LDAVAL, TIMMIN, A( 1, 1 ), LA, A( 1, 2 ),
     $                A( 1, 3 ), RESLTS, LDR1, LDR2, NOUT )
         CALL ZTIMMM( 'ZGEMM ', 'N', NN, NVAL, NLDA, LDAVAL,
...
*
      IF( .NOT.LSAME( C1, 'Zprecision' ) ) THEN
...
*        QR routines
*
         CALL ZTIMQR( LINE, NN, MVAL, NVAL, NK, KVAL, NNB, NBVAL,
     $                NXVAL, NLDA, LDAVAL, TIMMIN, A( 1, 1 ), E,
     $                A( 1, 2 ), A( 1, 3 ), D, RESLTS, LDR1, LDR2,
     $                LDR3, NOUT )
*
...
*
         CALL ZTIMRR( LINE, NM, MVAL, NVAL, NK, KVAL,
