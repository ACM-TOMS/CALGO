      SUBROUTINE ZGEQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  ZGEQPY computes a QR factorization
*       A*P = Q*[ R11 R12 ]
*               [  0  R22 ]
...
*     =============
*
      CALL ZGEQPB( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*
      IF( RANK.GT.0 ) THEN
         CALL ZTRQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
