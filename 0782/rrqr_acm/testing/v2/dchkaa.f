...
*  DRR    3               List types on next line if 0 < NTYPES <  3
*
*  Internal Parameters
*  ===================
*
...
*
      INTEGER            LWORK
      PARAMETER          ( LWORK = NMAX*( NMAX+MAXRHS+5 ) )
*     ..
*     .. Local Scalars ..
...
*
      IF( .NOT.LSAME( C1, 'D precision' ) ) THEN
...
*
         IF( TSTCHK ) THEN
            CALL DCHKRR( DOTYPE, NM, MVAL, NN, NVAL, NNB, NBVAL,
     $                   NXVAL, THRESH, TSTERR, A( 1, 1 ), A( 1, 2 ),
     $                   A( 1, 3 ), B( 1, 1 ), B( 1, 2 ),
     $                   WORK, LWORK, IWORK, NOUT )
         ELSE
            WRITE( NOUT, FMT = 9989 )PATH
         END IF
*
...
*
 ...
 9995 FORMAT( ' Invalid input value: ', A4, '=', I6, '; must be <=',
     $      I6 )
 9994 FORMAT( ' RRQR Tests. DOUBLE PRECISION routines ',
