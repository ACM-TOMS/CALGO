...
*     .. External Subroutines ..
      EXTERNAL           CTIMMM, CTIMMV,
     $                   CTIMQP, CTIMQR, CTIMRR
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
      ...
      ELSE
         WRITE( NOUT, FMT = 9990 )
*
*        Time CGEMV and CGEMM.
*
         CALL CTIMMV( 'CGEMV ', NN, NVAL, NNB, NBVAL, NLDA,
     $                LDAVAL, TIMMIN, A( 1, 1 ), LA, A( 1, 2 ),
     $                A( 1, 3 ), RESLTS, LDR1, LDR2, NOUT )
         CALL CTIMMM( 'CGEMM ', 'N', NN, NVAL, NLDA, LDAVAL,
...
*
      IF( .NOT.LSAME( C1, 'Cprecision' ) ) THEN
...
*        QR routines
*
         CALL CTIMQR( LINE, NN, MVAL, NVAL, NK, KVAL, NNB, NBVAL,
...
*
         CALL CTIMRR( LINE, NM, MVAL, NVAL, NK, KVAL,
