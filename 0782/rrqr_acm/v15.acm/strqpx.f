      SUBROUTINE STRQPX( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
...
*  =======
*
*  STRQPX detects the right rank for upper triangular matrix A.
...
*
      CALL STRQXC( JOB, M, N, K, A, LDA, C, LDC, JPVT,
