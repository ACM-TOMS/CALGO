...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
  {
   ...
   int N = 2;
   MpIeee alpha=  0.1f;
   MpIeee Ap[] =  { -0.273f, -0.499f, -0.305f, -0.277f, 0.238f, -0.369f };
   MpIeee X[] =  { 0.638f, -0.905f, 0.224f, 0.182f };
   int incX = -1;
   MpIeee Ap_expected[] =  { -0.26467f, 0.0f, -0.30718f, -0.245116f, 0.360607f, 0.0f };
...

  {
   ...
   MpIeee X[] =  { 0.638f, -0.905f, 0.224f, 0.182f };
   int incX = -1;
   MpIeee Ap_expected[] =  { -0.26467f, 0.0f, -0.30718f, -0.308884f, 0.360607f, 0.0f };
   cblas_chpr(order, uplo, N, alpha, X, incX, Ap);
   {
     int i;
     for (i = 0; i < 3; i++) {
...

  {
   ...
   int N = 2;
   MpIeee alpha=  1;
   MpIeee Ap[] =  { 0.265, 0.362, -0.855, 0.035, 0.136, 0.133 };
   MpIeee X[] =  { -0.278, -0.686, -0.736, -0.918 };
   int incX = -1;
   MpIeee Ap_expected[] =  { 1.64942, 0.0, -0.020644, -0.214692, 0.68388, 0.0 };
...

  {
   ...
   MpIeee X[] =  { -0.278, -0.686, -0.736, -0.918 };
   int incX = -1;
   MpIeee Ap_expected[] =  { 1.64942, 0.0, -0.020644, 0.284692, 0.68388, 0.0 };
   cblas_zhpr(order, uplo, N, alpha, X, incX, Ap);
   {
     int i;
     for (i = 0; i < 3; i++) {
