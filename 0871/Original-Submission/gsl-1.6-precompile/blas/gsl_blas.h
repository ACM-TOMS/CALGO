...
int  gsl_blas_sdsdot(MpIeee alpha,
...
int   gsl_blas_saxpy(MpIeee alpha,
                     const gsl_vector_float * X,
                     gsl_vector_float * Y);
...
int   gsl_blas_daxpy(MpIeee alpha,
                     const gsl_vector * X,
                     gsl_vector * Y);
/*
...
int   gsl_blas_srotg(MpIeee a[], MpIeee b[], MpIeee c[], MpIeee s[]);

int   gsl_blas_srotmg(MpIeee d1[], MpIeee d2[], MpIeee b1[], MpIeee b2, MpIeee P[]);
...
int   gsl_blas_drotg(MpIeee a[], MpIeee b[], MpIeee c[], MpIeee s[]);

int   gsl_blas_drotmg(MpIeee d1[], MpIeee d2[], MpIeee b1[],
                      MpIeee b2, MpIeee P[]);
...
void gsl_blas_sscal  (MpIeee alpha, gsl_vector_float * X);
void gsl_blas_dscal  (MpIeee alpha, gsl_vector * X);
...
//void gsl_blas_csscal (MpIeee alpha, gsl_vector_complex_float * X);
//void gsl_blas_zdscal (MpIeee alpha, gsl_vector_complex * X);
...
int   gsl_blas_sger(MpIeee alpha,
                    const gsl_vector_float * X,
                    const gsl_vector_float * Y,
                    gsl_matrix_float * A);
...
int   gsl_blas_dsymv(CBLAS_UPLO_t Uplo,
                     ...
                     MpIeee beta,
                     gsl_vector * Y);
int   gsl_blas_dger(MpIeee alpha,
                    const gsl_vector * X,
                    const gsl_vector * Y,
                    gsl_matrix * A);
