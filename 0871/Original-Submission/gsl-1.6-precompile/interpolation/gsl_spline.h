...
int
 gsl_spline_init(gsl_spline * spline, const MpIeee xa[], const MpIeee ya[], size_t size);


int
 gsl_spline_eval_e(const gsl_spline * spline, MpIeee x,
                  gsl_interp_accel * a, MpIeee * y);

MpIeee gsl_spline_eval(const gsl_spline * spline, MpIeee x, gsl_interp_accel * a);
