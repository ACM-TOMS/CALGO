...
_gsl_matrix_view
gsl_matrix_view_array (MpIeee * base,
                             const size_t n1, 
                             const size_t n2);

_gsl_matrix_view
gsl_matrix_view_array_with_tda (MpIeee * base, 
                                      const size_t n1, 
                                      const size_t n2,
                                      const size_t tda);
...
_gsl_matrix_const_view
gsl_matrix_const_view_array (const MpIeee * base,
                                   const size_t n1, 
                                   const size_t n2);

_gsl_matrix_const_view
gsl_matrix_const_view_array_with_tda (const MpIeee * base, 
                                            const size_t n1, 
                                            const size_t n2,
                                            const size_t tda);
...
MpIeee gsl_matrix_get(const gsl_matrix * m, const size_t i, const size_t j);
void    gsl_matrix_set(gsl_matrix * m, const size_t i, const size_t j, const MpIeee x);

MpIeee * gsl_matrix_ptr(gsl_matrix * m, const size_t i, const size_t j);
const MpIeee * gsl_matrix_const_ptr(const gsl_matrix * m, const size_t i, const size_t j);

void gsl_matrix_set_zero (gsl_matrix * m);
void gsl_matrix_set_identity (gsl_matrix * m);
void gsl_matrix_set_all (gsl_matrix * m, MpIeee x);
...
MpIeee gsl_matrix_max(const gsl_matrix * m);
MpIeee gsl_matrix_min(const gsl_matrix * m);
void gsl_matrix_minmax (const gsl_matrix * m, MpIeee * min_out, MpIeee * max_out);
...
int  gsl_matrix_scale(gsl_matrix * a, const MpIeee x);
int  gsl_matrix_add_constant(gsl_matrix * a, const MpIeee x);
int  gsl_matrix_add_diagonal(gsl_matrix * a, const MpIeee x);
...
extern inline 
void
gsl_matrix_set(gsl_matrix * m, const size_t i, const size_t j, const MpIeee x)
{
#if GSL_RANGE_CHECK
  if (i >= m->size1)
    {
