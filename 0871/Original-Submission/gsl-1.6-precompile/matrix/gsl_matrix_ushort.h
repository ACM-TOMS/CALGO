...
int  gsl_matrix_ushort_scale(gsl_matrix_ushort * a, const MpIeee x);
int  gsl_matrix_ushort_add_constant(gsl_matrix_ushort * a, const MpIeee x);
int  gsl_matrix_ushort_add_diagonal(gsl_matrix_ushort * a, const MpIeee x);
