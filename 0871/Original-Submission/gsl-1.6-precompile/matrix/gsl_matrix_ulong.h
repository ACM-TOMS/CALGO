...
int  gsl_matrix_ulong_scale(gsl_matrix_ulong * a, const MpIeee x);
int  gsl_matrix_ulong_add_constant(gsl_matrix_ulong * a, const MpIeee x);
int  gsl_matrix_ulong_add_diagonal(gsl_matrix_ulong * a, const MpIeee x);
