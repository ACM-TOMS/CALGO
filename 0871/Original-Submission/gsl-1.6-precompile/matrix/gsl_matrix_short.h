...
int  gsl_matrix_short_scale(gsl_matrix_short * a, const MpIeee x);
int  gsl_matrix_short_add_constant(gsl_matrix_short * a, const MpIeee x);
int  gsl_matrix_short_add_diagonal(gsl_matrix_short * a, const MpIeee x);
