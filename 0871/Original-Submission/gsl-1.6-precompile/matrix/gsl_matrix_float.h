...
_gsl_matrix_float_view
gsl_matrix_float_view_array (MpIeee * base,
                             const size_t n1, 
                             const size_t n2);

_gsl_matrix_float_view
gsl_matrix_float_view_array_with_tda (MpIeee * base, 
                                      const size_t n1, 
                                      const size_t n2,
                                      const size_t tda);
...
_gsl_matrix_float_const_view
gsl_matrix_float_const_view_array (const MpIeee * base,
                                   const size_t n1, 
                                   const size_t n2);

_gsl_matrix_float_const_view
gsl_matrix_float_const_view_array_with_tda (const MpIeee * base, 
                                            const size_t n1, 
                                            const size_t n2,
                                            const size_t tda);
...
MpIeee gsl_matrix_float_get(const gsl_matrix_float * m, const size_t i, const size_t j);
void    gsl_matrix_float_set(gsl_matrix_float * m, const size_t i, const size_t j, const MpIeee x);

MpIeee * gsl_matrix_float_ptr(gsl_matrix_float * m, const size_t i, const size_t j);
const MpIeee * gsl_matrix_float_const_ptr(const gsl_matrix_float * m, const size_t i, const size_t j);

void gsl_matrix_float_set_zero (gsl_matrix_float * m);
void gsl_matrix_float_set_identity (gsl_matrix_float * m);
void gsl_matrix_float_set_all (gsl_matrix_float * m, MpIeee x);
...
MpIeee gsl_matrix_float_max(const gsl_matrix_float * m);
MpIeee gsl_matrix_float_min(const gsl_matrix_float * m);
void gsl_matrix_float_minmax (const gsl_matrix_float * m, MpIeee * min_out, MpIeee * max_out);
...
int  gsl_matrix_float_scale(gsl_matrix_float * a, const MpIeee x);
int  gsl_matrix_float_add_constant(gsl_matrix_float * a, const MpIeee x);
int  gsl_matrix_float_add_diagonal(gsl_matrix_float * a, const MpIeee x);
...
extern inline 
void
gsl_matrix_float_set(gsl_matrix_float * m, const size_t i, const size_t j, const MpIeee x)
{
#if GSL_RANGE_CHECK
  if (i >= m->size1)
    {
...
#endif
  return (MpIeee *) (m->data + (i * m->tda + j)) ;
} 
...
#endif
  return (const const MpIeee *) (m->data + (i * m->tda + j)) ;
} 
