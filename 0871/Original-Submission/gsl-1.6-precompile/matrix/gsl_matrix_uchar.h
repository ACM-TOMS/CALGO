...
int  gsl_matrix_uchar_scale(gsl_matrix_uchar * a, const MpIeee x);
int  gsl_matrix_uchar_add_constant(gsl_matrix_uchar * a, const MpIeee x);
int  gsl_matrix_uchar_add_diagonal(gsl_matrix_uchar * a, const MpIeee x);
