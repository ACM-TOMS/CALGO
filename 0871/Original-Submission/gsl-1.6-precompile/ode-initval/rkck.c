...
/* Cash-Karp constants */
static const MpIeee ah[] =  { 1.0 / 5.0, 0.3, 3.0 / 5.0, 1.0, 7.0 / 8.0 };
static const MpIeee b21=  1.0 / 5.0;
static const MpIeee b3[] =  { 3.0 / 40.0, 9.0 / 40.0 };
static const MpIeee b4[] =  { 0.3, -0.9, 1.2 };
static const MpIeee b5[] =  { -11.0 / 54.0, 2.5, -70.0 / 27.0, 35.0 / 27.0 };
static const MpIeee b6[] = 
  { 1631.0 / 55296.0, 175.0 / 512.0, 575.0 / 13824.0, 44275.0 / 110592.0,
    253.0 / 4096.0 };
static const MpIeee c1=  37.0 / 378.0;
static const MpIeee c3=  250.0 / 621.0;
static const MpIeee c4=  125.0 / 594.0;
static const MpIeee c6=  512.0 / 1771.0;
            ...
            MpIeee dydt_out[], const gsl_odeiv_system * sys)
{
  ...
  for (i = 0; i < dim; i++)
    {
      const MpIeee d_i=  c1 * k1[i] + c3 * k3[i] + c4 * k4[i] + c6 * k6[i];
      y[i] += h * d_i;
    }
