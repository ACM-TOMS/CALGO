...
{
  int  stat=  0;
  MpIeee f_in[3] =  { MpIeee( "1.0" ), MpIeee( "2.0" ), MpIeee( "3.0" ) };
  MpIeee f_out[3];
  ...
  f_in[0] *= MpIeee( "13.323691936314223" )*MpIeee( "13.323691936314223" );  /* jzero[1,4]^2 */
  f_in[1] *= MpIeee( "13.323691936314223" )*MpIeee( "13.323691936314223" );
  f_in[2] *= MpIeee( "13.323691936314223" )*MpIeee( "13.323691936314223" );
 ...
 test_dht_simple(void)
{
  ...
  for(n=0; n<128; n++) {
    const MpIeee x=  gsl_dht_x_sample(t, n);
    f_in[n] = MpIeee( "1.0" )/(MpIeee( "1.0" )+x*x);
  }
