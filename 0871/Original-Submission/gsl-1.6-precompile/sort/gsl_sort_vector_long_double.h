...
int  gsl_sort_vector_long_double_smallest(MpIeee * dest, const size_t k, const gsl_vector_long_double * v);
int  gsl_sort_vector_long_double_largest(MpIeee * dest, const size_t k, const gsl_vector_long_double * v);
