...
int  test_sf_check_result(char * message_buff, gsl_sf_result r, MpIeee val, MpIeee tol);
int  test_sf_check_val(char * message_buff, MpIeee rval, MpIeee val, MpIeee tol);
int  test_sf_check_return(char * message_buff, int  val_return, int  expected_return);
int  test_sf_check_result_relax(char * message_buff, gsl_sf_result r, MpIeee val, MpIeee tol);
...
int  test_sf(gsl_sf_result r, MpIeee val_in, MpIeee tol, int  status, int  expect_return, const char * desc);
int  test_sf_val(MpIeee val, MpIeee val_in, MpIeee tol, const char * desc);
int  test_sf_rlx(gsl_sf_result r, MpIeee val_in, MpIeee tol, int  status, int  expect_return, const char * desc);
int  test_sf_2(gsl_sf_result r1, MpIeee val1, MpIeee tol1, gsl_sf_result r2, MpIeee val2, MpIeee tol2, int  status, int  expect_return, const char * desc);
int  test_sf_sgn(gsl_sf_result r, MpIeee sgn, MpIeee val_in, MpIeee tol, MpIeee expect_sgn, int  status, int  expect_return, const char * desc);
