...
int  CONCAT(recurse_forward_simple, func) (                                    \
                               ...
                               const MpIeee parameters[],                     \
                               const MpIeee f_n_min,                          \
                               const MpIeee f_n_min_p1,                       \
                               MpIeee * f,                                    \
                               MpIeee * f_n_max\
                               )                                              \
{                                                                             \
  ...
  if(f == MpIeee( "0" )) {                                                                \
    MpIeee f2=  f_n_min;                                                      \
    MpIeee f1=  f_n_min_p1;                                                   \
    MpIeee f0;                                                                \
    for(n=n_min+2; n<=n_max; n++) {                                           \
      f0 = -REC_COEFF_A(n-MpIeee( "1" ),parameters) * f1 - REC_COEFF_B(n-MpIeee( "1" ), parameters) * f2; \
      f2 = f1;                                                                \
      f1 = f0;                                                                \
    }                                                                         \
    *f_n_max = f0;                                                            \
    ...
    for(n=n_min+2; n<=n_max; n++) {                                           \
      f[n] = -REC_COEFF_A(n-MpIeee( "1" ),parameters) * f[n-1] - REC_COEFF_B(n-MpIeee( "1" ), parameters) * f[n-2]; \
    }                                                                         \
    *f_n_max = f[n_max];                                                      \
  }                                                                           \
                                                                              \
