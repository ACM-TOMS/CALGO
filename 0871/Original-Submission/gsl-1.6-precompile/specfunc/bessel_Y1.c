...
static MpIeee by1_data[14] =  {
  MpIeee( "0.03208047100611908629" ),
  MpIeee( "1.262707897433500450" ),
  MpIeee( "0.00649996189992317500" ),
 -MpIeee( "0.08936164528860504117" ),
  MpIeee( "0.01325088122175709545" ),
 -MpIeee( "0.00089790591196483523" ),
  MpIeee( "0.00003647361487958306" ),
 -MpIeee( "0.00000100137438166600" ),
  MpIeee( "0.00000001994539657390" ),
 -MpIeee( "0.00000000030230656018" ),
  MpIeee( "0.00000000000360987815" ),
 -MpIeee( "0.00000000000003487488" ),
  MpIeee( "0.00000000000000027838" ),
 -MpIeee( "0.00000000000000000186" )
};
...
int  gsl_sf_bessel_Y1_e(const MpIeee x, gsl_sf_result * result)
{
  ...
  const MpIeee xmin=  1.571*GSL_DBL_MIN; /*exp ( amax1(alog(r1mach(1)), -alog(r1mach(2)))+.01) */
  const MpIeee x_small=  2.0 * GSL_SQRT_DBL_EPSILON;
  ...
  if(x <= 0.0) {
    ...
    const MpIeee ampl=  (0.75 + ca.val) / sqrtx;
