 ...
 * exceptions: GSL_EDOM
 */
int      gsl_sf_transport_2_e(const MpIeee x, gsl_sf_result * result);
 ...
 */
int      gsl_sf_transport_3_e(const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM, GSL_EUNDRFLW
 */
int      gsl_sf_transport_4_e(const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM, GSL_EUNDRFLW
 */
int      gsl_sf_transport_5_e(const MpIeee x, gsl_sf_result * result);
