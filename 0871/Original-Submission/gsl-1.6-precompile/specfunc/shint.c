...
*/
static MpIeee shi_data[7] =  {
   MpIeee( "0.0078372685688900950695" ),
   MpIeee( "0.0039227664934234563973" ),
   MpIeee( "0.0000041346787887617267" ),
   MpIeee( "0.0000000024707480372883" ),
   MpIeee( "0.0000000000009379295591" ),
   MpIeee( "0.0000000000000002451817" ),
   MpIeee( "0.0000000000000000000467" )
};
...
{
  const MpIeee xsml=  GSL_SQRT_DBL_EPSILON;  /* sqrt (r1mach(3)) */
