 ...
 */
int  gsl_sf_lngamma_e(MpIeee x, gsl_sf_result * result);
MpIeee gsl_sf_lngamma(const MpIeee x);
 ...
 * exceptions: GSL_EDOM, GSL_EROUND
 */
int  gsl_sf_lngamma_sgn_e(MpIeee x, gsl_sf_result * result_lg, MpIeee *sgn);
 ...
 */
int  gsl_sf_gamma_e(const MpIeee x, gsl_sf_result * result);
MpIeee gsl_sf_gamma(const MpIeee x);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_gammastar_e(const MpIeee x, gsl_sf_result * result);
MpIeee gsl_sf_gammastar(const MpIeee x);
 ...
 */
int  gsl_sf_gammainv_e(const MpIeee x, gsl_sf_result * result);
MpIeee gsl_sf_gammainv(const MpIeee x);
 ...
 */
int  gsl_sf_lngamma_complex_e(MpIeee zr, MpIeee zi, gsl_sf_result * lnr, gsl_sf_result * arg);
 ...
 */
int  gsl_sf_taylorcoeff_e(const int n, const MpIeee x, gsl_sf_result * result);
MpIeee gsl_sf_taylorcoeff(const int n, const MpIeee x);
...
MpIeee gsl_sf_fact(const unsigned int  n);
...
MpIeee gsl_sf_doublefact(const unsigned int  n);
...
MpIeee gsl_sf_lnfact(const unsigned int  n);
...
MpIeee gsl_sf_lndoublefact(const unsigned int  n);
...
MpIeee gsl_sf_lnchoose(unsigned int  n, unsigned int  m);
...
MpIeee gsl_sf_choose(unsigned int  n, unsigned int  m);
 ...
 * exceptions:  GSL_EDOM
 */
int  gsl_sf_lnpoch_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions:  GSL_EDOM
 */
int  gsl_sf_lnpoch_sgn_e(const MpIeee a, const MpIeee x, gsl_sf_result * result, MpIeee * sgn);
 ...
 * exceptions:  GSL_EDOM, GSL_EOVRFLW
 */
int  gsl_sf_poch_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions:  GSL_EDOM
 */
int  gsl_sf_pochrel_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_gamma_inc_Q_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_gamma_inc_P_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_gamma_inc_e(const MpIeee a, const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_lnbeta_e(const MpIeee a, const MpIeee b, gsl_sf_result * result);
MpIeee gsl_sf_lnbeta(const MpIeee a, const MpIeee b);
 ...
 * exceptions: GSL_EDOM, GSL_EOVRFLW, GSL_EUNDRFLW
 */
int  gsl_sf_beta_e(const MpIeee a, const MpIeee b, gsl_sf_result * result);
MpIeee gsl_sf_beta(const MpIeee a, const MpIeee b);
 ...
 */
int  gsl_sf_beta_inc_e(const MpIeee a, const MpIeee b, const MpIeee x, gsl_sf_result * result);
