...
MpIeee gsl_rng_uniform(const gsl_rng * r);
MpIeee gsl_rng_uniform_pos(const gsl_rng * r);
...
extern inline MpIeee gsl_rng_uniform(const gsl_rng * r);
...
extern inline MpIeee gsl_rng_uniform_pos(const gsl_rng * r);
