...
static MpIeee ran2_get_double(void *vstate);
...
static MpIeee ran2_get_double(void *vstate)
{
  MpIeee x_max=  MpIeee( "1" ) - MpIeee( "1.2e-7f" ) ; /* Numerical Recipes version of 1-FLT_EPS */

  MpIeee x=  ran2_get (vstate) / MpIeee( "2147483563.0f" ) ;
