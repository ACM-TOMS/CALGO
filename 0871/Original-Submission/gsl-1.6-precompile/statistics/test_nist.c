 ...
 test_nist(void)
{
  ...
  const MpIeee pidigits[5000] =  { 3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8,
  ...
  const MpIeee numacc1[3] =  { 10000001, 10000003, 10000002 } ;
  ...
  numacc2[0] = MpIeee( "1.2" ) ;
  numacc3[0] = MpIeee( "1000000.2" ) ; 
  numacc4[0] = MpIeee( "10000000.2" ) ; 
 
  for (i = 1 ; i < 1000  ; i += 2) 
    {
      numacc2[i] = MpIeee( "1.1" ) ;
      numacc2[i+1] = MpIeee( "1.3" ) ;
      numacc3[i] = MpIeee( "1000000.1" ) ;
      numacc3[i+1] = MpIeee( "1000000.3" ) ;
      numacc4[i] = MpIeee( "10000000.1" ) ;
      numacc4[i+1] = MpIeee( "10000000.3" ) ;
    }

  gsl_ieee_env_setup ();

  {
    MpIeee mean=  gsl_stats_mean (lew, MpIeee( "1" ), nlew);
    MpIeee sd=  gsl_stats_sd (lew, MpIeee( "1" ), nlew);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (lew, MpIeee( "1" ), nlew);

    MpIeee expected_mean=  -MpIeee( "177.435000000000" );
    MpIeee expected_sd=  MpIeee( "277.332168044316" );
    MpIeee expected_lag1=  -MpIeee( "0.307304800605679" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (lottery, MpIeee( "1" ), nlottery);
    MpIeee sd=  gsl_stats_sd (lottery, MpIeee( "1" ), nlottery);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (lottery, MpIeee( "1" ), nlottery);

    MpIeee expected_mean=  MpIeee( "518.958715596330" );
    MpIeee expected_sd=  MpIeee( "291.699727470969" );
    MpIeee expected_lag1=  -MpIeee( "0.120948622967393" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (mavro, MpIeee( "1" ), nmavro);
    MpIeee sd=  gsl_stats_sd (mavro, MpIeee( "1" ), nmavro);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (mavro, MpIeee( "1" ), nmavro);

    MpIeee expected_mean=  MpIeee( "2.00185600000000" );
    MpIeee expected_sd=  MpIeee( "0.000429123454003053" );
    MpIeee expected_lag1=  MpIeee( "0.937989183438248" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (michelson, MpIeee( "1" ), nmichelson);
    MpIeee sd=  gsl_stats_sd (michelson, MpIeee( "1" ), nmichelson);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (michelson, MpIeee( "1" ), nmichelson);

    MpIeee expected_mean=  MpIeee( "299.852400000000" );
    MpIeee expected_sd=  MpIeee( "0.0790105478190518" );
    MpIeee expected_lag1=  MpIeee( "0.535199668621283" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (pidigits, MpIeee( "1" ), npidigits);
    MpIeee sd=  gsl_stats_sd (pidigits, MpIeee( "1" ), npidigits);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (pidigits, MpIeee( "1" ), npidigits);

    MpIeee expected_mean=  MpIeee( "4.53480000000000" );
    MpIeee expected_sd=  MpIeee( "2.86733906028871" );
    MpIeee expected_lag1=  -MpIeee( "0.00355099287237972" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (numacc1, MpIeee( "1" ), nacc1);
    MpIeee sd=  gsl_stats_sd (numacc1, MpIeee( "1" ), nacc1);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (numacc1, MpIeee( "1" ), nacc1);

    MpIeee expected_mean=  MpIeee( "10000002" );
    MpIeee expected_sd=  MpIeee( "1" );
    MpIeee expected_lag1=  -MpIeee( "0.5" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (numacc2, MpIeee( "1" ), nacc2);
    MpIeee sd=  gsl_stats_sd (numacc2, MpIeee( "1" ), nacc2);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (numacc2, MpIeee( "1" ), nacc2);

    MpIeee expected_mean=  MpIeee( "1.2" );
    MpIeee expected_sd=  MpIeee( "0.1" );
    MpIeee expected_lag1=  -MpIeee( "0.999" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (numacc3, MpIeee( "1" ), nacc3);
    MpIeee sd=  gsl_stats_sd (numacc3, MpIeee( "1" ), nacc3);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (numacc3, MpIeee( "1" ), nacc3);

    MpIeee expected_mean=  MpIeee( "1000000.2" );
    MpIeee expected_sd=  MpIeee( "0.1" );
    MpIeee expected_lag1=  -MpIeee( "0.999" );
  ...
  {
    MpIeee mean=  gsl_stats_mean (numacc4, MpIeee( "1" ), nacc4);
    MpIeee sd=  gsl_stats_sd (numacc4, MpIeee( "1" ), nacc4);
    MpIeee lag1=  gsl_stats_lag1_autocorrelation (numacc4, MpIeee( "1" ), nacc4);

    MpIeee expected_mean=  MpIeee( "10000000.2" );
    MpIeee expected_sd=  MpIeee( "0.1" );
    MpIeee expected_lag1=  -MpIeee( "0.999" );
