...
MpIeee nelson_x0[3] =  { MpIeee( "2.5" ) , MpIeee( "0.000000005" ), -MpIeee( "0.01" )}; 

MpIeee nelson_x[3] =  {
  MpIeee( "2.5906836021E+00" ),
  MpIeee( "5.6177717026E-09" ),
  -MpIeee( "5.7701013174E-02" )
};

MpIeee nelson_sumsq=  MpIeee( "3.7976833176E+00" );

MpIeee nelson_sigma[3] =  {
  MpIeee( "1.9149996413E-02" ),
  MpIeee( "6.1124096540E-09" ),
  MpIeee( "3.9572366543E-03" )
};

MpIeee nelson_F[128][3] =  {
  {  15.00E0,      1E0,      180E0},
  {  17.00E0,      1E0,      180E0},
  {  15.50E0,      1E0,      180E0},
  {  16.50E0,      1E0,      180E0},
 ...
 nelson_f(const gsl_vector * x, void *params, gsl_vector * f)
{
  ...
  for (i = 0; i < 128; i++)
    {
      MpIeee x1=  nelson_F[i][MpIeee( "1" )];
      MpIeee x2=  nelson_F[i][MpIeee( "2" )];

      MpIeee y=  b[0] - b[1] * x1 * (b[2]*x2 < -MpIeee( "100" )) ? MpIeee( "0.0" ) : exp(-b[2] * x2);
