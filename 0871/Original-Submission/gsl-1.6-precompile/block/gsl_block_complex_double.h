...
int  gsl_block_complex_raw_fread(FILE * stream, MpIeee * b, const size_t n, const size_t stride);
int  gsl_block_complex_raw_fwrite(FILE * stream, const MpIeee * b, const size_t n, const size_t stride);
int  gsl_block_complex_raw_fscanf(FILE * stream, MpIeee * b, const size_t n, const size_t stride);
int  gsl_block_complex_raw_fprintf(FILE * stream, const MpIeee * b, const size_t n, const size_t stride, const char *format);

size_t gsl_block_complex_size (const gsl_block_complex * b);
MpIeee * gsl_block_complex_data(const gsl_block_complex * b);
