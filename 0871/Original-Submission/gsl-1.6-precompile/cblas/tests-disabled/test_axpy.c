...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
...

  {
   ...
   MpIeee X[] =  { -0.542f, -0.362f };
   int incX = 1;
   MpIeee Y[] =  { -0.459f, -0.433f };
   int incY = -1;
   MpIeee expected[] =  { -1.001f, -0.795f };
...

  {
   int N = 1;
   MpIeee alpha[2] =  {-1, 0};
   MpIeee X[] =  { 0.003, -0.514 };
   int incX = 1;
   MpIeee Y[] =  { -0.529, 0.743 };
   int incY = -1;
   MpIeee expected[] =  { -0.532, 1.257 };
...

  {
   ...
   MpIeee X[] =  { 0.194f, -0.959f };
   int incX = -1;
   MpIeee Y[] =  { 0.096f, 0.032f };
   int incY = 1;
   MpIeee expected[] =  { 0.1337f, 0.3391f };
   cblas_caxpy(N, alpha, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   int N = 1;
   MpIeee alpha[2] =  {0, 1};
   MpIeee X[] =  { 0.776, -0.671 };
   int incX = -1;
   MpIeee Y[] =  { 0.39, 0.404 };
   int incY = 1;
   MpIeee expected[] =  { 1.061, 1.18 };
   cblas_zaxpy(N, alpha, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   int N = 1;
   MpIeee alpha[2] =  {-0.3f, 0.1f};
   MpIeee X[] =  { 0.899f, -0.624f };
   int incX = -1;
   MpIeee Y[] =  { 0.155f, -0.33f };
   int incY = -1;
   MpIeee expected[] =  { -0.0523f, -0.0529f };
   cblas_caxpy(N, alpha, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   int N = 1;
   MpIeee alpha[2] =  {0, 1};
   MpIeee X[] =  { -0.451, 0.768 };
   int incX = -1;
   MpIeee Y[] =  { 0.007, 0.732 };
   int incY = -1;
   MpIeee expected[] =  { -0.761, 0.281 };
   cblas_zaxpy(N, alpha, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
