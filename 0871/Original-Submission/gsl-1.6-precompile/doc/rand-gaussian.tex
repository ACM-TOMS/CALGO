...
%%CreationDate: Mon Oct 11 13:28:28 2004
%%DocumentFonts: 
...
\put(1950,2226){\cjust{Gaussian Distribution}}%
\put(1950,50){\cjust{$x$}}%
\put(100,1188){%
...
\put(400,1721){\rjust{ 0.4}}%
\put(400,1366){\rjust{ 0.3}}%
\put(400,1010){\rjust{ 0.2}}%
\put(400,655){\rjust{ 0.1}}%
\put(400,300){\rjust{ 0}}%
\endGNUPLOTpicture
\endgroup
\endinput
