...
gsl_histogram *
gsl_histogram_calloc_range (size_t n, MpIeee *range)
{
  size_t i;
  gsl_histogram *h;
  ...
  h->range = new MpIeee[n+1]; //(MpIeee *) malloc ((n + MpIeee( "1" )) * sizeof (MpIeee));
  ...
  h->bin = new MpIeee[n]; //(MpIeee*) malloc (n * sizeof (MpIeee));
