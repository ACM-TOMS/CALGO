...
gsl_function make_function (MpIeee(* f) (MpIeee, void *), MpIeee * p);
...
MpIeee counter(MpIeee x, void * params);
...
int main (void)
{
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049357767090777E-02" );
    MpIeee exp_abserr=  MpIeee( "2.990224871000550874E-06" );
    MpIeee exp_resabs=  MpIeee( "7.716049357767090777E-02" );
    MpIeee exp_resasc=  MpIeee( "4.434273814139995384E-02" );

    MpIeee alpha=  MpIeee( "2.6" ) ;
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049379303084599E-02" );
    MpIeee exp_abserr=  MpIeee( "9.424302194248481445E-08" );
    MpIeee exp_resabs=  MpIeee( "7.716049379303084599E-02" );
    MpIeee exp_resasc=  MpIeee( "4.434311425038358484E-02" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049382494900855E-02" );
    MpIeee exp_abserr=  MpIeee( "1.713503193600029893E-09" );
    MpIeee exp_resabs=  MpIeee( "7.716049382494900855E-02" );
    MpIeee exp_resasc=  MpIeee( "4.427995051868838933E-02" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049382681375302E-02" );
    MpIeee exp_abserr=  MpIeee( "9.576386660975511224E-11" );
    MpIeee exp_resabs=  MpIeee( "7.716049382681375302E-02" );
    MpIeee exp_resasc=  MpIeee( "4.421521169637691873E-02" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049382708510540E-02" );
    MpIeee exp_abserr=  MpIeee( "1.002079980317363772E-11" );
    MpIeee exp_resabs=  MpIeee( "7.716049382708510540E-02" );
    MpIeee exp_resasc=  MpIeee( "4.416474291216854892E-02" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049382713800753E-02" );
    MpIeee exp_abserr=  MpIeee( "1.566060362296155616E-12" );
    MpIeee exp_resabs=  MpIeee( "7.716049382713800753E-02" );
    MpIeee exp_resasc=  MpIeee( "4.419287685934316506E-02" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "1.555688196612745777E+01" );
    MpIeee exp_abserr=  MpIeee( "2.350164577239293706E+01" );
    MpIeee exp_resabs=  MpIeee( "1.555688196612745777E+01" );
    MpIeee exp_resasc=  MpIeee( "2.350164577239293706E+01" );

    MpIeee alpha=  -MpIeee( "0.9" ) ;
    gsl_function f = make_function(&f1, &alpha);
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "1.799045317938126232E+01" );
    MpIeee exp_abserr=  MpIeee( "2.782360287710622515E+01" );
    MpIeee exp_resabs=  MpIeee( "1.799045317938126232E+01" );
    MpIeee exp_resasc=  MpIeee( "2.782360287710622515E+01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "2.081873305159121657E+01" );
    MpIeee exp_abserr=  MpIeee( "3.296500137482590276E+01" );
    MpIeee exp_resabs=  MpIeee( "2.081873305159121301E+01" );
    MpIeee exp_resasc=  MpIeee( "3.296500137482590276E+01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "2.288677623903126701E+01" );
    MpIeee exp_abserr=  MpIeee( "3.671538820274916048E+01" );
    MpIeee exp_resabs=  MpIeee( "2.288677623903126701E+01" );
    MpIeee exp_resasc=  MpIeee( "3.671538820274916048E+01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "2.449953612016972215E+01" );
    MpIeee exp_abserr=  MpIeee( "3.967771249391228849E+01" );
    MpIeee exp_resabs=  MpIeee( "2.449953612016972215E+01" );
    MpIeee exp_resasc=  MpIeee( "3.967771249391228849E+01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "2.583030240976628988E+01" );
    MpIeee exp_abserr=  MpIeee( "4.213750493076978643E+01" );
    MpIeee exp_resabs=  MpIeee( "2.583030240976628988E+01" );
    MpIeee exp_resasc=  MpIeee( "4.213750493076978643E+01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575483799046E-01" );
    MpIeee exp_abserr=  MpIeee( "8.760080200939757174E-06" );
    MpIeee exp_resabs=  MpIeee( "1.165564172429140788E+00" );
    MpIeee exp_resasc=  MpIeee( "9.334560307787327371E-01" );

    MpIeee alpha=  MpIeee( "1.3" ) ;
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482959717E-01" );
    MpIeee exp_abserr=  MpIeee( "7.999213141433641888E-11" );
    MpIeee exp_resabs=  MpIeee( "1.150829032708484023E+00" );
    MpIeee exp_resasc=  MpIeee( "9.297591249133687619E-01" );
...

  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482959717E-01" );
    MpIeee exp_abserr=  MpIeee( "1.285805464427459261E-14" );
    MpIeee exp_resabs=  MpIeee( "1.158150602093290571E+00" );
    MpIeee exp_resasc=  MpIeee( "9.277828092501518853E-01" );
...

  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482959717E-01" );
    MpIeee exp_abserr=  MpIeee( "1.286535726271015626E-14" );
    MpIeee exp_resabs=  MpIeee( "1.158808363486595328E+00" );
    MpIeee exp_resasc=  MpIeee( "9.264382258645686985E-01" );
  ...
  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482961938E-01" );
    MpIeee exp_abserr=  MpIeee( "1.285290995039385778E-14" );
    MpIeee exp_resabs=  MpIeee( "1.157687209264406381E+00" );
    MpIeee exp_resasc=  MpIeee( "9.264666884071264263E-01" );
...

  {
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" );MpIeee  resabs=  MpIeee( "0" );MpIeee  resasc=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482959717E-01" );
    MpIeee exp_abserr=  MpIeee( "1.286438572027470736E-14" );
    MpIeee exp_resabs=  MpIeee( "1.158720854723590099E+00" );
    MpIeee exp_resasc=  MpIeee( "9.270469641771273972E-01" );
...

  {
    ...
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" ) ;
    MpIeee exp_result=  MpIeee( "7.716049379303083211E-02" );
    MpIeee exp_abserr=  MpIeee( "9.424302199601294244E-08" );
    int  exp_neval=   21;
    int  exp_ier=    0;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "7.716049382706505200E-02" );
    MpIeee exp_abserr=  MpIeee( "2.666893044866214501E-12" );
    int  exp_neval=   43;
    int  exp_ier=    0;
...

  {
    ...
    MpIeee result=  MpIeee( "0" );MpIeee  abserr=  MpIeee( "0" ) ;
    MpIeee exp_result= -MpIeee( "7.238969575482961938E-01" );
    MpIeee exp_abserr=  MpIeee( "1.277676889520056369E-14" );
    int  exp_neval=   43;
    int  exp_ier=    0;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "7.716049382716029525E-02" );
    MpIeee exp_abserr=  MpIeee( "8.566535680046930668E-16" );
    int  exp_neval=   87;
    int  exp_ier=    0;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "3.222948711817264211E+01" );
    MpIeee exp_abserr=  MpIeee( "2.782360287710622870E+01" );
    int  exp_neval=   87;
  ...
  {
    int  status=  0;int   i; struct counter_params p;
    MpIeee result=  MpIeee( "0" );MpIeee  abserr= MpIeee( "0" );

    gsl_integration_workspace * w = gsl_integration_workspace_alloc (1000) ;

    MpIeee exp_result=  MpIeee( "7.716049382715854665E-02" ) ;
    MpIeee exp_abserr=  MpIeee( "6.679384885865053037E-12" ) ;
    int  exp_neval=      165;
    int  exp_ier=        0;
    int  exp_last=        6;

    MpIeee a[6] =  { MpIeee( "0" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ), MpIeee( "0.0625" ), MpIeee( "0.03125" ) } ;
    MpIeee b[6] =  { MpIeee( "0.03125" ), MpIeee( "1" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ), MpIeee( "0.0625" ) } ;
    MpIeee r[6] =  { MpIeee( "3.966769831709074375E-06" ), MpIeee( "5.491842501998222409E-02" ),
                    MpIeee( "1.909827770934243926E-02" ), MpIeee( "2.776531175604360531E-03" ),
                    MpIeee( "3.280661030752063693E-04" ), MpIeee( "3.522704932261797744E-05" ) } ;
    MpIeee e[6] =  { MpIeee( "6.678528276336181873E-12" ), MpIeee( "6.097169993333454062E-16" ),
                    MpIeee( "2.120334764359736934E-16" ), MpIeee( "3.082568839745514608E-17" ),
                    MpIeee( "3.642265412331439511E-18" ), MpIeee( "3.910988124757650942E-19" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "7.716049382716050342E-02" ) ;
    MpIeee exp_abserr=  MpIeee( "2.227969521869139532E-15" ) ;
    int  exp_neval=      315;
    int  exp_ier=        0;
    int  exp_last=        8;

    MpIeee a[8] =  { MpIeee( "0" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ), MpIeee( "0.0625" ), MpIeee( "0.03125" ), MpIeee( "0.015625" ),
                    MpIeee( "0.0078125" ) } ;
    MpIeee b[8] =  { MpIeee( "0.0078125" ), MpIeee( "1" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ), MpIeee( "0.0625" ), MpIeee( "0.03125" ),
                    MpIeee( "0.015625" ) } ;
    MpIeee r[8] =  { MpIeee( "3.696942726831556522E-08" ), MpIeee( "5.491842501998223103E-02" ),
                    MpIeee( "1.909827770934243579E-02" ), MpIeee( "2.776531175604360097E-03" ),
                    MpIeee( "3.280661030752062609E-04" ), MpIeee( "3.522704932261797744E-05" ),
                    MpIeee( "3.579060884684503576E-06" ), MpIeee( "3.507395216921808047E-07" ) } ;
    MpIeee e[8] =  { MpIeee( "1.371316364034059572E-15" ), MpIeee( "6.097169993333454062E-16" ),
                    MpIeee( "2.120334764359736441E-16" ), MpIeee( "3.082568839745514608E-17" ),
                    MpIeee( "3.642265412331439511E-18" ), MpIeee( "3.910988124757650460E-19" ),
                    MpIeee( "3.973555800712018091E-20" ), MpIeee( "3.893990926286736620E-21" ) } ;
...

  {
    ...
    MpIeee exp_result=   MpIeee( "9.565151449233894709" ) ;
    MpIeee exp_abserr=   MpIeee( "1.570369823891028460E+01" );
    int  exp_neval=      305;
    int  exp_ier=      GSL_EMAXITER;
    int  exp_last=      3;

    MpIeee a[3] =  { -MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "0.000000000000000000" ),
                    -MpIeee( "1.000000000000000000" ) } ;
    
    MpIeee b[3] =  { MpIeee( "0.000000000000000000" ),
                    MpIeee( "1.000000000000000000" ),
                    -MpIeee( "5.000000000000000000E-01" ) } ;
    
    MpIeee r[3] =  { MpIeee( "9.460353469435913709" ),
                    MpIeee( "9.090909090909091161E-02" ),
                    MpIeee( "1.388888888888888812E-02" ) } ;
    
    MpIeee e[3] =  { MpIeee( "1.570369823891028460E+01" ),
                    MpIeee( "1.009293658750142399E-15" ),
                    MpIeee( "1.541976423090495140E-16" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "7.716049382715789440E-02" ) ;
    MpIeee exp_abserr=  MpIeee( "2.216394961010438404E-12" ) ;
    int  exp_neval=      189;
    int  exp_ier=        0;
    int  exp_last=        5;

    MpIeee a[5] =  { MpIeee( "0" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ), MpIeee( "0.0625" ) } ;
    MpIeee b[5] =  { MpIeee( "0.0625" ), MpIeee( "1" ), MpIeee( "0.5" ), MpIeee( "0.25" ), MpIeee( "0.125" ) } ;
    MpIeee r[5] =  { MpIeee( "3.919381915366914693E-05" ),
                    MpIeee( "5.491842501998223103E-02" ),
                    MpIeee( "1.909827770934243579E-02" ),
                    MpIeee( "2.776531175604360097E-03" ),
                    MpIeee( "3.280661030752062609E-04" ) } ;
    MpIeee e[5] =  { MpIeee( "2.215538742580964735E-12" ),
                    MpIeee( "6.097169993333454062E-16" ),
                    MpIeee( "2.120334764359736441E-16" ),
                    MpIeee( "3.082568839745514608E-17" ),
                    MpIeee( "3.642265412331439511E-18" ) } ;
...

  {
    ...
    MpIeee exp_result=  -MpIeee( "5.908755278982136588E+03" ) ;
    MpIeee exp_abserr=  MpIeee( "1.299646281053874554E-10" ) ;
    int  exp_neval=      357;
    int  exp_ier=        0;
    int  exp_last=        9;

    MpIeee a[9] =  { MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "5.005000000000000000E+02" ),
                    MpIeee( "2.507500000000000000E+02" ),
                    MpIeee( "1.258750000000000000E+02" ),
                    MpIeee( "6.343750000000000000E+01" ),
                    MpIeee( "3.221875000000000000E+01" ),
                    MpIeee( "1.660937500000000000E+01" ),
                    MpIeee( "8.804687500000000000E+00" ),
                    MpIeee( "4.902343750000000000E+00" ) } ;
    MpIeee b[9] =  { MpIeee( "4.902343750000000000E+00" ),
                    MpIeee( "1.000000000000000000E+03" ),
                    MpIeee( "5.005000000000000000E+02" ),
                    MpIeee( "2.507500000000000000E+02" ),
                    MpIeee( "1.258750000000000000E+02" ),
                    MpIeee( "6.343750000000000000E+01" ),
                    ...
                    MpIeee( "1.660937500000000000E+01" ),
                    MpIeee( "8.804687500000000000E+00" ) } ;
    MpIeee r[9] =  { -MpIeee( "3.890977835520834649E+00" ),
                    -MpIeee( "3.297343675805121620E+03" ),
                    -MpIeee( "1.475904154146372775E+03" ),
                    -MpIeee( "6.517404019686431411E+02" ),
                    -MpIeee( "2.829354222635842007E+02" ),
                    -MpIeee( "1.201692001973227519E+02" ),
                    -MpIeee( "4.959999906099650246E+01" ),
                    -MpIeee( "1.971441499411640308E+01" ),
                    -MpIeee( "7.457032710459004399E+00" ) } ;
    MpIeee e[9] =  { MpIeee( "6.448276035006137169E-11" ),
                    MpIeee( "3.660786868980994028E-11" ),
                    MpIeee( "1.638582774073219226E-11" ),
                    MpIeee( "7.235772003440423011E-12" ),
                    MpIeee( "3.141214202790722909E-12" ),
                    MpIeee( "1.334146129098576244E-12" ),
                    MpIeee( "5.506706097890446534E-13" ),
                    MpIeee( "2.188739744348345039E-13" ),
                    MpIeee( "8.278969410534525339E-14" ) } ;
...

  {
    ...
    MpIeee exp_result=  -MpIeee( "3.616892186127022568E-01" ) ;
    MpIeee exp_abserr=  MpIeee( "3.016716913328831851E-06" );
    int  exp_neval=       285;
    int  exp_ier=         0;
    int  exp_last=        10;

    MpIeee a[10] =  { MpIeee( "9.687500000000000000E-01" ),
                     MpIeee( "0.000000000000000000E+00" ),
                     MpIeee( "5.000000000000000000E-01" ),
                     MpIeee( "2.500000000000000000E-01" ),
                     MpIeee( "7.500000000000000000E-01" ),
                     MpIeee( "1.250000000000000000E-01" ),
                     MpIeee( "8.750000000000000000E-01" ),
                     MpIeee( "6.250000000000000000E-02" ),
                     MpIeee( "9.375000000000000000E-01" ),
                     MpIeee( "3.125000000000000000E-02" ) } ;
    MpIeee b[10] =  { MpIeee( "1.000000000000000000E+00" ),
                     MpIeee( "3.125000000000000000E-02" ),
                     MpIeee( "7.500000000000000000E-01" ),
                     MpIeee( "5.000000000000000000E-01" ),
                     MpIeee( "8.750000000000000000E-01" ),
                     ...
                     MpIeee( "9.375000000000000000E-01" ),
                     MpIeee( "1.250000000000000000E-01" ),
                     MpIeee( "9.687500000000000000E-01" ),
                     MpIeee( "6.250000000000000000E-02" ) } ;
    MpIeee r[10] =  { -MpIeee( "1.390003415539725340E-01" ),
                     MpIeee( "1.429785306003466313E-03" ),
                     -MpIeee( "1.229943369113085765E-02" ),
                     MpIeee( "2.995321156568048898E-03" ),
                     -MpIeee( "4.980050133751051655E-02" ),
                     MpIeee( "2.785385934678596704E-03" ),
                     -MpIeee( "8.653752279614615461E-02" ),
                     MpIeee( "1.736218164975512294E-03" ),
                     -MpIeee( "8.398745675010892142E-02" ),
                     MpIeee( "1.041689192004495576E-03" ) } ;
    MpIeee e[10] =  { MpIeee( "2.395037249893453013E-02" ),
                     MpIeee( "2.161214992172538524E-04" ),
                     MpIeee( "5.720644840858777846E-14" ),
                     MpIeee( "3.325474514168701167E-17" ),
                     MpIeee( "3.147380432198176412E-14" ),
                     MpIeee( "3.092399597147240624E-17" ),
                     MpIeee( "9.607595030230581153E-16" ),
                     MpIeee( "1.927589382528252344E-17" ),
                     MpIeee( "9.324480826368044019E-16" ),
                     MpIeee( "1.156507325466566521E-17" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "6.553600000000024738E+04" );
    MpIeee exp_abserr=  MpIeee( "7.121667111456009280E-04" );
    int  exp_neval=       285;
    int  exp_ier=         0;
    int  exp_last=        10;

    MpIeee a[10] =  { MpIeee( "0.000000000000000000E+00" ),
                     MpIeee( "5.000000000000000000E-01" ),
                     MpIeee( "2.500000000000000000E-01" ),
                     MpIeee( "1.250000000000000000E-01" ),
                     MpIeee( "6.250000000000000000E-02" ),
                     MpIeee( "3.125000000000000000E-02" ),
                     MpIeee( "1.562500000000000000E-02" ),
                     MpIeee( "7.812500000000000000E-03" ),
                     MpIeee( "3.906250000000000000E-03" ),
                     MpIeee( "1.953125000000000000E-03" ) } ;
    MpIeee b[10] =  { MpIeee( "1.953125000000000000E-03" ),
                     MpIeee( "1.000000000000000000E+00" ),
                     MpIeee( "5.000000000000000000E-01" ),
                     MpIeee( "2.500000000000000000E-01" ),
                     MpIeee( "1.250000000000000000E-01" ),
                     MpIeee( "6.250000000000000000E-02" ),
                     ...
                     MpIeee( "7.812500000000000000E-03" ),
                     MpIeee( "3.906250000000000000E-03" ) } ;
    MpIeee r[10] =  { MpIeee( "1.099297665754340292E+00" ),
                     MpIeee( "3.256176475185617591E-01" ),
                     MpIeee( "8.064694554185326325E+00" ),
                     MpIeee( "8.873128656118993263E+01" ),
                     MpIeee( "6.977679035845269482E+02" ),
                     MpIeee( "4.096981198511257389E+03" ),
                     MpIeee( "1.574317583220441520E+04" ),
                     MpIeee( "2.899418134793237914E+04" ),
                     MpIeee( "1.498314766425578091E+04" ),
                     MpIeee( "9.225251570832365360E+02" ) } ;
    MpIeee e[10] =  { MpIeee( "7.101865971621337814E-04" ),
                     MpIeee( "1.912660677170175771E-08" ),
                     MpIeee( "9.167763417119923333E-08" ),
                     MpIeee( "3.769501719163865578E-07" ),
                     MpIeee( "6.973493131275552509E-07" ),
                     MpIeee( "1.205653952340679711E-07" ),
                     MpIeee( "1.380003928453846583E-07" ),
                     MpIeee( "1.934652413547325474E-07" ),
                     MpIeee( "3.408933028357320364E-07" ),
                     MpIeee( "2.132473175465897029E-09" ) } ;
    int  order[10] =  { 1, 5, 4, 9, 8, 7, 6, 3, 2, 10 } ;

    MpIeee alpha=  MpIeee( "5.0" );
...

  {
    ...
    MpIeee exp_result=  MpIeee( "1.000000000006713292E-04" );
    MpIeee exp_abserr=  MpIeee( "3.084062020905636316E-09" );
    int  exp_neval=       165;
    int  exp_ier=         0;
    int  exp_last=         6;

    MpIeee a[6] =  { MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "6.250000000000000000E-02" ),
                    MpIeee( "3.125000000000000000E-02" ) } ;
    MpIeee b[6] =  { MpIeee( "3.125000000000000000E-02" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "6.250000000000000000E-02" ) } ;
    MpIeee r[6] =  { MpIeee( "7.633587786326674618E-05" ),
                    MpIeee( "9.900990099009899620E-07" ),
                    MpIeee( "1.922522349322310737E-06" ),
                    MpIeee( "3.629434715543053753E-06" ),
                    MpIeee( "6.501422186103209199E-06" ),
                    MpIeee( "1.062064387653501389E-05" ) } ;
    MpIeee e[6] =  { MpIeee( "3.084061858351569051E-09" ),
                    MpIeee( "3.112064814755089674E-17" ),
                    MpIeee( "4.543453652226561245E-17" ),
                    MpIeee( "4.908618166361344548E-17" ),
                    MpIeee( "3.014338672269481784E-17" ),
                    MpIeee( "6.795996738013555461E-18" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "2.275875794468747770E+00" );
    MpIeee exp_abserr=  MpIeee( "7.436490118267390744E-09" );
    int  exp_neval=       270;
    int  exp_ier=         0;
    int  exp_last=         5;

    MpIeee a[5] =  { MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "3.750000000000000000E-01" ) } ;
    MpIeee b[5] =  { MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "3.750000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "5.000000000000000000E-01" ) } ;
    MpIeee r[5] =  { MpIeee( "4.639317228058405717E-04" ),
                    MpIeee( "1.691664195356748834E+00" ),
                    MpIeee( "1.146307471900291086E-01" ),
                    MpIeee( "4.379392477350953574E-20" ),
                    MpIeee( "4.691169201991640669E-01" ) } ;
    MpIeee e[5] =  { MpIeee( "3.169263960393051137E-09" ),
                    MpIeee( "4.265988974874425043E-09" ),
                    MpIeee( "1.231954072964969637E-12" ),
                    MpIeee( "8.360902986775307673E-20" ),
                    MpIeee( "5.208244060463541433E-15" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "2.718281828459044647E+00" );
    MpIeee exp_abserr=  MpIeee( "1.588185109253204805E-10" );
    int  exp_neval=       135;
    int  exp_ier=         0;
    int  exp_last=         5;

    MpIeee a[5] =  { MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "6.250000000000000000E-02" ) } ;
    MpIeee b[5] =  { MpIeee( "6.250000000000000000E-02" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ) } ;
    MpIeee r[5] =  { MpIeee( "8.315287189746029816E-07" ),
                    MpIeee( "1.718281828459045091E+00" ),
                    MpIeee( "8.646647167633871867E-01" ),
                    MpIeee( "1.328565310599463256E-01" ),
                    MpIeee( "2.477920647947255521E-03" ) } ;
    MpIeee e[5] =  { MpIeee( "1.533437090413525935E-10" ),
                    MpIeee( "4.117868247943567505E-12" ),
                    MpIeee( "7.802455785301941044E-13" ),
                    MpIeee( "5.395586026138397182E-13" ),
                    MpIeee( "3.713312434866150125E-14" ) } ;
    int  order[5] =  { 1, 2, 3, 4, 5 } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "5.274080611672716401E+01" );
    MpIeee exp_abserr=  MpIeee( "1.755703848687062418E-04" );
    int  exp_neval=         777;
    int  exp_ier=           0;
    int  exp_last=          20;

    MpIeee a[20] =  { MpIeee( "9.687500000000000000E-01" ),
                    MpIeee( "1.401269388548935790E+00" ),
                    MpIeee( "1.414213562373095145E+00" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "2.207106781186547462E+00" ),
                    MpIeee( "1.810660171779821415E+00" ),
                    MpIeee( "1.207106781186547462E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "1.103553390593273731E+00" ),
                    MpIeee( "1.612436867076458391E+00" ),
                    MpIeee( "1.310660171779821415E+00" ),
                    MpIeee( "7.500000000000000000E-01" ),
                    MpIeee( "1.051776695296636976E+00" ),
                    MpIeee( "1.513325214724776657E+00" ),
                    MpIeee( "1.362436867076458391E+00" ),
                    MpIeee( "8.750000000000000000E-01" ),
                    MpIeee( "1.463769388548935790E+00" ),
                    MpIeee( "1.388325214724776657E+00" ),
                    MpIeee( "9.375000000000000000E-01" )} ;
    MpIeee b[20] =  { MpIeee( "1.000000000000000000E+00" ),
                     MpIeee( "1.414213562373095145E+00" ),
                     MpIeee( "1.463769388548935790E+00" ),
                     MpIeee( "1.051776695296636976E+00" ),
                     MpIeee( "5.000000000000000000E-01" ),
                     MpIeee( "3.000000000000000000E+00" ),
                     MpIeee( "2.207106781186547462E+00" ),
                     MpIeee( "1.310660171779821415E+00" ),
                     MpIeee( "7.500000000000000000E-01" ),
                     MpIeee( "1.207106781186547462E+00" ),
                     ...
                     MpIeee( "1.401269388548935790E+00" ),
                     MpIeee( "9.687500000000000000E-01" )} ;
    MpIeee r[20] =  { -MpIeee( "1.125078814079027711E-01" ),
                     -MpIeee( "1.565132123531515207E-01" ),
                     -MpIeee( "4.225328513207429193E-01" ),
                     -MpIeee( "1.830392049835374568E-01" ),
                     MpIeee( "6.575875041899758092E-03" ),
                     MpIeee( "4.873920540843067783E+01" ),
                     MpIeee( "6.032891565603589079E+00" ),
                     -MpIeee( "2.991531901645863023E-01" ),
                     -MpIeee( "7.326282608704996063E-03" ),
                     -MpIeee( "2.431894410706912923E-01" ),
                     MpIeee( "5.911661670635662835E-01" ),
                     -MpIeee( "2.236786562536174916E-01" ),
                     -MpIeee( "5.647871991778510847E-02" ),
                     -MpIeee( "1.305470403178642658E-01" ),
                     -MpIeee( "1.721363984401322045E-01" ),
                     -MpIeee( "1.589345454585119055E-01" ),
                     -MpIeee( "7.406626263352669715E-02" ),
                     -MpIeee( "2.208730668000830344E-01" ),
                     -MpIeee( "1.048692749517999567E-01" ),
                     -MpIeee( "6.302287584527696551E-02" )} ;
    MpIeee e[20] =  { MpIeee( "2.506431410088378817E-02" ),
                     MpIeee( "2.730454695485963826E-02" ),
                     MpIeee( "1.017446081816190118E-01" ),
                     MpIeee( "3.252808038935910834E-02" ),
                     MpIeee( "7.300687878575027348E-17" ),
                     MpIeee( "5.411138804637469780E-13" ),
                     MpIeee( "6.697855121200013106E-14" ),
                     MpIeee( "3.321267596107916554E-15" ),
                     MpIeee( "1.417509685426979386E-16" ),
                     MpIeee( "2.699945168224041491E-15" ),
                     MpIeee( "6.573952690524728748E-15" ),
                     MpIeee( "2.483331942899818875E-15" ),
                     MpIeee( "6.270397525408045936E-16" ),
                     MpIeee( "1.449363299575615261E-15" ),
                     MpIeee( "1.911097929242846383E-15" ),
                     MpIeee( "1.764527917763735212E-15" ),
                     MpIeee( "8.223007012367522077E-16" ),
                     MpIeee( "2.452183642810224359E-15" ),
                     MpIeee( "1.164282836272345215E-15" ),
                     MpIeee( "6.996944784151910810E-16" )} ;
...

  {
    ...
    MpIeee exp_result=  -MpIeee( "8.994400695837000137E-02" );
    MpIeee exp_abserr=   MpIeee( "1.185290176227023727E-06" );
    int  exp_neval=       215;
    int  exp_ier=         0;
    int  exp_last=         6;

    MpIeee a[6] =  { -MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "2.500000000000000000E+00" ),
                    MpIeee( "1.250000000000000000E+00" ),
                    MpIeee( "6.250000000000000000E-01" ),
                    -MpIeee( "5.000000000000000000E-01" ),
                    -MpIeee( "7.500000000000000000E-01" )} ;
    MpIeee b[6] =  { -MpIeee( "7.500000000000000000E-01" ),
                    MpIeee( "5.000000000000000000E+00" ),
                    MpIeee( "2.500000000000000000E+00" ),
                    MpIeee( "1.250000000000000000E+00" ),
                    MpIeee( "6.250000000000000000E-01" ),
                    -MpIeee( "5.000000000000000000E-01" )} ;
    MpIeee r[6] =  { -MpIeee( "1.234231128040012976E-01" ),
                    MpIeee( "3.579970394639702888E-03" ),
                    MpIeee( "2.249831615049339983E-02" ),
                    MpIeee( "7.214232992127905808E-02" ),
                    MpIeee( "2.079093855884046535E-02" ),
                    -MpIeee( "8.553244917962132821E-02" )} ;
    MpIeee e[6] =  { MpIeee( "1.172832717970022565E-06" ),
                    MpIeee( "9.018232896137375412E-13" ),
                    MpIeee( "1.815172652101790755E-12" ),
                    MpIeee( "1.006998195150956048E-13" ),
                    MpIeee( "1.245463873006391609E-08" ),
                    MpIeee( "1.833082948207153514E-15" ) } ;
...

  {
    ...
    MpIeee exp_result=  -MpIeee( "1.892751853489401670E-01" );
    MpIeee exp_abserr=  MpIeee( "1.129133712015747658E-08" );
    int  exp_neval=       280;
    int  exp_ier=         0;
    int  exp_last=         8;

    MpIeee a[8] =  { MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "6.250000000000000000E-02" ),
                    ...
                    MpIeee( "1.562500000000000000E-02" ),
                    MpIeee( "7.812500000000000000E-03" )} ;
    MpIeee b[8] =  { MpIeee( "7.812500000000000000E-03" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    ...
                    MpIeee( "3.125000000000000000E-02" ),
                    MpIeee( "1.562500000000000000E-02" )} ;
    MpIeee r[8] =  { -MpIeee( "4.126317299834445824E-05" ),
                    -MpIeee( "1.076283950172247789E-01" ),
                    -MpIeee( "6.240573216173390947E-02" ),
                    -MpIeee( "1.456169844189576269E-02" ),
                    -MpIeee( "3.408925115926728436E-03" ),
                    -MpIeee( "8.914083918175634211E-04" ),
                    -MpIeee( "2.574191402137795482E-04" ),
                    -MpIeee( "8.034390712936630608E-05" )} ;
    MpIeee e[8] =  { MpIeee( "1.129099387465713953E-08" ),
                    MpIeee( "3.423394967694403596E-13" ),
                    MpIeee( "6.928428071454762659E-16" ),
                    MpIeee( "1.616673288784094320E-16" ),
                    MpIeee( "3.784667152924835070E-17" ),
                    MpIeee( "9.896621209399419425E-18" ),
                    MpIeee( "2.857926564445496100E-18" ),
                    MpIeee( "8.919965558336773736E-19" )} ;
    int  order[8] =  { 1, 2, 3, 4, 5, 6, 7, 8 } ;
    ...
    exp_result = MpIeee( "9.896686656601706433E-01" );
    exp_abserr = MpIeee( "5.888032513201251628E-08" );
    ...
    exp_result = -MpIeee( "3.636679470586539620E-01" );
    exp_abserr = MpIeee( "2.851348775257054093E-08" );
    ...
    exp_result = -MpIeee( "1.911489253363409802E+00" );
    exp_abserr = MpIeee( "9.854016753016499034E-09" );
    ...
    exp_result = MpIeee( "3.159922862811048172E-01" );
    exp_abserr = MpIeee( "2.336183482198144595E-08" );
...

  {
    ...
    MpIeee exp_result=  -MpIeee( "1.281368483991674190E-01" );
    MpIeee exp_abserr=   MpIeee( "6.875028324415666248E-12" );
    int  exp_neval=       305;
    int  exp_ier=         0;
    int  exp_last=         9;

    MpIeee a[9] =  { MpIeee( "0.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    MpIeee( "6.250000000000000000E-02" ),
                    ...
                    MpIeee( "7.812500000000000000E-03" ),
                    MpIeee( "3.906250000000000000E-03" ) } ;
    MpIeee b[9] =  { MpIeee( "3.906250000000000000E-03" ),
                    MpIeee( "1.000000000000000000E+00" ),
                    MpIeee( "5.000000000000000000E-01" ),
                    MpIeee( "2.500000000000000000E-01" ),
                    MpIeee( "1.250000000000000000E-01" ),
                    ...
                    MpIeee( "1.562500000000000000E-02" ),
                    MpIeee( "7.812500000000000000E-03" ) } ;
    MpIeee r[9] =  { -MpIeee( "1.447193692377651136E-03" ),
                    MpIeee( "2.190541162282139478E-02" ),
                    -MpIeee( "2.587726479625663753E-02" ),
                    MpIeee( "5.483209176363500886E-02" ),
                    -MpIeee( "3.081695575172510582E-02" ),
                    -MpIeee( "9.178321994387816929E-02" ),
                    -MpIeee( "3.886716016498160953E-02" ),
                    -MpIeee( "1.242306301902117854E-02" ),
                    -MpIeee( "3.659495117871544145E-03" )} ;
    MpIeee e[9] =  { MpIeee( "8.326506625798146465E-07" ),
                    MpIeee( "1.302638552580516100E-13" ),
                    MpIeee( "7.259224351945759794E-15" ),
                    MpIeee( "1.249770395036711102E-14" ),
                    MpIeee( "7.832180081562836579E-16" ),
                    MpIeee( "1.018998440559284116E-15" ),
                    MpIeee( "4.315121611695628020E-16" ),
                    MpIeee( "1.379237060008662177E-16" ),
                    MpIeee( "4.062855738364339357E-17" ) } ;
...

  {
    ...
    MpIeee exp_result=  MpIeee( "9.999999999279802765E-01" );
    MpIeee exp_abserr=  MpIeee( "1.556289974669056164E-08" );
    int  exp_neval=       590;
    int  exp_ier=         0;
    int  exp_last=        12;

    MpIeee r[12] =  { MpIeee( "1.013283128125232802E+00" ),
                    -MpIeee( "1.810857954748607349E-02" ),
                    MpIeee( "7.466754034900931897E-03" ),
                    -MpIeee( "4.360312526786496237E-03" ),
                    MpIeee( "2.950184068216192904E-03" ),
                    -MpIeee( "2.168238443073697373E-03" ),
                    MpIeee( "1.680910783140869081E-03" ),
                    -MpIeee( "1.352797860944863345E-03" ),
                    MpIeee( "1.119354921991485901E-03" ),
                    -MpIeee( "9.462367583691360827E-04" ),
                    MpIeee( "8.136341270731781887E-04" ),
                    -MpIeee( "7.093931338504278145E-04" ) } ;
    MpIeee e[12] =  { MpIeee( "1.224798040766472695E-12" ),
                    MpIeee( "1.396565155187268456E-13" ),
                    MpIeee( "1.053844511655910310E-16" ),
                    MpIeee( "6.505213034913026604E-19" ),
                    MpIeee( "7.155734338404329264E-18" ),
                    MpIeee( "1.105886215935214523E-17" ),
                    MpIeee( "9.757819552369539906E-18" ),
                    MpIeee( "5.854691731421723944E-18" ),
                    MpIeee( "4.553649124439220312E-18" ),
                    MpIeee( "7.643625316022806260E-18" ),
                    MpIeee( "2.439454888092388058E-17" ),
                    MpIeee( "2.130457268934021451E-17" ) } ;
...
{
  if (0) {cout<<"(caught ["<< file<<":"<< line<<": "<< reason<<" ("<< err<<")])\n";}
}
