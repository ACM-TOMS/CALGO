...
struct gsl_cheb_series_struct {
  ...
  MpIeee * c;   /* coefficients                */
  size_t order; /* order of expansion          */
  MpIeee a;     /* lower interval point        */
  MpIeee b;     /* upper interval point        */
  ...
  MpIeee * f;   /* function evaluated at chebyschev points  */
};
...
int  gsl_cheb_eval_err(const gsl_cheb_series * cs, const MpIeee x, 
 ...
 * No errors can occur for a struct obtained from gsl_cheb_new().
 */
MpIeee gsl_cheb_eval_n(const gsl_cheb_series * cs, const size_t order, 
                       const MpIeee x);
int  gsl_cheb_eval_n_err(const gsl_cheb_series * cs, const size_t order, 
                        const MpIeee x, MpIeee * result, MpIeee * abserr);
 ...
 * No errors can occur for a struct obtained from gsl_cheb_new().
 */
MpIeee gsl_cheb_eval_mode(const gsl_cheb_series * cs, const MpIeee x, gsl_mode_t mode);
int  gsl_cheb_eval_mode_e(const gsl_cheb_series * cs, const MpIeee x, gsl_mode_t mode, MpIeee * result, MpIeee * abserr);
