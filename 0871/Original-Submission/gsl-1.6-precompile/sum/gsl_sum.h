...
int  gsl_sum_levin_u_accel(const MpIeee *array,
                           const size_t n,
...
int  gsl_sum_levin_u_minmax(const MpIeee *array,
                            const size_t n,
...
int
 gsl_sum_levin_u_step(const MpIeee term,
                      const size_t n,
                      const size_t nmax,
                      gsl_sum_levin_u_workspace * w, 
                      MpIeee *sum_accel);
...
int  gsl_sum_levin_utrunc_accel(const MpIeee *array,
                                const size_t n,
                                gsl_sum_levin_utrunc_workspace * w,
                                MpIeee *sum_accel, MpIeee *abserr_trunc);

int  gsl_sum_levin_utrunc_minmax(const MpIeee *array,
                                 const size_t n,
                                 const size_t min_terms,
                                 const size_t max_terms,
                                 gsl_sum_levin_utrunc_workspace * w,
...
int  gsl_sum_levin_utrunc_step(const MpIeee term,
                               const size_t n,
                               gsl_sum_levin_utrunc_workspace * w, 
                               MpIeee *sum_accel);
