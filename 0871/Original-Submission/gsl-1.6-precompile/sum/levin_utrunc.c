...
int
 gsl_sum_levin_utrunc_accel(const MpIeee *array,
...
int
 gsl_sum_levin_utrunc_minmax(const MpIeee *array,
                             const size_t array_size,
...
int
 gsl_sum_levin_utrunc_step(const MpIeee term,
                           const size_t n,
                           gsl_sum_levin_utrunc_workspace * w, MpIeee *sum_accel)
{
  if (term == 0.0)
    {
