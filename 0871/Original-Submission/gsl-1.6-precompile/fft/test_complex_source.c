...
void FUNCTION(test_complex,func) (size_t stride, size_t n) 
{
  ...
  MpIeee * fft_complex_tmp=  (MpIeee *) malloc (MpIeee( "2" ) * n * stride * sizeof (MpIeee));

  for (i = 0 ; i < 2 * n * stride ; i++)
    {
      complex_data[i] = (MpIeee)i ;
      complex_tmp[i] = (MpIeee)(i + MpIeee( "1000.0" )) ;
      fft_complex_data[i] = (MpIeee)(i + MpIeee( "2000.0" )) ;
      fft_complex_tmp[i] = (MpIeee)(i + MpIeee( "3000.0" )) ;
    }
...
FUNCTION(test_complex,bitreverse_order) (size_t stride, size_t n) 
{
  ...
  MpIeee * tmp=  (MpIeee *) malloc (MpIeee( "2" ) * n * stride * sizeof (MpIeee));
  MpIeee * data=  (MpIeee *) malloc (MpIeee( "2" ) * n * stride * sizeof (MpIeee));
  MpIeee * reversed_data=  (MpIeee *) malloc (MpIeee( "2" ) * n * stride * sizeof (MpIeee));
  ...
  memcpy (tmp, data, 2 * n * stride * sizeof(MpIeee)) ;
