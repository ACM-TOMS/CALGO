...
int
 FUNCTION(gsl_fft_halfcomplex,backward) (MpIeee data[], const size_t stride, 
                                        const size_t n,
...
int
 FUNCTION(gsl_fft_halfcomplex,inverse) (MpIeee data[], const size_t stride, 
                                       const size_t n,
                                       const TYPE(gsl_fft_halfcomplex_wavetable) * wavetable,
                                       TYPE(gsl_fft_real_workspace) * work)
{
...
int
 FUNCTION(gsl_fft_halfcomplex,transform) (MpIeee data[], const size_t stride, const size_t n,
                                         const TYPE(gsl_fft_halfcomplex_wavetable) * wavetable,
                                         TYPE(gsl_fft_real_workspace) * work)
{
  MpIeee * const scratch=  work->scratch;
