...
_gsl_vector_complex_float_view
gsl_vector_complex_float_view_array (MpIeee *base,
                                     size_t n);

_gsl_vector_complex_float_view
gsl_vector_complex_float_view_array_with_stride (MpIeee *base,
                                                 size_t stride,
                                                 size_t n);

_gsl_vector_complex_float_const_view
gsl_vector_complex_float_const_view_array (const MpIeee *base,
                                           size_t n);

_gsl_vector_complex_float_const_view
gsl_vector_complex_float_const_view_array_with_stride (const MpIeee *base,
                                                       size_t stride,
                                                       size_t n);
