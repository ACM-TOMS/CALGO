...
_gsl_vector_long_double_view 
gsl_vector_long_double_view_array (MpIeee *v, size_t n);

_gsl_vector_long_double_view 
gsl_vector_long_double_view_array_with_stride (MpIeee *base,
                                         size_t stride,
                                         size_t n);

_gsl_vector_long_double_const_view 
gsl_vector_long_double_const_view_array (const MpIeee *v, size_t n);

_gsl_vector_long_double_const_view 
gsl_vector_long_double_const_view_array_with_stride (const MpIeee *base,
                                               size_t stride,
                                               size_t n);
...
MpIeee gsl_vector_long_double_get(const gsl_vector_long_double * v, const size_t i);
void gsl_vector_long_double_set (gsl_vector_long_double * v, const size_t i, MpIeee x);

MpIeee *gsl_vector_long_double_ptr(gsl_vector_long_double * v, const size_t i);
const MpIeee *gsl_vector_long_double_const_ptr(const gsl_vector_long_double * v, const size_t i);

void gsl_vector_long_double_set_zero (gsl_vector_long_double * v);
void gsl_vector_long_double_set_all (gsl_vector_long_double * v, MpIeee x);
...
MpIeee gsl_vector_long_double_max(const gsl_vector_long_double * v);
MpIeee gsl_vector_long_double_min(const gsl_vector_long_double * v);
void gsl_vector_long_double_minmax (const gsl_vector_long_double * v, MpIeee * min_out, MpIeee * max_out);
...
int  gsl_vector_long_double_scale(gsl_vector_long_double * a, const MpIeee x);
int  gsl_vector_long_double_add_constant(gsl_vector_long_double * a, const MpIeee x);
...
extern inline
void
gsl_vector_long_double_set (gsl_vector_long_double * v, const size_t i, MpIeee x)
{
#if GSL_RANGE_CHECK
  if (i >= v->size)
    {
...
#endif
  return (const long const MpIeee *) (v->data + i * v->stride);
}
