...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
...

  {
   ...
   MpIeee X[] =  { 0.473 };
   int incX = -1;
   MpIeee x_expected[] =  { -2.25238095238 };
...

  {
   ...
   MpIeee X[] =  { 0.979 };
   int incX = -1;
   MpIeee x_expected[] =  { 1.30882352941 };
   cblas_dtrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.529f, -0.348f };
   MpIeee X[] =  { -0.95f, 0.343f };
   int incX = -1;
   MpIeee x_expected[] =  { -1.55112f, -0.372004f };
...

  {
   ...
   MpIeee X[] =  { -0.95f, 0.343f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.95f, 0.343f };
   cblas_ctrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.6f, 0.041f };
   MpIeee X[] =  { 0.896f, -0.447f };
   int incX = -1;
   MpIeee x_expected[] =  { 1.43572f, -0.843108f };
   cblas_ctrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee X[] =  { 0.896f, -0.447f };
   int incX = -1;
   MpIeee x_expected[] =  { 0.896f, -0.447f };
   cblas_ctrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.397f, 0.683f };
   MpIeee X[] =  { 0.765f, 0.18f };
   int incX = -1;
   MpIeee x_expected[] =  { 0.289642f, 0.951701f };
   cblas_ctrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee X[] =  { 0.765f, 0.18f };
   int incX = -1;
   MpIeee x_expected[] =  { 0.765f, 0.18f };
   cblas_ctrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.977, -0.955 };
   MpIeee X[] =  { -0.627, 0.281 };
   int incX = -1;
   MpIeee x_expected[] =  { -0.471957414573, -0.173714770642 };
...

  {
   ...
   MpIeee X[] =  { 0.3, -0.874 };
   int incX = -1;
   MpIeee x_expected[] =  { 5.18357980622, -0.587200407955 };
   cblas_ztrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.372, -0.745 };
   MpIeee X[] =  { -0.085, -0.303 };
   int incX = -1;
   MpIeee x_expected[] =  { -0.371144591432, -0.0712292456544 };
   cblas_ztrsv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
