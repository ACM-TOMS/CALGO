...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { -0.434f, 0.837f };
   MpIeee X[] =  { 0.209f, -0.935f };
   int incX = -1;
   MpIeee Y[] =  { 0.346f, -0.412f };
   int incY = -1;
   MpIeee y_expected[] =  { -0.153306f, 0.56399f };
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.036, -0.966 };
   MpIeee X[] =  { -0.695, 0.886 };
   int incX = -1;
   MpIeee Y[] =  { 0.486, 0.629 };
   int incY = -1;
   MpIeee y_expected[] =  { 0.486, 0.629 };
