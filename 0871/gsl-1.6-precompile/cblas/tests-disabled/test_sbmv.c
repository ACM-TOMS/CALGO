...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
  {
   ...
   int k = 1;
   int lda = 3;
   MpIeee A[] =  { 0.627f, -0.312f, 0.031f, 0.308f, 0.323f, -0.578f, 0.797f, 0.545f, -0.476f };
   MpIeee X[] =  { -0.542f, 0.606f, 0.727f };
   int incX = -1;
   MpIeee Y[] =  { 0.755f, 0.268f, -0.99f };
   int incY = -1;
   MpIeee y_expected[] =  { -0.236236f, -0.215242f, 0.266757f };
...

  {
   ...
   MpIeee Y[] =  { 0.755f, 0.268f, -0.99f };
   int incY = -1;
   MpIeee y_expected[] =  { 0.187592f, -0.01232f, -0.040176f };
   cblas_ssbmv(order, uplo, N, k, alpha, A, lda, X, incX, beta, Y, incY);
   {
     int i;
     for (i = 0; i < 3; i++) {
...

  {
   ...
   int k = 1;
   int lda = 3;
   MpIeee A[] =  { 0.83, -0.568, -0.888, 0.281, -0.779, -0.148, 0.138, 0.053, -0.757 };
   MpIeee X[] =  { 0.166, 0.808, 0.723 };
   int incX = -1;
   MpIeee Y[] =  { 0.9, 0.99, -0.578 };
   int incY = -1;
   MpIeee y_expected[] =  { 0.9, 0.99, -0.578 };
