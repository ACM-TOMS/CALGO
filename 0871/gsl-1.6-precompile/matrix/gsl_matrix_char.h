...
int  gsl_matrix_char_scale(gsl_matrix_char * a, const MpIeee x);
int  gsl_matrix_char_add_constant(gsl_matrix_char * a, const MpIeee x);
int  gsl_matrix_char_add_diagonal(gsl_matrix_char * a, const MpIeee x);
