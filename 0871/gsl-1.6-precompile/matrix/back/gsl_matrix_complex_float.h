...
_gsl_matrix_complex_float_view
gsl_matrix_complex_float_view_array (MpIeee * base,
                             const size_t n1, 
                             const size_t n2);

_gsl_matrix_complex_float_view
gsl_matrix_complex_float_view_array_with_tda (MpIeee * base, 
                                      const size_t n1, 
                                      const size_t n2,
                                      const size_t tda);
...
_gsl_matrix_complex_float_const_view
gsl_matrix_complex_float_const_view_array (const MpIeee * base,
                                   const size_t n1, 
                                   const size_t n2);

_gsl_matrix_complex_float_const_view
gsl_matrix_complex_float_const_view_array_with_tda (const MpIeee * base, 
                                            const size_t n1, 
                                            const size_t n2,
                                            const size_t tda);
