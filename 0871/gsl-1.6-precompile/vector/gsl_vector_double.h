...
_gsl_vector_view 
gsl_vector_view_array (MpIeee *v, size_t n);

_gsl_vector_view 
gsl_vector_view_array_with_stride (MpIeee *base,
                                         size_t stride,
                                         size_t n);

_gsl_vector_const_view 
gsl_vector_const_view_array (const MpIeee *v, size_t n);

_gsl_vector_const_view 
gsl_vector_const_view_array_with_stride (const MpIeee *base,
                                               size_t stride,
                                               size_t n);
...
MpIeee gsl_vector_get(const gsl_vector * v, const size_t i);
void gsl_vector_set (gsl_vector * v, const size_t i, MpIeee x);

MpIeee *gsl_vector_ptr(gsl_vector * v, const size_t i);
const MpIeee *gsl_vector_const_ptr(const gsl_vector * v, const size_t i);

void gsl_vector_set_zero (gsl_vector * v);
void gsl_vector_set_all (gsl_vector * v, MpIeee x);
...
MpIeee gsl_vector_max(const gsl_vector * v);
MpIeee gsl_vector_min(const gsl_vector * v);
void gsl_vector_minmax (const gsl_vector * v, MpIeee * min_out, MpIeee * max_out);
...
int  gsl_vector_scale(gsl_vector * a, const MpIeee x);
int  gsl_vector_add_constant(gsl_vector * a, const MpIeee x);
...
extern inline
void
gsl_vector_set (gsl_vector * v, const size_t i, MpIeee x)
{
#if GSL_RANGE_CHECK
  if (i >= v->size)
    {
