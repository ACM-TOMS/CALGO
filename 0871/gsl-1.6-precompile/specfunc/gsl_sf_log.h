 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_log_e(const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_log_abs_e(const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_complex_log_e(const MpIeee zr, const MpIeee zi, gsl_sf_result * lnr, gsl_sf_result * theta);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_log_1plusx_e(const MpIeee x, gsl_sf_result * result);
 ...
 * exceptions: GSL_EDOM
 */
int  gsl_sf_log_1plusx_mx_e(const MpIeee x, gsl_sf_result * result);
