...
static MpIeee small(MpIeee q)
{
  const MpIeee a[8] =  { 3.387132872796366608, 133.14166789178437745,
  ...
  const MpIeee b[8] =  { 1.0, 42.313330701600911252,
  ...
  MpIeee r=  MpIeee( "0.180625" ) - q * q;

  MpIeee x=  q * rat_eval (a, 8, b, 8, r);

  return x;
}

static MpIeee intermediate(MpIeee r)
{
  const MpIeee a[] =  { 1.42343711074968357734, 4.6303378461565452959,
  ...
  const MpIeee b[] =  { 1.0, 2.05319162663775882187,
  ...
  MpIeee x=  rat_eval (a,8, b,8, (r - MpIeee( "1.6" )));

  return x;
}

static MpIeee tail(MpIeee r)
{
  const MpIeee a[] =  { 6.6579046435011037772, 5.4637849111641143699,
    1.7848265399172913358, 0.29656057182850489123,
    0.026532189526576123093, 0.0012426609473880784386,
    2.71155556874348757815e-5, 2.01033439929228813265e-7
  };

  const MpIeee b[] =  { 1.0, 0.59983220655588793769,
  ...
  MpIeee x=  rat_eval (a,8, b,8, (r - MpIeee( "5.0" )));
...
{
  MpIeee r;MpIeee  x;MpIeee  pp;

  MpIeee dP=  P - MpIeee( "0.5" );
  ...
  pp = (P < MpIeee( "0.5" )) ? P : MpIeee( "1.0" ) - P;
...
MpIeee gsl_cdf_ugaussian_Qinv(const MpIeee Q)
{
  ...
  pp = (Q < MpIeee( "0.5" )) ? Q : MpIeee( "1.0" ) - Q;
