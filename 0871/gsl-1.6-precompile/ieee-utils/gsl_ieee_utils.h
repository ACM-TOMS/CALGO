...
void gsl_ieee_printf_float (const MpIeee * x) ;
void gsl_ieee_printf_double (const MpIeee * x) ;

void gsl_ieee_fprintf_float (FILE * stream, const MpIeee * x) ;
void gsl_ieee_fprintf_double (FILE * stream, const MpIeee * x) ;

void gsl_ieee_float_to_rep (const MpIeee * x, gsl_ieee_float_rep * r) ;
void gsl_ieee_double_to_rep (const MpIeee * x, gsl_ieee_double_rep * r) ;
