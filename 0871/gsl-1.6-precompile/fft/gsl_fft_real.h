...
int gsl_fft_real_radix2_transform (MpIeee data[], const size_t stride, const size_t n) ;
...
int  gsl_fft_real_transform(MpIeee data[], const size_t stride, const size_t n,
                            const gsl_fft_real_wavetable * wavetable,
                            gsl_fft_real_workspace * work);


int  gsl_fft_real_unpack(const MpIeee real_coefficient[],
