...
static MpIeee random8_get_double(void *vstate);
static MpIeee random32_get_double(void *vstate);
static MpIeee random64_get_double(void *vstate);
static MpIeee random128_get_double(void *vstate);
static MpIeee random256_get_double(void *vstate);
...
static MpIeee random8_get_double(void *vstate)
{
  return random8_get (vstate) / MpIeee( "2147483648.0" ) ;
}

static MpIeee random32_get_double(void *vstate)
{
  return random32_get (vstate) / MpIeee( "2147483648.0" ) ;
}

static MpIeee random64_get_double(void *vstate)
{
  return random64_get (vstate) / MpIeee( "2147483648.0" ) ;
}

static MpIeee random128_get_double(void *vstate)
{
  return random128_get (vstate) / MpIeee( "2147483648.0" ) ;
}

static MpIeee random256_get_double(void *vstate)
{
  return random256_get (vstate) / MpIeee( "2147483648.0" ) ;
}
