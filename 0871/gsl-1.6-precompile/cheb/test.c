...
MpIeee f_T0(MpIeee x, void * p) {
  p = 0;
  return MpIeee( "1.0" );
}

MpIeee f_T1(MpIeee x, void * p) {
  p = 0;
  return x;
}

MpIeee f_T2(MpIeee x, void * p) {
  p = 0;
  return MpIeee( "2" )*x*x - MpIeee( "1" );
}

MpIeee f_sin(MpIeee x, void * p) {
  p = 0;
  return sin(x);
}
...
main(void)
{
  MpIeee tol=  MpIeee( "100.0" ) * GSL_DBL_EPSILON;
  MpIeee ftol=  MpIeee( "20.0" );
  MpIeee x; 
  size_t i;
  ...
  for (i = 0; i<cs->order; i++)
    {
      MpIeee c_exp=  (i == MpIeee( "0" )) ? MpIeee( "2.0" ) : MpIeee( "0.0" );
  ...
  for (i = 0; i<cs->order; i++)
    {
      MpIeee c_exp=  (i == MpIeee( "1" )) ? MpIeee( "1.0" ) : MpIeee( "0.0" );
  ...
  for (i = 0; i<cs->order; i++)
    {
      MpIeee c_exp=  (i == MpIeee( "2" )) ? MpIeee( "1.0" ) : MpIeee( "0.0" );
  ...
  for(x=-M_PI; x<M_PI; x += M_PI/MpIeee( "100.0" )) {
    MpIeee r=  gsl_cheb_eval(cs, x);
  ...
  for(x=-M_PI; x<M_PI; x += M_PI/MpIeee( "100.0" )) {
    MpIeee r=  gsl_cheb_eval_n(cs, MpIeee( "25" ), x);
  ...
  for(x=-M_PI; x<M_PI; x += M_PI/MpIeee( "100.0" )) {
    MpIeee r=  gsl_cheb_eval_n(csd, MpIeee( "25" ), x);
  ...
  for(x=-M_PI; x<M_PI; x += M_PI/MpIeee( "100.0" )) {
    MpIeee r=  gsl_cheb_eval_n(csi, MpIeee( "25" ), x);
