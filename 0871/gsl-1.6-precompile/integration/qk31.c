...
static const MpIeee xgk[16] =    /* abscissae of the 31-point kronrod rule */
{
...
static const MpIeee wg[8] =      /* weights of the 15-point gauss rule */
{
...
static const MpIeee wgk[16] =    /* weights of the 31-point kronrod rule */
{
...
void
gsl_integration_qk31 (const gsl_function * f, MpIeee a, MpIeee b,
      MpIeee *result, MpIeee *abserr,
      MpIeee *resabs, MpIeee *resasc)
{
  MpIeee fv1[16];MpIeee  fv2[16];
