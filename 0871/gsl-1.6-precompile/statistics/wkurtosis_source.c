...
MpIeee FUNCTION(gsl_stats,wkurtosis) (const BASE w[], const size_t wstride, const BASE data[], const size_t stride, const size_t n)
{
...
MpIeee FUNCTION(gsl_stats,wkurtosis_m_sd) (const BASE w[], const size_t wstride,
                                    const BASE data[], 
                                    const size_t stride,
                                    const size_t n,
                                    const MpIeee wmean, 
                                    const MpIeee wsd)
{
  ...
  MpIeee wavg=  MpIeee( "0" );MpIeee  kurtosis;
  MpIeee W=  MpIeee( "0" );
  size_t i;
  ...
  kurtosis = wavg - MpIeee( "3.0" );  /* makes kurtosis zero for a Gaussian */
