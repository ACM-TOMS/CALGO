...
/* stopping parameters */
const MpIeee EPSREL=  (10 * GSL_DBL_EPSILON);
const MpIeee EPSABS=  (10 * GSL_DBL_EPSILON);
...
test_fdf_e (const gsl_root_fdfsolver_type * T, 
            ...
            MpIeee root, MpIeee correct_root)
{
  int  status;
  size_t iterations = 0;
  MpIeee prev=  MpIeee( "0" ) ;
