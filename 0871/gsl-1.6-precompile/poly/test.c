...
main (void)
{
  const MpIeee eps=  100.0 * GSL_DBL_EPSILON;

  gsl_ieee_env_setup ();

  {
    MpIeee x;MpIeee  y;
    MpIeee c[3] =  { MpIeee( "1.0" ), MpIeee( "0.5" ), MpIeee( "0.3" ) };
    x = MpIeee( "0.5" );
    y = gsl_poly_eval (c, MpIeee( "3" ), x);
  ...
  {
    MpIeee x;MpIeee  y;
    MpIeee d[11] =  { MpIeee( "1" ), -MpIeee( "1" ), MpIeee( "1" ), -MpIeee( "1" ), MpIeee( "1" ), -MpIeee( "1" ), MpIeee( "1" ), -MpIeee( "1" ), MpIeee( "1" ), -MpIeee( "1" ), MpIeee( "1" ) };
    x = MpIeee( "1.0" );
    y = gsl_poly_eval (d, MpIeee( "11" ), x);
...

  {
    ...
    MpIeee a[6] =  { -MpIeee( "120" ), MpIeee( "274" ), -MpIeee( "225" ), MpIeee( "85" ), -MpIeee( "15" ), MpIeee( "1" ) };
    MpIeee z[6*2];
...

  {
    ...
    MpIeee a[9] =  { MpIeee( "1" ), MpIeee( "0" ), MpIeee( "0" ), MpIeee( "0" ), MpIeee( "1" ), MpIeee( "0" ), MpIeee( "0" ), MpIeee( "0" ), MpIeee( "1" ) };
    MpIeee z[8*2];

    MpIeee C=  MpIeee( "0.5" );
    MpIeee S=  sqrt (MpIeee( "3.0" )) / MpIeee( "2.0" );
...

  {
    ...
    MpIeee xa[7] =  {MpIeee( "0.16" ), MpIeee( "0.97" ), MpIeee( "1.94" ), MpIeee( "2.74" ), MpIeee( "3.58" ), MpIeee( "3.73" ), MpIeee( "4.70" ) };
    MpIeee ya[7] =  {MpIeee( "0.73" ), MpIeee( "1.11" ), MpIeee( "1.49" ), MpIeee( "1.84" ), MpIeee( "2.30" ), MpIeee( "2.41" ), MpIeee( "3.07" ) };

    MpIeee dd_expected[7] =  {  MpIeee( "7.30000000000000e-01" ),
                               MpIeee( "4.69135802469136e-01" ),
                              -MpIeee( "4.34737219941284e-02" ),
                               MpIeee( "2.68681098870099e-02" ),
                              -MpIeee( "3.22937056934996e-03" ),
                               MpIeee( "6.12763259971375e-03" ),
                              -MpIeee( "6.45402453527083e-03" ) };

    MpIeee dd[7];MpIeee  coeff[7];MpIeee  work[7];
    ...
    for (i = 0; i < 7; i++)
      {
        MpIeee y=  gsl_poly_dd_eval(dd, xa, MpIeee( "7" ), xa[i]);
    ...
    for (i = 0; i < 7; i++)
      {
        MpIeee y=  gsl_poly_eval(coeff, MpIeee( "7" ), xa[i] - MpIeee( "1.5" ));
