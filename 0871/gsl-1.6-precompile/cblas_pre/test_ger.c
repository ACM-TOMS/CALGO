...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
...

  {
   ...
   MpIeee A[] =  { -0.651f, 0.856f };
   MpIeee X[] =  { -0.38f, -0.235f };
   int incX = -1;
   MpIeee Y[] =  { -0.627f, 0.757f };
   int incY = -1;
   MpIeee A_expected[] =  { -0.651f, 0.856f };
...

  {
   ...
   int lda = 1;
   MpIeee alpha[2] =  {-1, 0};
   MpIeee A[] =  { -0.426, 0.757 };
   MpIeee X[] =  { -0.579, -0.155 };
   int incX = -1;
   MpIeee Y[] =  { 0.831, 0.035 };
   int incY = -1;
   MpIeee A_expected[] =  { 0.049724, 0.90607 };
...

  {
   ...
   MpIeee Y[] =  { 0.831, 0.035 };
   int incY = -1;
   MpIeee A_expected[] =  { 0.060574, 0.86554 };
