...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
  {
   ...
   MpIeee Y[] =  { -0.262f };
   int incY = -1;
   MpIeee expected1[] =  { -0.262f };
   MpIeee expected2[] =  { 0.539f };
...

  {
   ...
   MpIeee Y[] =  { 0.373 };
   int incY = -1;
   MpIeee expected1[] =  { 0.373 };
   MpIeee expected2[] =  { 0.906 };
  ...
  {
   int N = 1;
   MpIeee X[] =  { -0.316f, -0.529f };
   int incX = 1;
   MpIeee Y[] =  { -0.313f, 0.363f };
   int incY = -1;
   MpIeee expected1[] =  { -0.313f, 0.363f };
   MpIeee expected2[] =  { -0.316f, -0.529f };
...

  {
   ...
   MpIeee X[] =  { 0.512, -0.89 };
   int incX = 1;
   MpIeee Y[] =  { -0.225, -0.511 };
   int incY = -1;
   MpIeee expected1[] =  { -0.225, -0.511 };
   MpIeee expected2[] =  { 0.512, -0.89 };
...

  {
   ...
   MpIeee Y[] =  { -0.431f };
   int incY = 1;
   MpIeee expected1[] =  { -0.431f };
   MpIeee expected2[] =  { 0.336f };
   cblas_sswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee Y[] =  { -0.293 };
   int incY = 1;
   MpIeee expected1[] =  { -0.293 };
   MpIeee expected2[] =  { 0.764 };
   cblas_dswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
  ...
  {
   int N = 1;
   MpIeee X[] =  { -0.239f, 0.361f };
   int incX = -1;
   MpIeee Y[] =  { 0.149f, 0.347f };
   int incY = 1;
   MpIeee expected1[] =  { 0.149f, 0.347f };
   MpIeee expected2[] =  { -0.239f, 0.361f };
   cblas_cswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
  ...
  {
   int N = 1;
   MpIeee X[] =  { -0.171, -0.936 };
   int incX = -1;
   MpIeee Y[] =  { 0.495, -0.835 };
   int incY = 1;
   MpIeee expected1[] =  { 0.495, -0.835 };
   MpIeee expected2[] =  { -0.171, -0.936 };
   cblas_zswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee Y[] =  { -0.213f };
   int incY = -1;
   MpIeee expected1[] =  { -0.213f };
   MpIeee expected2[] =  { -0.405f };
   cblas_sswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee Y[] =  { -0.585 };
   int incY = -1;
   MpIeee expected1[] =  { -0.585 };
   MpIeee expected2[] =  { -0.761 };
   cblas_dswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
  ...
  {
   int N = 1;
   MpIeee X[] =  { 0.853f, 0.146f };
   int incX = -1;
   MpIeee Y[] =  { 0.009f, -0.178f };
   int incY = -1;
   MpIeee expected1[] =  { 0.009f, -0.178f };
   MpIeee expected2[] =  { 0.853f, 0.146f };
   cblas_cswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
  ...
  {
   int N = 1;
   MpIeee X[] =  { -0.228, 0.386 };
   int incX = -1;
   MpIeee Y[] =  { 0.988, -0.084 };
   int incY = -1;
   MpIeee expected1[] =  { 0.988, -0.084 };
   MpIeee expected2[] =  { -0.228, 0.386 };
   cblas_zswap(N, X, incX, Y, incY);
   {
     int i;
     for (i = 0; i < 1; i++) {
