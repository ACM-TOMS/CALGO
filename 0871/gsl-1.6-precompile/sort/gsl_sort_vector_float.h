...
int  gsl_sort_vector_float_smallest(MpIeee * dest, const size_t k, const gsl_vector_float * v);
int  gsl_sort_vector_float_largest(MpIeee * dest, const size_t k, const gsl_vector_float * v);
