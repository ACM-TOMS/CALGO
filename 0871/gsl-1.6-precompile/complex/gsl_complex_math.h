...
gsl_complex gsl_complex_rect (MpIeee x, MpIeee y);  /* r= real+i*imag */
gsl_complex gsl_complex_polar (MpIeee r, MpIeee theta); /* r= r e^(i theta) */
...
MpIeee gsl_complex_arg(gsl_complex z); /* return arg(z), -pi< arg(z) <=+pi */
MpIeee gsl_complex_abs(gsl_complex z);   /* return |z|   */
MpIeee gsl_complex_abs2(gsl_complex z);  /* return |z|^2 */
MpIeee gsl_complex_logabs(gsl_complex z); /* return log|z| */
...
gsl_complex gsl_complex_add_real (gsl_complex a, MpIeee x);  /* r=a+x */
gsl_complex gsl_complex_sub_real (gsl_complex a, MpIeee x);  /* r=a-x */
gsl_complex gsl_complex_mul_real (gsl_complex a, MpIeee x);  /* r=a*x */
gsl_complex gsl_complex_div_real (gsl_complex a, MpIeee x);  /* r=a/x */

gsl_complex gsl_complex_add_imag (gsl_complex a, MpIeee y);  /* r=a+iy */
gsl_complex gsl_complex_sub_imag (gsl_complex a, MpIeee y);  /* r=a-iy */
gsl_complex gsl_complex_mul_imag (gsl_complex a, MpIeee y);  /* r=a*iy */
gsl_complex gsl_complex_div_imag (gsl_complex a, MpIeee y);  /* r=a/iy */
...
gsl_complex gsl_complex_sqrt_real (MpIeee x);  /* r=sqrt(x) (x<0 ok) */

gsl_complex gsl_complex_pow (gsl_complex a, gsl_complex b);  /* r=a^b */
gsl_complex gsl_complex_pow_real (gsl_complex a, MpIeee b);  /* r=a^b */
...
gsl_complex gsl_complex_arcsin_real (MpIeee a);  /* r=arcsin(a) */
gsl_complex gsl_complex_arccos (gsl_complex a);  /* r=arccos(a) */
gsl_complex gsl_complex_arccos_real (MpIeee a);  /* r=arccos(a) */
gsl_complex gsl_complex_arcsec (gsl_complex a);  /* r=arcsec(a) */
gsl_complex gsl_complex_arcsec_real (MpIeee a);  /* r=arcsec(a) */
gsl_complex gsl_complex_arccsc (gsl_complex a);  /* r=arccsc(a) */
gsl_complex gsl_complex_arccsc_real (MpIeee a);  /* r=arccsc(a) */
...
gsl_complex gsl_complex_arccosh_real (MpIeee a);  /* r=arccosh(a) */
...
gsl_complex gsl_complex_arctanh_real (MpIeee a);  /* r=arctanh(a) */
