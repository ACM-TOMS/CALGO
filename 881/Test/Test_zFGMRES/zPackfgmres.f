...
C*
*
        subroutine drive_zfgmres(n,nloc,m,lwork,work,
     &                         irc,icntl,cntl,info,rinfo)
*
*  Purpose
*  =======
*    drive_zfgmres is the driver routine for solving the linear system 
...
* Authors :  Valerie Fraysse, Luc Giraud, Serge Gratton
*             Parallel Algorithms - CERFACS
* Comments: Totally rewritten from the zfgmres implementation
*
...
* setup some pointers on the workspace
       ...
       Zptr     = lwork - (m*nloc)+1
*
       call zfgmres(nloc,m,lwork,work(bptr),work(xptr),work(dotptr),
...
*
        subroutine zfgmres(n,m,lwork,b,x,dot,H,w,r0,V,Z,yCurrent,
     &                xCurrent,rotSin,rotCos,irc,icntl,cntl,info,rinfo)
*
*
*  Purpose
*  =======
*  zfgmres solves the linear system Ax = b using the
...
*
* Z         (workspace)  double precision/double complex
...
*
* rotCos    (workspace) double precision/double complex
...
* ----------------------
       integer  irc(7)
       double complex x(n), dot(m), H(m+1,m+1), w(n)
       double complex r0(n), V(n,m+1), Z(n,m)
       double complex xCurrent(n), rotSin(m), yCurrent(m)   
       double complex rotCos(m)
*
* Local variables
* ---------------
...
*
        ...
        irc(7) = irc(7) - n 
*
*       Most outer loop : zfgmres iteration
*
*       REPEAT
 7      continue
*
...
*
          call zgemv('N',n,jH,ONE,Z(1,m-jH+1),n,
...
*
*
        subroutine init_zfgmres(icntl,cntl)
*
*  Purpose
*  =======
