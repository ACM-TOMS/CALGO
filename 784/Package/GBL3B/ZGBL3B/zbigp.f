      LOGICAL FUNCTION ZBIGP ( IP, DIM1, DIM2 )
*     .. Scalar Arguments ..
...
*  =======
*
*  ZBIGP determines which of two alternative code sections in a GEMM-
*  Based Level 3 BLAS routine that will be the fastest for a particular
*  problem. If the problem is considered large enough ZBIGP returns
...
*  rewarding to rewrite the logical expressions in ZBIGP so that both
...
*
*
*     .. User specified parameters for ZBIGP ..
      INTEGER            ZIP41, ZIP42,
     $                   ZIP51, ZIP52,
     $                   ZIP81, ZIP82, ZIP83,
     $                   ZIP91, ZIP92, ZIP93
