      SUBROUTINE SGB04( UPLO, TRANS, N, K, ALPHA, A, LDA,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  SGB04 (SSYRK) performs one of the symmetric rank k operations
*
*     C := alpha*A*A' + beta*C,
*
*  or
...
*     .. Parameters ..
     ...
     $                   SIP41 = 41, SIP42 = 42 )
*     .. User specified parameters for SGB04 ..
      INTEGER            RB, CB, RCB
...
*
            SMALLN = .NOT.SGB90( SIP41 , N, K )
            IF( SMALLN )THEN
               TINYK = .NOT.SGB90( SIP42 , N, K )
               DO 90, II = 1, N, RCB
                  ISEC = MIN( RCB, N-II+1 )
*
