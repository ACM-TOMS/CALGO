      PROGRAM CSBPM
*
*  CSBPM re-writes GEMM-Based Level 3 BLAS source files replacing lines
...
*  statements in the input file, and then run CSBPM to distribute these
...
*     .. Data statements ..
      DATA               BNAM/
     $'cgb02.f'   ,'cgb03.f'   ,'cgb04.f'   ,'cgb05.f'   ,
     $'cgb06.f'   ,'cgb07.f'   ,'cgb08.f'   ,'cgb09.f'   ,
     $'cgb90.f'   ,'          ','          ','          ',
     $'cgb91.f'   ,'          '/
      DATA               STRS/
...
*
   20 NAM = -1
     ...
     $            GBNAM( IB:IE ), ' is missing in CSBPM.'
               STOP
            END IF
         END IF
   30 CONTINUE
