      SUBROUTINE CGB09 ( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, LDA,
     $                   C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB09 (CTRSM) solves one of the matrix equations
*
...
*     .. External Functions ..
      LOGICAL            LSAME, CGB90, CGB91
      EXTERNAL           LSAME, CGB90, CGB91
...
*     .. User specified parameters for CGB09 ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.CGB90( CIP91, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.CGB90( CIP92, M, N )
