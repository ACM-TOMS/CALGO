      LOGICAL FUNCTION CGB90 ( IP, DIM1, DIM2 )
*     .. Scalar Arguments ..
...
*  =======
*
*  CGB90 determines which of two alternative code sections in a GEMM-
*  Based Level 3 BLAS routine that will be the fastest for a particular
*  problem. If the problem is considered large enough CGB90 returns
...
*  rewarding to rewrite the logical expressions in CGB90 so that both
...
*
*
*     .. User specified parameters for CGB90 ..
      INTEGER            CIP41, CIP42,
     $                   CIP51, CIP52,
     $                   CIP81, CIP82, CIP83,
     $                   CIP91, CIP92, CIP93
