...
*  system.
*
*  The function DGB91 returns .TRUE. if the leading dimension LD is
*  critical and .FALSE. if it is not critical. In this implementation
*  DGB91 is designed to detect critical leading dimensions in an
...
*  It may be rewarding to rewrite DGB91 for a machine with a different
*  cache policy.
*
...
*
*
*  User specified parameters for DGB91
*  ================================
*
...
*
      ...
      ELSE
         ...
         DGB91 = MIN( UPDIF, LD-UPDIF ).LE.MXDIF
      END IF
*
      RETURN
*
