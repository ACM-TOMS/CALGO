      SUBROUTINE DGB02( SIDE, UPLO, M, N, ALPHA, A, LDA, B, LDB,
     $                   BETA, C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  DGB02 (DSYMM) performs one of the matrix-matrix operations
*
*     C := alpha*A*B + beta*C,
*
*  or
...
*     .. User specified parameters for DGB02 ..
      INTEGER            RCB, CB
