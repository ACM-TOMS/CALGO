      SUBROUTINE DGB09( SIDE, UPLO, TRANSA, DIAG, M, N, ALPHA, A, LDA,
     $                   C, LDC )
*     .. Scalar Arguments ..
...
*  =======
*
*  DGB09 (DTRSM) solves one of the matrix equations
*
...
*     .. External Functions ..
      LOGICAL            LSAME, DGB90, DGB91
      EXTERNAL           LSAME, DGB90, DGB91
...
*     .. User specified parameters for DGB09 ..
      INTEGER            RB, CB, RCB
...
*
               SMALLN = .NOT.DGB90( DIP91, M, N )
               IF( SMALLN )THEN
                  TINYN = .NOT.DGB90( DIP92, M, N )
