function sol = burgerssolve(n,tspan,adigatorFlag)
...
%         adigatorFlag - flag to use adigator (default 1)
...
opts = odeset('Mass',@(t,y)burgersmass(t,y,N),'MStateDependence','strong','JPattern',Jpat,...
  ...
  opts = odeset('Mass',@(t,y)burgersmass(t,y,N),'MStateDependence','strong','JPattern',Jpat,...
    'MvPattern',burgersMvPat(N),'RelTol',1e-5,'AbsTol',1e-4);
end
 display(' ');
