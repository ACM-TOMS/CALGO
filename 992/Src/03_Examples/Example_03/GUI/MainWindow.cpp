...
*/
    ...
    connect(_side_widget->show_arcs_check_box, SIGNAL(clicked(bool)), _gl_widget, SLOT(setVisibilityOfArcs(bool)));
    connect(_side_widget->show_control_polygons_check_box, SIGNAL(clicked(bool)), _gl_widget, SLOT(setVisibilityOfControlPolygons(bool)));
    connect(_side_widget->show_tangent_vectors_check_box, SIGNAL(clicked(bool)), _gl_widget, SLOT(setVisibilityOfTangentVectors(bool)));
}
