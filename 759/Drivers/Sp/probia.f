...
C
      ...
      PARAMETER (MXLEV=2, NPD=1, NPTS=170000)
...
C Compute ||err||_max
   ...
   10 CONTINUE
      ...
      J = 1
      DO 10 I = 1, NPTS
         RMAX = MAX(RMAX,ABS(UEX(I,J)-U(I,J)))
   10 CONTINUE
      WRITE(28,'(''Error at T='',E9.3,'', level='',I1,'' :'',E9.3,I10)')
     +   T, LEVEL, RMAX, NPTS
