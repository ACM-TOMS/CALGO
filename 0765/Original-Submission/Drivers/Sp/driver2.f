...
C*****WARNING*****
C
C THE SINGLE-PRECISION FINITE DIFFERENCE HESSIAN APPROXIMATION
C MAY NOT BE ACCURATE ENOUGH. THIS MAY LEAD TO A CONVERGENCE
C DETERIORATION. THE USER IS ADVISED TO PROVIDE AN ANALYTIC 
C HESSIAN WHEN THE SINGLE-PRECISION VERSION OF STENMIN IS USED. 
C
C*****************
C
...
C
      ...
      REAL             FSCALE, GRADTL, STEPTL, FPLS, STEPMX
      REAL             LAMBDA, HX, HY, TEMP, ONE
...
C  COMPUTE THE STANDARD STARTING POINT.
      ...
      HY = ONE/FLOAT(NY+1)
      DO 20 J = 1, NY
         TEMP = FLOAT(MIN(J,NY-J+1))*HY
         DO 10 I = 1, NX
            K = NX*(J-1) + I
            X(K) = -(MIN(FLOAT(MIN(I,NX-I+1))*HX,TEMP))**2
   10    CONTINUE
   20 CONTINUE
...
C  CALL THE SPARSE OPTIMIZER.
      ...
      CALL STUMCS(N,X,NZ,IRN,LIRN,ICN,LICN,DODCF,DODCG,
...
C
      INTEGER I, J, K
      REAL MU1, MU2, ONE, P5, TWO, ZERO
      REAL AREA, DPSI, DVDX, DVDY, GRADV, HX, HXHY
      REAL HY, TEMP, T1, T2, V, VB, VL, VR, VT
      PARAMETER (ZERO=0.0E0,P5=0.5E0,ONE=1.0E0,TWO=2.0E0)
...
C
      INTEGER I, J, K
      REAL MU1, MU2, ONE, P5, TWO, ZERO
      REAL AREA, DPSIP, DVDX, DVDY, GRADV, HX, HXHY
      REAL HY, T1, T2, V, VB, VL, VR, VT
      PARAMETER (ZERO=0.0E0,P5=0.5E0,ONE=1.0E0,TWO=2.0E0)
      PARAMETER (MU1=ONE,MU2=TWO)
      INTRINSIC FLOAT, SQRT
      EXTERNAL DODCPS
...
C
      REAL P25, P5, ZERO
      PARAMETER (ZERO=0.0E0,P25=0.25E0,P5=0.5E0)
      REAL SQRTT
      INTRINSIC SQRT
C
      SQRTT = SQRT(T)
