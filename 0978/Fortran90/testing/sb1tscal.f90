subroutine SB1TSCAL( nn, nvals, nix, ixvals, nal, alvals, lenx, x, xs, &
...
!  =======
!
!  SB1TSCAL tests the scaling routine SSCAL.
!
!  Arguments
!  =========
!
...
!
       do k = 1, nal
         alphas = alvals(k)
!
!        Call SSCAL to scale the vector x
!
         n = ns
         alpha = alphas
         x(1:lenx) = xs(1:lenx)
...
!
         ...
         call SARGCKX( nerrs, subnam, 'X', lenx, iwork, x, xs, nout )
