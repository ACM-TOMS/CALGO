subroutine SB1TAMAX( nn, nvals, nix, ixvals, lenx, x, xs, &
      work, nout )
...
!  =======
!
!  SB1TAMAX tests the infinity-norm routine ISAMAX. Tests are done
...
!
!              Call ISAMAX to find the maximum element
!
               n = ns
               x(1:lenx) = xs(1:lenx)
               incx = incxs
               ibla = ISAMAX( n, x, incx )
!
