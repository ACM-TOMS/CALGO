subroutine CB1TROT( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
                    work1, work2, iwork1, iwork2, thresh, nout )
   use LA_CONSTANTS32, only: wp, zero, half, one, two, ulp
!
...
!  =======
!
!  CB1TROT tests the Level 1 BLAS subroutine CROT to apply
...
!  when constructed by CROTG, but CROT doesn't actually check this):
!     1) c = 0, s = (1,0)
!     2) c = 0, s = (0,1)
...
!
         do ir = 1, nr
           ...
           ss = svals(ir)
!
!          Call CROT to apply the rotation described by c and s
!
           n = ns
           x(1:lenx) = xs(1:lenx)
           incx = incxs
...
!
           ...
           call CARGCKS( nerrs, subnam, 'S', s, ss, nout )
!
