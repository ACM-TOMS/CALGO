...
!  =======
!
!  IDAMAX finds the index of the element of maximum absolute value
!  in the n-element real vector x. If the vector contains NaNs,
!  IDAMAX returns the index of the largest element excluding the
!  NaN entries. If all entries are NaN, IDAMAX returns 1.
!
!  Arguments
!  =========
!
...
!          If INCX = 0, all elements of x are the same so IDAMAX will
!          return 1.
!
! =====================================================================
!
