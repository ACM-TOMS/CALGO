subroutine STIMPY2( n, nrep, x, y, z, xs, ys, thresh, rtim, nout )
...
!  ..
!
!  STIMPY2 times SLAPY2 from LAPACK, a function to compute the
...
!
   ...
   call SARGCKV( nerrs, subnam, 'Y', n, y, ys, nout )
!
