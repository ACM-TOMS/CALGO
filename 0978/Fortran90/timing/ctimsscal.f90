subroutine CTIMSSCAL( n, nrep, nal, alvals, x, xs, work, &
      thresh, rtim, nout )
...
!  ..
!
!  CTIMSSCAL times CSSCAL from the Level 1 BLAS, a subroutine to scale a
...
!
     ...
     incx = incxs
     call CSSCAL( n, alpha, x, incx )
!    write(nout,99) 'CSSCAL', ns, alphas, rtim
!
