subroutine CTOMSWAP( n, nrep, x, ldx, y, ldy, xs, ys, thresh, nout )
...
!  ..
!
!  CTOMSWAP times CSWAP from the Level 1 BLAS, a subroutine to swap
...
!
   ...
   t1 = SECOND()
   do j = 1, nrep
     call CSWAP( n, x(1,j), incx, y(1,j), incy )
   end do
   t2 = SECOND()
   tottim = t2 - t1
   write(nout,99) 'CSWAP ', ns, tottim / nrep
!
