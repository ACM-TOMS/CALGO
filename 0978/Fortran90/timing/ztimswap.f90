subroutine ZTIMSWAP( n, nrep, x, y, xs, ys, thresh, rtim, nout )
...
!  ..
!
!  ZTIMSWAP times ZSWAP from the Level 1 BLAS, a subroutine to swap
...
!  .. Local Scalars ..
   ...
   real(wp) :: r1, r2, t1, t2, tottim, tmax, trat, &
      umax, urat, xnrm, ynrm
