subroutine ZTIMSCAL( n, nrep, nal, alvals, x, xs, work, &
      thresh, rtim, nout )
...
!  ..
!
!  ZTIMSCAL times ZSCAL from the Level 1 BLAS, a subroutine to scale a
...
!
     ...
     incx = incxs
     call ZSCAL( n, alpha, x, incx )
!    write(nout,99) 'ZSCAL ', ns, alphas, rtim
!
