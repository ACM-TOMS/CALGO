subroutine DTOMSWAP( n, nrep, x, ldx, y, ldy, xs, ys, thresh, nout )
...
!  ..
!
!  DTOMSWAP times DSWAP from the Level 1 BLAS, a subroutine to swap
...
!
   ...
   t1 = DSECND()
   do j = 1, nrep
     call DSWAP( n, x(1,j), incx, y(1,j), incy )
   end do
   t2 = DSECND()
   tottim = t2 - t1
   write(nout,99) 'DSWAP ', ns, tottim / nrep
!
