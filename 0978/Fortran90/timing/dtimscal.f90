subroutine DTIMSCAL( n, nrep, nal, alvals, x, xs, thresh, rtim, nout )
...
!  ..
!
!  DTIMSCAL times DSCAL from the Level 1 BLAS, a subroutine to scale a
...
!
     ...
     incx = incxs
     call DSCAL( n, alpha, x, incx )
!    write(nout,99) 'DSCAL ', ns, alphas, rtim
!
