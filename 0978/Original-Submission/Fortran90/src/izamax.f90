...
!  =======
!
!  IZAMAX finds the index of the element of maximum absolute value
!  in the n-element complex vector x. If the vector contains NaNs,
!  IZAMAX returns the index of the largest element excluding the
!  NaN entries. If all entries are NaN, IZAMAX returns 1.
!
!  Arguments
!  =========
!
...
!          If INCX = 0, all elements of x are the same so IZAMAX will
!          return 1.
!
! =====================================================================
!
