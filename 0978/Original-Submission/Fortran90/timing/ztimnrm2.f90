subroutine ZTIMNRM2( n, nrep, x, xs, work, thresh, rtim, nout )
...
!  ..
!
!  ZTIMNRM2 times the 2-norm routine DZNRM2 from the Level 1 BLAS.
...
!  ..
!  .. External Functions ..
   real(wp) :: DZNRM2, DSECND
   external :: DZNRM2, DSECND
!  ..
!
   nfail = 0
   ntests = 0
