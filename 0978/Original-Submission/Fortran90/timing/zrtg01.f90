subroutine ZRTG01( f, g, cs, sn, r, result )
   use LA_CONSTANTS, only: wp, zero, one, ulp, safmin, safmax, czero, cone
   use LA_XISNAN
   use LA_XXVALS
!
...
!  =======
!
!  ZRTG01 is an auxiliary test routine for CB1TRTG.  The input values
