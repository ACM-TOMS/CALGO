subroutine ZTIMDROT( n, nrep, x, y, xs, ys, work, thresh, rtim, nout )
...
!  ..
!
!  ZTIMDROT times ZDROT from the Level 1 BLAS, a subroutine to apply
...
!  .. Local Scalars ..
   ...
   real(wp) :: c, cs, s, ss, t1, t2, tottim, tmax, trat, umax, urat, xnrm, ynrm
