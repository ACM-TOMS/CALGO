subroutine STOMCOPY( n, nrep, x, ldx, y, ldy, xs, ys, thresh, nout )
...
!  ..
!
!  STOMCOPY times SCOPY from the Level 1 BLAS, a subroutine to copy
...
!  .. Local Scalars ..
   ...
   real(wp) :: rogue, t1, t2, tottim, tmax, trat, yexp, ymax, ynrm
!  ..
!  .. External Functions ..
   real(wp) :: SECOND
!  ..
...
!
   ...
   t1 = SECOND()
   do j = 1, nrep
     call SCOPY( n, x(1,j), incx, y(1,j), incy )
   end do
   t2 = SECOND()
   tottim = t2 - t1
   write(nout,99) 'SCOPY ', ns, tottim / nrep
!
