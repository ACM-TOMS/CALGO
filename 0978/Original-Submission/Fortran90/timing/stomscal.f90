subroutine STOMSCAL( n, nrep, nal, alvals, x, ldx, xs, thresh, nout )
...
!  ..
!
!  STOMSCAL times SSCAL from the Level 1 BLAS, a subroutine to scale a
...
!
     ...
     t1 = SECOND()
     do j = 1, nrep
       call SSCAL( n, alpha, x(1,j), incx )
     end do
     t2 = SECOND()
     tottim = t2 - t1
     write(nout,99) 'SSCAL ', ns, alphas, tottim / nrep
!
