subroutine DTIMRTG( n, nrep, x, y, z, xs, ys, thresh, rtim, nout )
...
!  ..
!
!  DTIMRTG times DLARGV from LAPACK, a subroutine to compute a vector
...
!
       ...
       do j = 1, nrep
         ...
         z(1:n) = rogue
         incz = inczs
         call DLARGV( n, x, incx, y, incy, z, incz )
       end do
       t2 = DSECND()
       tottim = t2 - t1
...
!
       ...
       worst(1:ntests) = zero
       do i = 1, ns
         call DRTG01( likbla, sx*xs(i), sy*ys(i), z(i), y(i), x(i), result )
!
