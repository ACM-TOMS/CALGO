subroutine STOMROT( n, nrep, x, ldx, y, ldy, xs, ys, thresh, nout )
...
!  ..
!
!  STOMROT times SROT from the Level 1 BLAS, a subroutine to apply
...
!
   ...
   t1 = SECOND()
   do j = 1, nrep
     call SROT( n, x(1,j), incx, y(1,j), incy, c, s )
   end do
   t2 = SECOND()
   tottim = t2 - t1
   write(nout,99) 'SROT  ', ns, tottim / nrep
!
