subroutine DTOMROT( n, nrep, x, ldx, y, ldy, xs, ys, thresh, nout )
...
!  ..
!
!  DTOMROT times DROT from the Level 1 BLAS, a subroutine to apply
...
!
   ...
   t1 = DSECND()
   do j = 1, nrep
     call DROT( n, x(1,j), incx, y(1,j), incy, c, s )
   end do
   t2 = DSECND()
   tottim = t2 - t1
   write(nout,99) 'DROT  ', ns, tottim / nrep
!
