subroutine CTIMAXPY( n, nrep, nal, alvals, x, y, xs, ys, &
                     work, thresh, rtim, nout )
   use LA_CONSTANTS32, only: wp, zero, ulp, one, two, czero
!
!  .. Scalar Arguments ..
...
!  ..
!
!  CTIMAXPY times CAXPY from the Level 1 BLAS, a subroutine to compute
...
!
     ...
     incy = incys
     call CAXPY( n, alpha, x, incx, y, incy )
!    write(nout,99) 'CAXPY ', ns, alphas, rtim
!
...
!
     ...
     call CARGCKV( nerrs, subnam, 'X', n, x, xs, nout )
