subroutine CB1TDOTC( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  CB1TDOTC tests the dot product routine CDOTC.
!
...
!
!            Call CDOTC to compute the dot product of x and y
!
             n = ns
             x(1:lenx) = xs(1:lenx)
             incx = incxs
