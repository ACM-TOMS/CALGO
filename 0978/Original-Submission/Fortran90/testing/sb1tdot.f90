subroutine SB1TDOT( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  SB1TDOT tests the dot product routine SDOT.
!
...
!
!            Call SDOT to compute the dot product of x and y
!
             n = ns
             x(1:lenx) = xs(1:lenx)
             incx = incxs
...
!
             ...
             call SARGCKV( nerrs, subnam, 'Y', lenx, y, ys, nout )
