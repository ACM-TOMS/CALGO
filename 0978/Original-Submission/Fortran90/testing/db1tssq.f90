subroutine DB1TSSQ( nn, nvals, nix, ixvals, lenx, x, xs, z, &
      work, thresh, nout )
...
!  =======
!
!  DB1TSSQ tests the sum of squares routine DLASSQ.  Tests are done
...
!
!            Call DLASSQ to compute the sum of squares
!
             scl = s
             sumsq = ssq
             n = ns
