subroutine SB1TROT( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  SB1TROT tests the Level 1 BLAS subroutine SROT to apply
...
!
         do ir = 1, nr
           ...
           ss = svals(ir)
!
!          Call SROT to apply the rotation described by c and s
!
           n = ns
           x(1:lenx) = xs(1:lenx)
           incx = incxs
