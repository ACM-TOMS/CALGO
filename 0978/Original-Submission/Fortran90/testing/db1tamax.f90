subroutine DB1TAMAX( nn, nvals, nix, ixvals, lenx, x, xs, &
      work, nout )
...
!  =======
!
!  DB1TAMAX tests the infinity-norm routine IDAMAX. Tests are done
...
!  The other values of the vector are set to random values in [-1,1]
!  or to alternating NaN and random values.
!
!  Arguments
!  =========
!
...
!
!              Call IDAMAX to find the maximum element
!
               n = ns
               x(1:lenx) = xs(1:lenx)
               incx = incxs
               ibla = IDAMAX( n, x, incx )
!
