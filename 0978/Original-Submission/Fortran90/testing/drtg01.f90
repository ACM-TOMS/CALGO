subroutine DRTG01( likbla, f, g, cs, sn, r, result )
   use LA_CONSTANTS, only: wp, zero, one, ulp, safmax, safmin
   use LA_XISNAN
   use LA_XXVALS
!
...
!  =======
!
!  DRTG01 is an auxiliary test routine for DB1TRTG.  The input values
