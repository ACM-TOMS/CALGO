subroutine ZB1TDROT( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  ZB1TDROT tests the Level 1 BLAS subroutine ZDROT to apply
...
!
         do ir = 1, nr
           ...
           ss = svals(ir)
!
!          Call ZDROT to apply the rotation described by c and s
!
           n = ns
           x(1:lenx) = xs(1:lenx)
           incx = incxs
