...
*        the matrix V. 
*  = 'R' Numerical rank NUMRANK is determined and only NUMARNK right singular
...
*  the Householder vectorsas stored by ZGEQP3. If JOBU = 'F', these Househlder 
...
*  ZGEQP3. If, on entry, LCWORK = -1, then then a workspace query is  
...
*     exact zeros in ZGESVD() aplied to the (possibly truncated) 
