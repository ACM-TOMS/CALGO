...
static void dwt_step (const gsl_wavelet * w, MpIeee *a, size_t stride,
...
static void
dwt_step (const gsl_wavelet * w, MpIeee *a, size_t stride, size_t n,
          gsl_wavelet_direction dir, gsl_wavelet_workspace * work)
{
  MpIeee ai;MpIeee  ai1;
  size_t i, ii;
  size_t jf;
  size_t k;
...
int
 gsl_wavelet_transform(const gsl_wavelet * w, 
                       MpIeee *data, size_t stride, size_t n,
...
int
 gsl_wavelet2d_transform(const gsl_wavelet * w, 
                         MpIeee *data, size_t tda, size_t size1,
