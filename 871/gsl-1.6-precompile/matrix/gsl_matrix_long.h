...
int  gsl_matrix_long_scale(gsl_matrix_long * a, const MpIeee x);
int  gsl_matrix_long_add_constant(gsl_matrix_long * a, const MpIeee x);
int  gsl_matrix_long_add_diagonal(gsl_matrix_long * a, const MpIeee x);
