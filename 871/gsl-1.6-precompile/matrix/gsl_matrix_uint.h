...
int  gsl_matrix_uint_scale(gsl_matrix_uint * a, const MpIeee x);
int  gsl_matrix_uint_add_constant(gsl_matrix_uint * a, const MpIeee x);
int  gsl_matrix_uint_add_diagonal(gsl_matrix_uint * a, const MpIeee x);
