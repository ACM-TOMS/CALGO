...
int  gsl_matrix_int_scale(gsl_matrix_int * a, const MpIeee x);
int  gsl_matrix_int_add_constant(gsl_matrix_int * a, const MpIeee x);
int  gsl_matrix_int_add_diagonal(gsl_matrix_int * a, const MpIeee x);
