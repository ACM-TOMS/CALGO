...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { -0.162f, -0.108f };
   MpIeee X[] =  { 0.542f, 0.461f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.038016f, -0.133218f };
...

  {
   ...
   MpIeee X[] =  { 0.542f, 0.461f };
   int incX = -1;
   MpIeee x_expected[] =  { 0.542f, 0.461f };
   cblas_ctrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.547f, 0.583f };
   MpIeee X[] =  { -0.302f, 0.434f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.418216f, 0.061332f };
   cblas_ctrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee X[] =  { -0.302f, 0.434f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.302f, 0.434f };
   cblas_ctrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { 0.216f, 0.192f };
   MpIeee X[] =  { -0.564f, -0.297f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.178848f, 0.044136f };
   cblas_ctrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   MpIeee X[] =  { -0.564f, -0.297f };
   int incX = -1;
   MpIeee x_expected[] =  { -0.564f, -0.297f };
   cblas_ctrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int lda = 1;
   MpIeee A[] =  { 0.693, -0.22 };
   MpIeee X[] =  { -0.101, 0.889 };
   int incX = -1;
   MpIeee x_expected[] =  { 0.125587, 0.638297 };
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { -0.216, -0.623 };
   MpIeee X[] =  { 0.048, 0.293 };
   int incX = -1;
   MpIeee x_expected[] =  { 0.172171, -0.093192 };
   cblas_ztrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
...

  {
   ...
   int N = 1;
   int lda = 1;
   MpIeee A[] =  { -0.345, -0.851 };
   MpIeee X[] =  { -0.708, 0.298 };
   int incX = -1;
   MpIeee x_expected[] =  { -0.009338, -0.705318 };
   cblas_ztrmv(order, uplo, trans, diag, N, A, lda, X, incX);
   {
     int i;
     for (i = 0; i < 1; i++) {
