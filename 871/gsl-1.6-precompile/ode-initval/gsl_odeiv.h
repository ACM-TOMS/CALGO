...
typedef struct  
{
  int (* function) (MpIeee t, const MpIeee y[], MpIeee dydt[], void * params);
  int (* jacobian) (MpIeee t, const MpIeee y[], MpIeee * dfdy, MpIeee dfdt[], void * params);
  size_t dimension;
  void * params;
}
gsl_odeiv_system;
...
typedef struct 
{
  ...
  int  (*apply)  (void * state, size_t dim, MpIeee t, MpIeee h, MpIeee y[], MpIeee yerr[], const MpIeee dydt_in[], MpIeee dydt_out[], const gsl_odeiv_system * dydt);
...
int   gsl_odeiv_step_apply(gsl_odeiv_step *, MpIeee t, MpIeee h, MpIeee y[], MpIeee yerr[], const MpIeee dydt_in[], MpIeee dydt_out[], const gsl_odeiv_system * dydt);
...
typedef struct 
{
  const char * name;
  void * (*alloc) (void);
  int  (*init) (void * state, MpIeee eps_abs, MpIeee eps_rel, MpIeee a_y, MpIeee a_dydt);
  int  (*hadjust) (void * state, size_t dim, unsigned int  ord, const MpIeee y[], const MpIeee yerr[], const MpIeee yp[], MpIeee * h);
  void (*free) (void * state);
}
...
int  gsl_odeiv_control_init(gsl_odeiv_control * c, MpIeee eps_abs, MpIeee eps_rel, MpIeee a_y, MpIeee a_dydt);
void gsl_odeiv_control_free(gsl_odeiv_control * c);
int  gsl_odeiv_control_hadjust(gsl_odeiv_control * c, gsl_odeiv_step * s, const MpIeee y0[], const MpIeee yerr[], const MpIeee dydt[], MpIeee * h);
...
gsl_odeiv_control * gsl_odeiv_control_standard_new(MpIeee eps_abs, MpIeee eps_rel, MpIeee a_y, MpIeee a_dydt);
gsl_odeiv_control * gsl_odeiv_control_y_new(MpIeee eps_abs, MpIeee eps_rel);
gsl_odeiv_control * gsl_odeiv_control_yp_new(MpIeee eps_abs, MpIeee eps_rel);
 ...
 */
gsl_odeiv_control * gsl_odeiv_control_scaled_new(MpIeee eps_abs, MpIeee eps_rel, MpIeee a_y, MpIeee a_dydt, const MpIeee scale_abs[], size_t dim);
...
int  gsl_odeiv_evolve_apply(gsl_odeiv_evolve *, gsl_odeiv_control * con, gsl_odeiv_step * step, const gsl_odeiv_system * dydt, MpIeee * t, MpIeee t1, MpIeee * h, MpIeee y[]);
