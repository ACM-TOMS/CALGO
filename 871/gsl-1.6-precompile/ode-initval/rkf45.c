...
static const MpIeee ah[] =  { 1.0/4.0, 3.0/8.0, 12.0/13.0, 1.0, 1.0/2.0 };
static const MpIeee b3[] =  { 3.0/32.0, 9.0/32.0 };
static const MpIeee b4[] =  { 1932.0/2197.0, -7200.0/2197.0, 7296.0/2197.0};
static const MpIeee b5[] =  { 8341.0/4104.0, -32832.0/4104.0, 29440.0/4104.0, -845.0/4104.0};
static const MpIeee b6[] =  { -6080.0/20520.0, 41040.0/20520.0, -28352.0/20520.0, 9295.0/20520.0, -5643.0/20520.0};

static const MpIeee c1=  902880.0/7618050.0;
static const MpIeee c3=  3953664.0/7618050.0;
static const MpIeee c4=  3855735.0/7618050.0;
static const MpIeee c5=  -1371249.0/7618050.0;
static const MpIeee c6=  277020.0/7618050.0;

/* These are the differences of fifth and fourth order coefficients
   for error estimation */

static const MpIeee ec[] =  { 0.0,
  1.0 / 360.0,
  0.0,
  -128.0 / 4275.0,
  -2197.0 / 75240.0,
...
rkf45_alloc (size_t dim)
{
  ...
  state->k4 = (MpIeee*) malloc (dim * sizeof (MpIeee));
  ...
  state->k5 = (MpIeee*) malloc (dim * sizeof (MpIeee));
  ...
  state->k6 = (MpIeee*) malloc (dim * sizeof (MpIeee));
            ...
            MpIeee dydt_out[], const gsl_odeiv_system * sys)
{
  ...
  MpIeee *const k4=  state->k4;
  MpIeee *const k5=  state->k5;
  MpIeee *const k6=  state->k6;
  ...
  for (i = 0; i < dim; i++)
    {
      const MpIeee d_i=  c1 * k1[i] + c3 * k3[i] + c4 * k4[i] + c5 * k5[i] + c6 * k6[i];
      y[i] += h * d_i;
    }
