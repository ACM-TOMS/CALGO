...
typedef MpIeee(*gsl_siman_Efunc_t) (void *xp);
typedef void (*gsl_siman_step_t) (const gsl_rng *r, void *xp, MpIeee step_size);
typedef MpIeee(*gsl_siman_metric_t) (void *xp, void *yp);
...
typedef struct {
  ...
  MpIeee step_size;     /* max step size in the random walk */
  /* the following parameters are for the Boltzmann distribution */
  MpIeee k;MpIeee  t_initial;MpIeee  mu_t;MpIeee  t_min;
} gsl_siman_params_t;
