 ...
 */
int  gsl_sf_airy_Ai_e(const MpIeee x, const gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: none
 */
int  gsl_sf_airy_Ai_scaled_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: none
 */
int  gsl_sf_airy_Bi_scaled_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: GSL_EUNDRFLW
 */
int  gsl_sf_airy_Ai_deriv_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: GSL_EOVRFLW
 */
int  gsl_sf_airy_Bi_deriv_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: none
 */
int  gsl_sf_airy_Ai_deriv_scaled_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
 ...
 * exceptions: none
 */
int  gsl_sf_airy_Bi_deriv_scaled_e(const MpIeee x, gsl_mode_t mode, gsl_sf_result * result);
