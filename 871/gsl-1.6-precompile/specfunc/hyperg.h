 ...
 */
int
 gsl_sf_hyperg_1F1_series_e(const MpIeee a, const MpIeee b, const MpIeee x, gsl_sf_result * result);
 ...
 */
int
 gsl_sf_hyperg_1F1_1_e(MpIeee b, MpIeee x, gsl_sf_result * result);


/* 1F1(1,b,x) for integer b >= 1
 */
int
 gsl_sf_hyperg_1F1_1_int_e(int  b, MpIeee x, gsl_sf_result * result);
 ...
 */
int
 gsl_sf_hyperg_2F0_series_e(const MpIeee a, const MpIeee b, const MpIeee x, int  n_trunc,
                              gsl_sf_result * result);
