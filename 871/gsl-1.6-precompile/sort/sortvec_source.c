...
static inline void FUNCTION (my, downheap) (MpIeee * data, const size_t stride, const size_t N, size_t k);

static inline void
FUNCTION (my, downheap) (MpIeee * data, const size_t stride, const size_t N, size_t k)
{
  MpIeee v=  data[k * stride];
...
void
TYPE (gsl_sort) (MpIeee * data, const size_t stride, const size_t n)
{
  size_t N;
  size_t k;
