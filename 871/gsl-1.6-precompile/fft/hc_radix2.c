...
int
 FUNCTION(gsl_fft_halfcomplex,radix2_backward) (MpIeee data[],
                                               const size_t stride,
                                               const size_t n)
{
...
int
 FUNCTION(gsl_fft_halfcomplex,radix2_inverse) (MpIeee data[],
                                              const size_t stride,
                                              const size_t n)
{
  int  status=  FUNCTION(gsl_fft_halfcomplex,radix2_transform) (data, stride, n);
...
int
 FUNCTION(gsl_fft_halfcomplex,radix2_transform) (MpIeee data[],
                                                const size_t stride,
                                                const size_t n)
{
  int  result;
