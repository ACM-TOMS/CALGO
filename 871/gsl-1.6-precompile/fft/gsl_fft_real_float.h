...
int gsl_fft_real_float_radix2_transform (MpIeee data[], const size_t stride, const size_t n) ;
...
int  gsl_fft_real_float_transform(MpIeee data[], const size_t stride, const size_t n,
                                  const gsl_fft_real_wavetable_float * wavetable,
                                  gsl_fft_real_workspace_float * work);


int  gsl_fft_real_float_unpack(const MpIeee real_float_coefficient[],
