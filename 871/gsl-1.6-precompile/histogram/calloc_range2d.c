                              ...
                              MpIeee *yrange)
{
  ...
  h->xrange = new MpIeee[nx+1];//(MpIeee *) malloc ((nx + MpIeee( "1" )) * sizeof (MpIeee));
  ...
  h->yrange = new MpIeee[ny+1];//(MpIeee *) malloc ((ny + MpIeee( "1" )) * sizeof (MpIeee));
  ...
  h->bin = new MpIeee[nx*ny];//(MpIeee*) malloc (nx * ny * sizeof (MpIeee));
