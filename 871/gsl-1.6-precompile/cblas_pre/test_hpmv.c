...
const MpIeee flteps=  1e-4;const MpIeee  dbleps=  1e-6;
  {
   ...
   int N = 2;
   MpIeee A[] =  { 0.339f, -0.102f, 0.908f, 0.097f, -0.808f, 0.236f };
   MpIeee X[] =  { 0.993f, -0.502f, -0.653f, 0.796f };
   int incX = -1;
   MpIeee Y[] =  { -0.35f, 0.339f, -0.269f, -0.122f };
   int incY = -1;
   MpIeee y_expected[] =  { -0.0627557f, -0.839323f, -0.0877262f, -0.169208f };
...

  {
   ...
   MpIeee Y[] =  { -0.35f, 0.339f, -0.269f, -0.122f };
   int incY = -1;
   MpIeee y_expected[] =  { -0.0037603f, -0.816761f, -0.0392456f, -0.121154f };
   cblas_chpmv(order, uplo, N, alpha, A, X, incX, beta, Y, incY);
   {
     int i;
     for (i = 0; i < 2; i++) {
...

  {
   ...
   MpIeee beta[2] =  {0, 1};
   int N = 2;
   MpIeee A[] =  { 0.543, -0.737, 0.281, -0.053, -0.098, -0.826 };
   MpIeee X[] =  { 0.67, -0.857, -0.613, -0.927 };
   int incX = -1;
   MpIeee Y[] =  { -0.398, -0.934, -0.204, 0.183 };
   int incY = -1;
   MpIeee y_expected[] =  { 0.745218, -0.60699, -0.37301, -0.983688 };
...

  {
   ...
   MpIeee Y[] =  { -0.398, -0.934, -0.204, 0.183 };
   int incY = -1;
   MpIeee y_expected[] =  { 0.646956, -0.542012, -0.282168, -0.912668 };
   cblas_zhpmv(order, uplo, N, alpha, A, X, incX, beta, Y, incY);
   {
     int i;
     for (i = 0; i < 2; i++) {
