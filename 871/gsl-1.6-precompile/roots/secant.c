...
static int  secant_init(void * vstate, gsl_function_fdf * fdf, MpIeee * root);
static int  secant_iterate(void * vstate, gsl_function_fdf * fdf, MpIeee * root);

static int
 secant_init(void * vstate, gsl_function_fdf * fdf, MpIeee * root)
{
...
static int
 secant_iterate(void * vstate, gsl_function_fdf * fdf, MpIeee * root)
{
  secant_state_t * state = (secant_state_t *) vstate;
  
  const MpIeee x=  *root ;
  const MpIeee f=  state->f;
  const MpIeee df=  state->df;
