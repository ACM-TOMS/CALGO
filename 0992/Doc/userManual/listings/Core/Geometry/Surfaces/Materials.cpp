...
namespace cagd
{
    ...
    {
        Material black_plastique = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/black_plastique.pdf}}@*)
                 ...
                 black_rubber = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/black_rubber.pdf}}@*)
                        Color4(0.000000f, 0.000000f, 0.000000f, 0.4f),
                 ...
                 brass = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/brass.pdf}}@*)
                 ...
                 bronze = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/bronze.pdf}}@*)
                 ...
                 chrome = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/chrome.pdf}}@*)
                 ...
                 copper = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/copper.pdf}}@*)
                 ...
                 emerald = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/emerald.pdf}}@*)
                 ...
                 gold = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/gold.pdf}}@*)
                 ...
                 jade = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/jade.pdf}}@*)
                 ...
                 obsidian = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/obsidian.pdf}}@*)
                 ...
                 pearl = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/pearl.pdf}}@*)
                 ...
                 pewter = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/pewter.pdf}}@*)
                 ...
                 polished_bronze = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/polished_bronze.pdf}}@*)
                 ...
                 polished_copper = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/polished_copper.pdf}}@*)
                 ...
                 polished_gold = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/polished_gold.pdf}}@*)
                 ...
                 polished_silver = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/polished_silver.pdf}}@*)
                 ...
                 ruby = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/ruby.pdf}}@*)
                 ...
                 silver = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{\includegraphics{images/silver.pdf}}@*)
                ...
                turquoise = Material((*@\hspace*{\fill}\makebox[4.65cm][l]{$\includegraphics{images/turquoise.pdf}^{\footnote[9]{\Green{The model file mouse.off is the creation of the author. It was rendered by means of the proposed function library.}}}$}@*)
