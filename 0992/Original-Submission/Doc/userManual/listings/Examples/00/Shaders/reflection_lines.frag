...
uniform sampler2D sampler_2D_texture;    (*@\Green{// determines the currently active texture}\Suppressnumber{}@*)
...
const   float     TWO_PI = 2.0 * PI;    (*@\Suppressnumber{}@*)
...
void main()
{
    ...
    color = clamp(color, 0.0, 1.0); (*@\Suppressnumber{}@*)
(*@\Red{\rule{\textwidth}{0.75pt}}\Reactivatenumber{}@*)
