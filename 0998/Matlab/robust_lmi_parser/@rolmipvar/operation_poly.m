        ...
        for cont1=1:length(poly1.data)
            for cont2=1:length(poly2.data)
                for contsimplex = 1:length(poly1.data(cont1).exponent)
                    if (isempty(poly1.data(cont1).exponent{contsimplex}))
                        poly1.data(cont1).exponent{contsimplex} = 0;
                    end
                    if (isempty(poly2.data(cont2).exponent{contsimplex}))
                        poly2.data(cont2).exponent{contsimplex} = 0;
                    end
