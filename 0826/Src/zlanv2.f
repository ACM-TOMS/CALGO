...
*  =======
*
*  ZLANV2 computes the Schur factorization of a complex 2-by-2 nonhermitian
...
*     ..
*     .. Local Scalars ..
      COMPLEX*16         AA, BB, DD, TEMP, T, U, X, Y
*     ..
*     .. External Functions ..
      COMPLEX*16         ZLADIV
      EXTERNAL           ZLADIV
...
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, DCONJG, DIMAG, SQRT
*     ..
