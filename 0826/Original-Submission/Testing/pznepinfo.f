      SUBROUTINE PZNEPINFO( SUMMRY, NOUT, NMAT, NVAL, LDNVAL, NNB,
...
*  =======
*
*  PZNEPINFO gets needed startup information for PZHSEQR drivers
...
* ===== of an integer is equal to the length in bytes of a complex single
*       precision.
*
* ======================================================================
*
