...
*     .. Local Scalars ..
      ...
      COMPLEX*16       CDUM, H44, H33, H43H34, H00, H10, H11, H12, H21, 
     $                 H22, H44S, H33S, SUM, T1, T2, T3, V1, V2, V3
*     ..
*     .. Local Arrays ..
      COMPLEX*16       V( 3 )
*     ..
...
*           Find minimum
            DVAL = (CABS1(H10)*(CABS1(V2)+CABS1(V3))) / (ULP*TST1)   
            IVAL = IBULGE
     ...
     $                     CABS1( H22 ) )
               IF ( (DVAL.GT.(CABS1(H10)*(CABS1(V2)+CABS1(V3)))/
     $             (ULP*TST1)) .AND. ( DVAL .GT. RONE ) ) THEN
                  DVAL = (CABS1(H10)*(CABS1(V2)+CABS1(V3)))/(ULP*TST1)   
                  IVAL = I
               END IF
  15        CONTINUE
