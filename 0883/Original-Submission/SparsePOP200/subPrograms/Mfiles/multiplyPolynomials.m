function polyOut = multiplyPolynomials(poly1,poly2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% polyOut = poly1 * poly2                                        %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
tmpsupports = [];
tmpCoef = [];
for i=1:poly1.noTerms
	for j=1:poly2.noTerms
		supVec = poly1.supports(i,:)+poly2.supports(j,:); 
		tmpsupports = [tmpsupports; supVec];
		tmpCoef = [tmpCoef; poly1.coef(i,1)*poly2.coef(j,1)]; 
	end
end
polyIn.typeCone = poly1.typeCone;
polyIn.sizeCone = poly1.sizeCone;
polyIn.dimVar = poly1.dimVar;
polyIn.degree = poly1.degree + poly2.degree;
polyIn.noTerms = poly1.noTerms * poly2.noTerms; 
polyIn.supports = tmpsupports;
polyIn.coef = tmpCoef;
%
...
% $Header: /home/waki9/CVS_DB/SparsePOPdev/subPrograms/multiplyPolynomials.m,v 1.1.1.1 2007/01/11 11:31:50 waki9 Exp $
