function [objPoly,ineqPolySys,lbd,ubd] = example115(nDim);
...
ineqPolySys{i}.supports = [sparse(3,nDim)];
ineqPolySys{i}.supports(2,1) = 1;
ineqPolySys{i}.supports(3,nDim) = 1;
ineqPolySys{i}.coef     = ones(3,1);
