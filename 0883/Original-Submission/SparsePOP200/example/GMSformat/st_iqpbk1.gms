*  NLP written by GAMS Convert at 08/31/02 19:02:08
*  
*  Equation counts
*     Total       E       G       L       N       X       C
*         8       1       7       0       0       0       0
...
e8..  0.845*x1*x1 + 7*x1 + 0.5*x1*x2 + 6*x2 + x1*x3 + 5*x3 + 1.5*x1*x4 + 4*
     x4 + 2*x1*x5 + 3*x5 + 2.5*x1*x6 + 2*x6 + 3*x1*x7 + x7 + 3.5*x1*x8 + 0.5*x2
     *x1 + 0.845*x2*x2 + 0.5*x2*x3 + x2*x4 + 1.5*x2*x5 + 2*x2*x6 + 2.5*x2*x7 + 
     3*x2*x8 + x3*x1 + 0.5*x3*x2 + 0.845*x3*x3 + 0.5*x3*x4 + x3*x5 + 1.5*x3*x6
