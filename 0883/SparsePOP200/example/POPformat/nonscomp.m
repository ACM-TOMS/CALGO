function [objPoly,ineqPolySys,lbd,ubd] = nonscomp(nDim); 

% nonscomp(nDim);
% 
% The function in nondquar.mod 
% (http://www.sor.princeton.edu/%7Ervdb/ampl/nlmodels/cute/nonscomp.mod)
%
% <Input> 
...
for j=1:nDim-1
  ...
  poly{j+1}.supports(1,j+1)   = 1;
  poly{j+1}.supports(2,j) = 2;
  poly{j+1}.coef = [2;-2];
end
...
% $Header: /home/waki9/CVS_DB/SparsePOPdev/example/POPformat/nonscomp.m,v 1.1.1.1 2007/01/11 11:31:50 waki9 Exp $
