...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DHABAL( JOB, N, A, LDA, QG, LDQG, ILO, SCALE, INFO )
         IF ( INFO.NE.0 ) THEN
...
40          CONTINUE
     ...
     $                 N, ILO-1, QG(1,1), LDQG, DUMMY ) )
      ...
      END IF    
*
99999 FORMAT (' TDHABAL EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHABAL = ',I2)
