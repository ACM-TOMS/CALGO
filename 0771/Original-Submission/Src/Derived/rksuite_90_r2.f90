...
!enda!
interface setup
   module procedure setup_r2
end interface
interface range_integrate
   module procedure range_integrate_r2
end interface
interface step_integrate
   module procedure step_integrate_r2
end interface
interface statistics
   module procedure statistics_r2
end interface
interface global_error
   module procedure global_error_r2
end interface
interface reset_t_end
   module procedure reset_t_end_r2
end interface
interface interpolate
   module procedure interpolate_r2
end interface
interface set_stop_on_fatal
   module procedure set_stop_on_fatal_r2
end interface
interface get_saved_fatal
   module procedure get_saved_fatal_r2
end interface
interface collect_garbage
   module procedure collect_garbage_r2
end interface
