function[D]=second_compact_dirichlet_2dyy(n,p,y_l,y_r)
% M. Mehra & K. S. Patel
% Inputs
% n=number of grid points in y direction
% p=order of accuracy (p=4 or 6)
% y_l=left end of the interval (Default value is 0)
% y_r=right end of the interval (Default value is 1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Output
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 [D1]=second_compact_dirichlet(n,p,y_l,y_r);
