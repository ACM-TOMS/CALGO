...
C     ..
C     .. Array Arguments ..
      DOUBLE PRECISION X(I1:N),F(I1:N),WF(I1:N),Y(I1:N),WY(I1:N),
     +     SS(I1:N),G(0:KSECTN,I1:(N - I1 + 1)/2 + 1),
     +     RG(I1:(N - I1 + 1)/2 + 1),FT(I1:N),WFT(I1:N),FTNEG(I1:N),
     +     WY1(I1:N),Z(1:N + I1 - 1),WZ(1:N + I1 - 1),PAR(I1:N)
C
...
C     ..
C     .. Array Arguments ..
      DOUBLE PRECISION SS(I1:N),Y(I1:N),WY(I1:N),F(I1:N),WF(I1:N),
     +     Z(1:N + I1 - 1),WZ(1:N + I1 - 1),PAR(I1:N)
...
C     ..
C     .. Array Arguments ..
      DOUBLE PRECISION F(I1:N),Y(I1:N)
