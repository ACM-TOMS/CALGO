...
C     REVISIONS
C
C     V. Sima, Aug. 2009, Nov. 2009, Nov. 2010, Dec. 2010, June 2014.
...
C     .. Scalar Arguments ..
      ...
      INTEGER            DKIND
      PARAMETER          ( DKIND = KIND( CO1 ) )
      COMPLEX(DKIND) ::  SI1, SI2, SI3
C
C     .. Array Arguments ..
      COMPLEX(DKIND) ::  A( LDA, * ), B( LDB, * ), D( LDD, * )
C
C     .. Local Scalars ..
      COMPLEX(DKIND) ::  F, G, TMP
C
