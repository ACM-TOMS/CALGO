...
*     .. Parameters ..
     ...
     $                                   272 ),
     $                     LIWORK = MAX( 32, NMAX + 12, 2*NMAX + 1 ) )
*
*     .. Local Scalars ..
...
*        real part.
         CALL DGHUDF( COMPQ, ORTH, N, A, LDA, DE, LDDE, B, LDB, FG,
...
*
   ...
   50          CONTINUE
      ...
      STOP
*
99999 FORMAT( 'DGHUDF EXAMPLE PROGRAM RESULTS', 1X )
99998 FORMAT( 'N is out of range.', /, 'N = ', I5 )
99997 FORMAT( 'INFO on exit from DGHUDF = ', I2 )
