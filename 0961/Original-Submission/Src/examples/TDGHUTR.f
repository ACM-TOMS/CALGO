...
*     .. Parameters ..
     ...
     $                     LDWORK = 2*NMAX*NMAX + MAX( 4*NMAX, 32 ) + 4,
     $                     LIWORK = NMAX + 12 )
*
*     .. Local Scalars ..
...
*        pencil.
         CALL DGHUTR( JOB, COMPQ1, COMPQ2, N, A, LDA, DE, LDDE, C1,
...
*
         ...
         ELSE
*           Set to zero the lower triangle of F, to avoid reference to
*           undefined entries.
            CALL DLASET( 'L', M, M, ZERO, ZERO, F, LDF )
*
   ...
   90          CONTINUE
      ...
      STOP
*
99999 FORMAT( 'DGHUTR EXAMPLE PROGRAM RESULTS', 1X )
99998 FORMAT( 'N is out of range.', /, 'N = ', I5 )
99997 FORMAT( 'INFO on exit from DGHUTR = ', I2 )
