function test_skewHamileig
% Function for testing the routine DGHUTR. Random matrices of all
...
%
%   Revisions:
%   V. Sima, Dec. 2010, June 2014.
%   M. Voigt, July 2013.
%

disp(' ')
disp('Random tests of the routine DGHUTR')
disp(' ')
...
[ Alphar13, Alphai13, Beta13 ] = ...
                            skewHamileig( A, DE, C, VW, job0 );
[ Alphar14, Alphai14, Beta14 ] = ...
                            skewHamileig( A, DE, C, VW );
%
   ...
   for m = 0 : 20,
      ...
      for job = 0 : 1,
         ...
         [ Alphar, Alphai, Beta, Ao, Do, Bo, Fo, C1o, Vo, C2o, Q1, Q2 ] = ...
                            skewHamileig( A, DE, C, VW, job, cmpq11, cmpq21 );
...
if max_err < tol,
   disp( [ 'DGHUTR :    passed  -- maximum relative error max_err = ', num2str( max_err ) ] )
   disp( [ '            Number of problems solved                 = ', num2str( count   ) ] )
   disp( ' ' )
else
   disp( [ 'DGHUTR :    failed  -- maximum relative error max_err = ', num2str( max_err ) ] )
   disp( [ '            Number of problems solved                 = ', num2str( count   ) ] )
end
