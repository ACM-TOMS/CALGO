% Incident field that is a sum of two other incident fields.
%
%   Note: this is intended to be used only by the incident.plus method.
%
...
classdef incidentplus < incident
    ...
    methods
        ...
        function self = incidentplus(left,right)
