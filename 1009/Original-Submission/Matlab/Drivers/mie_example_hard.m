...
%
%   Scattering by a single scatterer with a sound hard boundary condition.
%
...
% setup scatterer (circle centred at 0 with unit radius and sound hard
% boundary condition).
s=scatterer(0,1,'HARD');
