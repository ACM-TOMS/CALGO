...
%
%   Scattering by a single scatterer with a Robin boundary condition.
%
...
% setup scatterer (circle centred at 0 with unit radius and Robin
% boundary condition).
s=scatterer(0,1,'ROBIN',10);
