...
%
%   Scattering by a single dielectric scatterer.
%
...
% setup scatterer (circle centred at 0 with unit radius and transmission
% boundary condition). Refractive index is 1.5.
s=scatterer(0,1,'DIELECTRIC',1.5);
