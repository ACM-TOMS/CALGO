% Regular wavefunction with zero coefficients.
%
%  u = regularzero(n,x,k) returns a regular wavefunction expansion object u
%  with order n, expansion origin x, wavenumber k and zero coefficient
%  vector.
%
% Note: in the above vectors in the plane are represented by
% complex numbers.
%
% See also: radiatingzero, regularwavefunctionexpansion.
%
