...
fprintf('T-matrix error estimate %0.2e \n(only valid for pure imaginary Robin constant)\n',tmat.error());

disp('Computed: Input/output independent  characterization of an absorbing trefoil')
%-----------------------------------------
...
shading interp;
colorbar
title('Total field (in the plane [-10,10]x[-10,10]) exterior to a trefoil absorbing scatterer')
