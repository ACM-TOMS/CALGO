...
*
*  -- ScaLAPACK routine (version 1.7.x) --
...
*
*  Parallel version by Robert Granat, Dept Computing Science, Umea
*    University, Sweden.
*
*  References:
...
*     .. External Subroutines ..
      EXTERNAL           PDSCAL, PDSWAP, PXERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
   20 CONTINUE
     ...
     $   GO TO 30
*
*     Use parallel swap routines from PBLAS
*
...
*
  190    CONTINUE
     ...
     $         GO TO 200
         ...
         NOCONV = .TRUE.
*
*     Call PBLAS scaling routines for maximum performance
*
