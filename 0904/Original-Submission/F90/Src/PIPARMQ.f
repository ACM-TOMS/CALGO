     ...
     $                          LWORKNB )
*
*  -- ScaLAPACK auxuliary routine (version 1.7.x) --
...
*       useful for PDHSEQR and its subroutines. It is called whenever 
...
*                        PIPARMQ(ISPEC=14) = 0 causes PTTQRE to skip a
*                        multi-shift QR sweep whenever early deflation
*                        finds a converged eigenvalue.  Setting
*                        PIPARMQ(ISPEC=14) greater than or equal to 100
*                        prevents PTTQRE from skipping a multi-shift
*                        QR sweep.
*
*              ISPEC=15: (NSHFTS) The number of simultaneous shifts in
*                        a multi-shift QR iteration.
*
*              ISPEC=16: (IACC22) PIPARMQ is set to 0, 1 or 2 with the
*                        following meanings.
*                        0:  During the multi-shift QR sweep,
*                            PxLAQR5 does not accumulate reflections and
*                            does not use matrix-matrix multiply to
*                            update the far-from-diagonal matrix
*                            entries.
*                        1:  During the multi-shift QR sweep,
*                            PxLAQR5 and/or xLAQRaccumulates reflections 
...
*
*       PIPARMQ(ISPEC=14) Nibble crossover point.  Default: 14.
*
...
*        .     get sent to PDLAHQR, the classic ScaLAPACK algorithm.
