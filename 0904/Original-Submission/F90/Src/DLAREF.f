...
*$OMP& PRIVATE(J,A1,A2,A3,A4,A5,B1,B2,B3,B4,B5,SUM1,SUM2,SUM3,A11,A22,
*$OMP&         H11,H22,TMP1,TMP2,TMP3), 
*$OMP& SHARED(A,ITMP1,ITMP2,IROW1,V2,V3,T1,T2,T3,V22,V32,T12,V23,V33,
*$OMP&        T13,T22,T32,T23,T33) 
*$OMP DO
#endif
...
*$OMP PARALLEL DEFAULT( NONE ), 
*$OMP& PRIVATE(J,SUM),
*$OMP& SHARED(A,ITMP1,ITMP2,IROW1,T1,T2,T3,V2,V3)
*$OMP DO
#endif
               DO 40 J = ITMP1, ITMP2
                  SUM = A( IROW1, J ) + V2*A( IROW1+1, J ) +
...
#ifdef USE_OMP
*$OMP PARALLEL DEFAULT( NONE ) 
*$OMP& PRIVATE(J,SUM,H11,H22), 
*$OMP& SHARED(A,ITMP1,ITMP2,ICOL1,V2,V3,T1,T2,T3,V22,V32,T12,V23,V33,
*$OMP&        T13,T22,T32,T23,T33) 
*$OMP DO
#endif
               DO 70 J = ITMP1, ITMP2
...
*$OMP PARALLEL DEFAULT( NONE ) 
*$OMP& PRIVATE(J,SUM,H11,H22), 
*$OMP& SHARED(Z,LILOZ,LIHIZ,ICOL1,V2,V3,T1,T2,T3,V22,V32,T12,V23,V33,
*$OMP&        T13,T22,T32,T23,T33) 
*$OMP DO
#endif
                  DO 80 J = LILOZ, LIHIZ
...
*$OMP PARALLEL DEFAULT( NONE ), 
*$OMP& PRIVATE(J,SUM),
*$OMP& SHARED(A,ITMP1,ITMP2,ICOL1,T1,T2,T3,V2,V3)
*$OMP DO
#endif
...
*$OMP PARALLEL DEFAULT( NONE ), 
*$OMP& PRIVATE(J,SUM),
*$OMP& SHARED(Z,LILOZ,LIHIZ,ICOL1,T1,T2,T3,V2,V3)
*$OMP DO 
#endif                  
