...
*          17 <= ISPEC <= 22:
*               Parameters for PDBTRSEN/PxHSEQR (not all), as follows:
...
*          =23: Maximum iteration chunksize in OpenMP parallelization
*
...
*
     ...
     $        170, 180, 190, 200, 210, 220, 230)ISPEC
*
...
*
  180 CONTINUE
*
*     ISPEC = 18: number of shifts in each window
*     
...
*
  230 CONTINUE
*
*     ISPEC = 23: maximum chunksize of iterations in OpenMP
*                 parallelization
*     
      PILAENVX = 32
      RETURN
