 ...
 * @author Juan F. Pérez
 */
public class DenseContMomentTest extends TestCase {
	...
	/**
	 * Matrix of the Dense Continuous Distribution
	 */
	double[][] matrix= {
	...
	/**
	 * Vector of the Dense Continuous Distribution
	 */
	...
	public static void main(String[] args) {
		//junit.swingui.TestRunner.run(DenseContMomentTest.class);
		junit.textui.TestRunner.run(DenseContMomentTest.class);
	}
	@Override
	...
	/**
	 * Test for the method jphase.DenseContPhaseVar.ExpectedValue
	 */
	...
	/**
	 * Test for the method jphase.DenseContPhaseVar.Variance
	 */
	...
	/**
	 * Test for the method jphase.DenseContPhaseVar.CV
	 */
	public void testCV() {
	...
	/**
	 * Test for the method jphase.DenseContPhaseVar.moment
	 */
