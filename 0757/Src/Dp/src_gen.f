...
C
     ...
     4     THREE,TWO,X,XHIGH1,XLOW1,XNEG1,XVALUE,Z,ZERO,D1MACH
...
C
     ...
     &     X,XLOW,XUPPER,XVALUE,ZERO,D1MACH
      DATA ZERO,HALF,ONE/0.0 D 0 , 0.5 D 0 , 1.0 D 0/
      DATA ONEHUN/100.0 D 0/
...
C
     ...
     2      TWO,X,XLOW,XUPPER,XVALUE,ZERO,D1MACH
...
C
     ...
     2     T,TWO,X,XHIGH,XLOW,XVALUE,ZERO,D1MACH
...
C
     ...
     2     X,XHIGH,XLOW,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*26
      DATA FNNAME/'I0INT '/
...
C
     ...
     2     X,XHIGH,XLOW,XSQ,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*14
      DATA FNNAME/'I1ML1 '/
      DATA ERRMSG/'ARGUMENT < 0.0'/
      DATA ZERO,ONE,TWO/ 0.0 D 0 , 1.0 D 0 , 2.0 D 0 /
...
C
     ...
     3     XHIGH,XLOW,XVALUE,ZERO,D1MACH
...
C
     ...
     4     XLOW2,XLOW3,XR,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*26
      DATA FNNAME/'LOBACH'/
      DATA ERRMSG/'ARGUMENT TOO LARGE IN SIZE'/
      DATA ZERO,HALF/ 0.0 D 0 , 0.5 D 0 /
...
C
     ...
     3     XK,XK1,XLOW0,XLOW1,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*14
      DATA FNNAME/'STROM '/
      DATA ERRMSG/'ARGUMENT < 0.0'/
      DATA ZERO,HALF,ONE/ 0.0 D 0 , 0.5 D 0 , 1.0 D 0/
...
C
     ...
     3     XHIGH2,XLOW,XPOWTH,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*14
      DATA FNNAME/'SYNCH1'/
      DATA ERRMSG/'ARGUMENT < 0.0'/
      DATA ZERO,HALF,ONE/ 0.0 D 0 , 0.5 D 0 , 1.0 D 0 /
...
C
     ...
     &     XHIGH3,XK,XK1,XLOW1,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*14
      DATA FNNAME/'TRAN02'/
      DATA ERRMSG/'ARGUMENT < 0.0'/
      DATA ZERO,HALF,ONE/ 0.0 D 0 , 0.5 D 0 , 1.0 D 0 /
...
C
      ...
      DOUBLE PRECISION ATRAN(0:19),CHEVAL,EIGHT,FOUR,HALF,ONE,ONEHUN,RK,
     &     RNUMJN,SUMEXP,SUM2,T,VALINF,X,XHIGH1,XHIGH2,
     &     XHIGH3,XK,XK1,XLOW1,XLOW2,XVALUE,ZERO,D1MACH
      CHARACTER FNNAME*6,ERRMSG*14
      DATA FNNAME/'TRAN03'/
      DATA ERRMSG/'ARGUMENT < 0.0'/
      DATA ZERO,HALF,ONE/ 0.0 D 0 , 0.5 D 0 , 1.0 D 0/
...
C
     ...
     4     XLOW,XMPI4,XVALUE,ZERO,D1MACH
