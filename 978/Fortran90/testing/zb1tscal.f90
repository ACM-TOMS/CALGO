subroutine ZB1TSCAL( nn, nvals, nix, ixvals, nal, alvals, lenx, x, xs, &
...
!  =======
!
!  ZB1TSCAL tests the scaling routine ZSCAL.
!
!  Arguments
!  =========
!
...
!
       do k = 1, nal
         alphas = alvals(k)
!
!        Call ZSCAL to scale the vector x
!
         n = ns
         alpha = alphas
         x(1:lenx) = xs(1:lenx)
...
!
         ...
         call ZARGCKX( nerrs, subnam, 'X', lenx, iwork, x, xs, nout )
