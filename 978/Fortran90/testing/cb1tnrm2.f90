subroutine CB1TNRM2( nn, nvals, nix, ixvals, lenx, x, xs, z, &
      work, thresh, nout )
   use LA_CONSTANTS32, only: wp, zero, ulp, half, one, two, three, four, &
...
!  =======
!
!  CB1TNRM2 tests the 2-norm routine SCNRM2.  Tests are done with
