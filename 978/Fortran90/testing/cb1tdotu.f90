subroutine CB1TDOTU( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  CB1TDOTU tests the dot product routine CDOTU.
!
...
!
!            Call CDOTU to compute the dot product of x and y
!
             n = ns
             x(1:lenx) = xs(1:lenx)
             incx = incxs
...
!
             ...
             call CARGCKV( nerrs, subnam, 'Y', lenx, y, ys, nout )
