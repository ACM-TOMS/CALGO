subroutine ZB1TDOTU( nn, nvals, nix, ixvals, lenx, x, y, xs, ys, &
...
!  =======
!
!  ZB1TDOTU tests the dot product routine ZDOTU.
!
...
!
!            Call ZDOTU to compute the dot product of x and y
!
             n = ns
             x(1:lenx) = xs(1:lenx)
             incx = incxs
