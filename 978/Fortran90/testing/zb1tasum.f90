subroutine ZB1TASUM( nn, nvals, nix, ixvals, lenx, x, xs, z, &
      work, thresh, nout )
...
!  =======
!
!  ZB1TASUM tests the 1-norm routine DZASUM. Tests are done with
...
!
!          Call DZASUM to compute the 1-norm
!
           n = ns
           x(1:lenx) = xs(1:lenx)
           incx = incxs
           snrm = DZASUM( n, x, incx )
!
