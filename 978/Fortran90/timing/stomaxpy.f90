subroutine STOMAXPY( n, nrep, nal, alvals, x, ldx, y, ldy, xs, ys, &
                     thresh, nout )
...
!  ..
!
!  STOMAXPY times SAXPY from the Level 1 BLAS, a subroutine to compute
...
!
     ...
     t1 = SECOND()
     do j = 1, nrep
       call SAXPY( n, alpha, x(1,j), incx, y(1,j), incy )
     end do
     t2 = SECOND()
     tottim = t2 - t1
     write(nout,99) 'SAXPY ', ns, alphas, tottim / nrep
!
