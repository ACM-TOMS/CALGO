subroutine ZTOMDSCAL( n, nrep, nal, alvals, x, ldx, xs, work, thresh, nout )
...
!  ..
!
!  ZTOMDSCAL times ZDSCAL from the Level 1 BLAS, a subroutine to scale a
...
!
     ...
     t1 = DSECND()
     do j = 1, nrep
       call ZDSCAL( n, alpha, x(1,j), incx )
     end do
     t2 = DSECND()
     tottim = t2 - t1
     write(nout,99) 'ZDSCAL', ns, alphas, tottim / nrep
!
