subroutine CTOMSSCAL( n, nrep, nal, alvals, x, ldx, xs, work, thresh, nout )
...
!  ..
!
!  CTOMSSCAL times CSSCAL from the Level 1 BLAS, a subroutine to scale a
...
!  .. Local Scalars ..
   ...
   real(wp) :: alpha, alphas, t1, t2, tottim, tmax, trat, xnrm
...
!
     ...
     t1 = SECOND()
     do j = 1, nrep
       call CSSCAL( n, alpha, x(1,j), incx )
     end do
     t2 = SECOND()
     tottim = t2 - t1
     write(nout,99) 'CSSCAL', ns, alphas, tottim / nrep
!
