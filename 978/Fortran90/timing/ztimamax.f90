subroutine ZTIMAMAX( n, nrep, x, xs, work, rtim, nout )
...
!  ..
!
!  ZTIMAMAX times IZAMAX from the Level 1 BLAS, a function to find
...
!
   ...
   t1 = DSECND()
   do j = 1, nrep
     ibla(j) = IZAMAX( n, x, incx )
   end do
   t2 = DSECND()
   tottim = t2 - t1
   rtim = tottim / nrep
!  write(nout,99) 'IZAMAX', ns, rtim
!
