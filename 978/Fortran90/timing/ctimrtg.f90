subroutine CTIMRTG( n, nrep, x, y, z, xs, ys, work, thresh, rtim, nout )
...
!  ..
!
!  CTIMRTG times CLARGV from LAPACK, a subroutine to compute a vector
...
!
       ...
       do j = 1, nrep
         ...
         z(1:n) = rogue
         incz = inczs
         call CLARGV( n, x, incx, y, incy, z, incz )
       end do
       t2 = SECOND()
       tottim = t2 - t1
...
!
       ...
       worst(1:ntests) = zero
       do i = 1, ns
         call CRTG01( sx*xs(i), sy*ys(i), z(i), y(i), x(i), result )
!
