...
//******************************************************************************
// lcg64Panel class defines a panel for entering and translating parameters of
// "64 bit Linear Congruential Generator".
//******************************************************************************

public class lcg64Panel
       extends ParmGrpPanel
{
   ...
   //***************************************************************************
   // The constructor constructs lcg64Panel with owner <wizard>.
   //---------------------------------------------------------------------------
   public lcg64Panel(TestWizard wizard) {
      // Set up a group panel that will contain six parameter fields.
      super("64 bit Linear Congruential Generator (lcg64)", 6);
