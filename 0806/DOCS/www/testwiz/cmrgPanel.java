...
//******************************************************************************
// cmrgPanel class defines a panel for entering and translating parameters of
// "Combine Mulitple Reacursive Generator".
//******************************************************************************

public class cmrgPanel
       extends ParmGrpPanel
{
   ...
   //***************************************************************************
   // The constructor constructs cmrgPanel with owner <wizard>.
   //---------------------------------------------------------------------------
   public cmrgPanel(TestWizard wizard) {
      // Set up a group panel that will contain six parameter fields.
      super("Combined Multiple Recursive Generator (cmrg)", 6);
