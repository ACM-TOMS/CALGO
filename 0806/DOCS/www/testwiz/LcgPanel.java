...
//******************************************************************************
// LcgPanel class defines a panel for entering and translating parameters of
// "48 bit Linear Congruential Generator".
//******************************************************************************

public class LcgPanel
       extends ParmGrpPanel
{
   ...
   //***************************************************************************
   // The constructor constructs LcgPanel with owner <wizard>.
   //---------------------------------------------------------------------------
   public LcgPanel(TestWizard wizard) {
      // Set up a group panel that will contain six parameter fields.
      super("48 bit Linear Congruential Generator (lcg)", 6);
