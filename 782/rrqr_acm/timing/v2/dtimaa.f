...
*     .. External Subroutines ..
      EXTERNAL           DTIMMM, DTIMMV, DTIMQP, DTIMQR,
     $                   DTIMRR
*     ..
*     .. Scalars in Common ..
...
*     next line but don't time DGEMV.
*
      ...
      ELSE
         WRITE( NOUT, FMT = 9990 )
*
*        Time DGEMV and DGEMM.
*
         CALL DTIMMV( 'DGEMV ', NN, NVAL, NNB, NBVAL, NLDA,
     $                LDAVAL, TIMMIN, A( 1, 1 ), LA, A( 1, 2 ),
     $                A( 1, 3 ), RESLTS, LDR1, LDR2, NOUT )
         CALL DTIMMM( 'DGEMM ', 'N', NN, NVAL, NLDA, LDAVAL,
...
*
      IF( .NOT.LSAME( C1, 'Dprecision' ) ) THEN
...
*        QR routines
*
         CALL DTIMQR( LINE, NN, MVAL, NVAL, NK, KVAL, NNB, NBVAL,
...
*        Rank-Revealing QR
*
         CALL DTIMRR( LINE, NM, MVAL, NVAL, NK, KVAL,
