      SUBROUTINE STIMRR( LINE, NM, MVAL, NVAL, NK, KVAL, NNB,
...
*  =======
*
*  STIMRR times the routines to perform the Rank-Revealing QR
...
*     .. External Subroutines ..
      EXTERNAL           ATIMCK, ATIMIN, SGEQPX, SGEQPY,
     $                   SLACPY, SLATMS
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          REAL, MIN
...
*
                     ...
                     END IF
*
*                    SGEQPX:  Rank-Revealing QR factorization
*
  ...
  110                CONTINUE
*
                     CALL SGEQPX( JOB, M, N, K, A, LDA, B, LDA,
...
*
  ...
  120       CONTINUE
            WRITE( NOUT, FMT = * )
            CALL SPRTB4( '(  NB,  NX)', 'M', 'N', NNB, NBVAL, NXVAL,
...
*
                     ...
                     END IF
*
*                    SGEQPY:  Rank-Revealing QR factorization
*
                     CALL SLACPY( 'All', M, N, COPYA, LDA, A, LDA )
                     IC = 0
                     S1 = SECOND( )
  230                CONTINUE
*
                     CALL SGEQPY( JOB, M, N, K, A, LDA, B, LDA,
     $                            IWORK, IRCOND, ORCOND, RANK, SVLUES,
     $                            WORK, LW, INFO )
                     S2 = SECOND( )
*
