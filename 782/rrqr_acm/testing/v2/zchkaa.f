...
*  =======
*
*  ZCHKAA is the main test program for the COMPLEX*16 linear
*  equation routines.
*
...
*  ZRR    3               List types on next line if 0 < NTYPES <  3
*
*  Internal Parameters
*  ===================
*
...
*
      IF( .NOT.LSAME( C1, 'Z precision' ) ) THEN
...
*
         IF( TSTCHK ) THEN
            CALL ZCHKQP( DOTYPE, NM, MVAL, NN, NVAL, THRESH,
...
*
         IF( TSTCHK ) THEN
            CALL ZCHKRR( DOTYPE, NM, MVAL, NN, NVAL, NNB, NBVAL,
...
*
 ...
 9995 FORMAT( ' Invalid input value: ', A4, '=', I6, '; must be <=',
     $      I6 )
 9993 FORMAT( ' RRQR Tests. COMPLEX*16 LAPACK routines ',
