      SUBROUTINE CGEQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
     $                   ORCOND, RANK, SVLUES, WORK, LWORK, RWORK,
     $                   INFO )
*
...
*  =======
*
*  CGEQPY computes a QR factorization
*       A*P = Q*[ R11 R12 ]
*               [  0  R22 ]
...
*     =============
*
      CALL CGEQPB( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
     $             ORCOND, RANK, SVLUES, WORK, LWORK, RWORK, INFO )
      WSIZE = REAL( WORK( 1 ) )
*
*     Postprocessing
*     ==============
*
      IF( RANK.GT.0 ) THEN
         CALL CTRQPY( JOB, M, N, K, A, LDA, C, LDC, JPVT, IRCOND,
