...
double complex *OMP_LTsamples_ode (unsigned int NXval, double Xval[], unsigned int N, double complex S[], double tol, int THREADS);
...
**/
{
    ...
    char *LTS = "LT samples by solving ODE problems by means of ode.c";
    printf("%s", str);
              ...
              double *ABSERR,double *RELERR,double *PS_ERR,int thrds1,int thrds2)
{
    ...
    switch (jFUN)
    {
        case 1 : /* (modified Talbot's method coarse-grain parallelism */
            IFAIL_tot = OMP_Talbot11_DE ( OMP_LTsamples_ode, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;

        case 2 : /* modified Talbot's method fine-grain parallelism */
            IFAIL_tot = OMP_Talbot12_DE ( OMP_LTsamples_ode, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;
        ...
        case 3 : /* modified Talbot's method hybrid fine/coarse-grain parallelism */
            ...
            #endif
            IFAIL_tot = OMP_Talbot13_DE ( OMP_LTsamples_ode, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1,thrds2);
            break;
