...
double complex *OMP_LTsamples_twpbvp (unsigned int NXval, double Xval[], unsigned int N, double complex S[], double tol, int THREADS);
...
/** RUN AS:
            ./ex4_acc.exe tol thrds1
    OR AS:
            ./ex4_acc.exe tol thrds1 thrds2     [for nested parallelism]
**/
{
    ...
    case 4 :
        /* ./ex4_acc.exe tol threads1 threads2 [nested parallelism] */
    ...
    char *LTS = "LT samples by solving ODE problems by means of twpbvp.f";
    printf("%s", str);
              ...
              double *ABSERR,double *RELERR,double *PS_ERR,int thrds1,int thrds2)
{
    ...
    switch (jFUN)
    {
        case 1 : /* (modified Talbot's method coarse-grain parallelism */
            IFAIL_tot = OMP_Talbot11_DE ( OMP_LTsamples_twpbvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;

        case 2 : /* modified Talbot's method fine-grain parallelism */
            IFAIL_tot = OMP_Talbot12_DE ( OMP_LTsamples_twpbvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;
        ...
        case 3 : /* modified Talbot's method hybrid fine/coarse-grain parallelism */
            ...
            #endif
            IFAIL_tot = OMP_Talbot13_DE ( OMP_LTsamples_twpbvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1,thrds2);
            break;
