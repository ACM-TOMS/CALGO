...
echo "           Example 5 - LT samples by a function"
echo ""
echo "\nWhich test?\n"
echo "        1)  On accuracy"
...
1)	# 1) BUILD THE EXECUTABLE (ACCURACY)
	...
	echo "                ./ex5_acc.exe tol thrds1\n"
	echo "          or"
	echo "                ./ex5_acc.exe tol thrds1 thrds2\n"
	echo "          where\n"
	echo "             tol: tolerance"
	echo "             thrds1,thrds2 are the number of parallel threads"
	echo "\n-------------------------------------------------\n"
	./ex5_acc.exe 1e-12 4 2
	;;
2)	# 1) BUILD THE EXECUTABLE (TIMES)
	...
	echo "\n-------------------------------------------------\n"
	echo "2) run the executable:\n"
	echo "                ./ex5_time.exe tol jFUN NTval NXval\n"
	echo "          where"
	echo "                tol : tolerance"
