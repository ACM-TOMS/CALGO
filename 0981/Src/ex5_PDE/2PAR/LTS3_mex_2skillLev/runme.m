...
elseif isunix % MATLAB + Unix
    OPTS = ' ''CFLAGS="\$CFLAGS -fopenmp"'' -lgomp ';                   % Link without time library (time is measured in MATLAB)
...
%% BUILD EXECUTABLES
FILENAMES = ['./OMP_Talbot11_SUM_mex.c ' TALBOTdir '/COM/COM_Talbot_pack.c ' TALBOTdir '/COM_DE/COM_Talbot_pack_DE.c ' TALBOTdir '/FUN_DE/OMP_Talbot_pack_DE.c'];
