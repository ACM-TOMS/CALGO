...
%% singularities
NOSING=1;   SINGS=3i;    MULT=2;    sigma0=0;
...
switch choice
    ...
    %%%%%%%%%%%%%%%%%%%%%%
        ...
        PARtime1 = NaN(numel(NTval),numel(NXval)); % SEQ_TalbotSUM1
        LTStime1 = NaN(numel(NTval),numel(NXval));
        SUMtime1 = NaN(numel(NTval),numel(NXval));
        TOTtime1 = NaN(numel(NTval),numel(NXval));

        PARtime2 = NaN(numel(NTval),numel(NXval)); % SEQ_TalbotSUM2
        LTStime2 = NaN(numel(NTval),numel(NXval));
        SUMtime2 = NaN(numel(NTval),numel(NXval));
        TOTtime2 = NaN(numel(NTval),numel(NXval));
