...
echo.
@echo on
gcc -o ex4_acc.exe ./OMP_main_ACCURACY.o ./OMP_LTsamples_ode.o ./ode.o ./ILTfun2.o ./LTsings2.o ./COM_Talbot_pack.o ./COM_Talbot_pack_DE.o ./OMP_Talbot_pack_DE.o -lm -lgomp
