...
echo.
@echo on
gcc -o ex2_time.exe ./OMP_main_TIMES.o ./OMP_LTsamples_ode.o ./ode.o ./LTsings2.o ./COM_Talbot_pack.o ./COM_Talbot_pack_DE.o ./OMP_Talbot_pack_DE.o -lm -lgomp
