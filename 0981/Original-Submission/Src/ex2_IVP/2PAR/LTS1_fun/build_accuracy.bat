...
echo.
@echo on
gcc -o ex2_acc.exe ./OMP_main_ACCURACY.o ./OMP_LTsamples_fun.o ./LTfun2.o ./ILTfun2.o ./LTsings2.o ./COM_Talbot_pack.o ./COM_Talbot_pack_DE.o ./OMP_Talbot_pack_DE.o -lm -lgomp
...
echo.
echo     ex2_acc tol thrds1
echo     or
echo     ex2_acc tol thrds1 thrds2
echo.
echo     where:
echo.
