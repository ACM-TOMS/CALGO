...
double complex *OMP_LTsamples_bvp (unsigned int NXval, double Xval[], unsigned int N, double complex S[], double tol, int THREADS);
 ...
 */
{
    ...
    double Xmin= 0.0,  Xmax= 1.0;   /* endpoints of the interval for x */
    unsigned int NTval=5;           /* number of t values              */
    double Tmin=100, Tmax=500;      /* endpoints of the interval for t */

    char *LTS = "LT samples by solving ODE problems by means of MATLAB bvp5c.m + PCT";
    mexPrintf("%s", str);
    ...
    RELERR1 = rel_err (1,NTval,Tmin,Tmax,NXval,Xmin,Xmax,tol,thrds1,thrds2);
    RELERR2 = rel_err (2,NTval,Tmin,Tmax,NXval,Xmin,Xmax,tol,thrds1,thrds2);
    RELERR3 = rel_err (3,NTval,Tmin,Tmax,NXval,Xmin,Xmax,tol,thrds1,thrds2);
...
double *rel_err (unsigned int jFUN, unsigned int NTval, double Tmin, double Tmax, unsigned int NXval, double Xmin, double Xmax, double tol, int thrds1, int thrds2)
{
    ...
    switch (jFUN)
    {
        case 1 : /* modified Talbot's method coarse grain parallelism */
            IFAIL_tot = OMP_Talbot11_DE ( OMP_LTsamples_bvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;

        case 2 : /* modified Talbot's method fine-grain parallelism */
            IFAIL_tot = OMP_Talbot12_DE ( OMP_LTsamples_bvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1);
            break;
        ...
        case 3 : /* modified Talbot's method hybrid fine/coarse-grain parallelism */
            ...
            #endif
            IFAIL_tot = OMP_Talbot13_DE ( OMP_LTsamples_bvp, sigma0,NXval,x,NTval,t,tol,NUMft,IFAIL,Nsings,SINGS,MULT,Tmin,Tmax,thrds1,thrds2);
            break;
