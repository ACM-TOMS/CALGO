...
*/
{
    ...
    unsigned int NTval[]={5,20,120},
                 NXval[]={5,20,120};       /* number of x, t values */

    double Xmin=0.0,     Xmax=1.0;    /* endpoints */
    ...
    for (h=0; h<NT; h++)        /* Tval[h] */
        ...
        {
            SEQ_PDE_skill_MAIN (SEQ_LTsamples_twpbvp,1,NTval[h],Tmin,Tmax,NXval[k],Xmin,Xmax,tol,&PARtime1[h][k],&LTStime1[h][k],&SUMtime1[h][k],&TOTtime1[h][k]);
            SEQ_PDE_skill_MAIN (SEQ_LTsamples_twpbvp,1,NTval[h],Tmin,Tmax,NXval[k],Xmin,Xmax,tol,&PARtime1[h][k],&LTStime1[h][k],&SUMtime1[h][k],&TOTtime1[h][k]);
            /* chiama 2 volte Talbot1 per ammortizzare l'inizializzazione dei cicli for */
            SEQ_PDE_skill_MAIN (SEQ_LTsamples_twpbvp,2,NTval[h],Tmin,Tmax,NXval[k],Xmin,Xmax,tol,&PARtime2[h][k],&LTStime2[h][k],&SUMtime2[h][k],&TOTtime2[h][k]);
        }


    /* DISPLAY TIME'S MATRICES: 0 (LT function), 1 (LT twpbvp.f), 2 (LT bvp5c.m) */
    char ch = '%';
    printf("\n\ttol = %e\n\n", tol);
/* ------------------------------------------------------------------------------------- */
    printf("PARtime1 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("LTStime1 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("SUMtime1 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("TOTtime1 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("PARtime2 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("LTStime2 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("SUMtime2 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
    ...
    printf(  "            ];\n");
/* ------------------------------------------------------------------------------------- */
    printf("TOTtime2 = [%c", ch);    for (k=0; k<NX; k++)    printf("%13d  ", NXval[k]);
    printf("= NXval\n");
    for (h=0; h<NT; h++)
    {   printf(  "            ");
