...
*****************************************
*
10     call drive_sfgmres(n,n,m,lwork,work,
...
* gmres iteration 
           call scopy(n,work(colx),1,work(irc(6)+n),1)
 20        call drive_sgmres(n,n,m2,irc(7),
...
* Perform the matrix vector product for the inner GMRES iteration
             call sgemv('N',n,n,ONE,a,lda,work(colx2),1,
     &                 ZERO,work(colz2),1)
             goto 20
...
*      work(colz) <-- work(colx) work(coly)
             call sgemv('C',n,nbscal2,ONE,work(colx2),n,
     &               work(coly2),1,ZERO,work(colz2),1)
             goto 20
           endif
           call scopy(n,work(irc(6)),1,work(colz),1)
           goto 10
         else
* (m2.le.0)
