...
CFPP$ UNROLL
            DO 501 LC = 1, NPDE
      A(N,IC,1,1) = A(N,IC,1,1) - A(N,IC,LC,-7)*A(LLDG(N,-7),LC,1,8) - A
     1   (N,IC,LC,-6)*A(LLDG(N,-6),LC,1,7) - A(N,IC,LC,-3)*A(LLDG(N,-3),
     2   LC,1,4) - A(N,IC,LC,-2)*A(LLDG(N,-2),LC,1,3)
      A(N,IC,1,2) = A(N,IC,1,2) - A(N,IC,LC,-8)*A(LLDG(N,-8),LC,1,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,1,6) - A(N,IC,LC,-1)*A(N-1,LC,1,3)
      A(N,IC,1,3) = A(N,IC,1,3) - A(N,IC,LC,-7)*A(LLDG(N,-7),LC,1,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,1,7) - A(N,IC,LC,-1)*A(N-1,LC,1,4)
      A(N,IC,1,4) = A(N,IC,1,4) - A(N,IC,LC,-6)*A(LLDG(N,-6),LC,1,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,1,8)
      A(N,IC,1,5) = A(N,IC,1,5) - A(N,IC,LC,-9)*A(LLDG(N,-9),LC,1,8) - A
     1   (N,IC,LC,-3)*A(LLDG(N,-3),LC,1,7) - A(N,IC,LC,-2)*A(LLDG(N,-2),
     2   LC,1,6)
      A(N,IC,1,6) = A(N,IC,1,6) - A(N,IC,LC,-4)*A(LLDG(N,-4),LC,1,9) - A
     1   (N,IC,LC,-1)*A(N-1,LC,1,7)
      A(N,IC,1,7) = A(N,IC,1,7) - A(N,IC,LC,-3)*A(LLDG(N,-3),LC,1,9) - A
     1   (N,IC,LC,-1)*A(N-1,LC,1,8)
      A(N,IC,1,8) = A(N,IC,1,8) - A(N,IC,LC,-2)*A(LLDG(N,-2),LC,1,9)
      A(N,IC,2,1) = A(N,IC,2,1) - A(N,IC,LC,-7)*A(LLDG(N,-7),LC,2,8) - A
     1   (N,IC,LC,-6)*A(LLDG(N,-6),LC,2,7) - A(N,IC,LC,-3)*A(LLDG(N,-3),
     2   LC,2,4) - A(N,IC,LC,-2)*A(LLDG(N,-2),LC,2,3)
      A(N,IC,2,2) = A(N,IC,2,2) - A(N,IC,LC,-8)*A(LLDG(N,-8),LC,2,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,2,6) - A(N,IC,LC,-1)*A(N-1,LC,2,3)
      A(N,IC,2,3) = A(N,IC,2,3) - A(N,IC,LC,-7)*A(LLDG(N,-7),LC,2,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,2,7) - A(N,IC,LC,-1)*A(N-1,LC,2,4)
      A(N,IC,2,4) = A(N,IC,2,4) - A(N,IC,LC,-6)*A(LLDG(N,-6),LC,2,9) - A
     1   (N,IC,LC,-5)*A(LLDG(N,-5),LC,2,8)
      A(N,IC,2,5) = A(N,IC,2,5) - A(N,IC,LC,-9)*A(LLDG(N,-9),LC,2,8) - A
     1   (N,IC,LC,-3)*A(LLDG(N,-3),LC,2,7) - A(N,IC,LC,-2)*A(LLDG(N,-2),
     2   LC,2,6)
      A(N,IC,2,6) = A(N,IC,2,6) - A(N,IC,LC,-4)*A(LLDG(N,-4),LC,2,9) - A
     1   (N,IC,LC,-1)*A(N-1,LC,2,7)
      A(N,IC,2,7) = A(N,IC,2,7) - A(N,IC,LC,-3)*A(LLDG(N,-3),LC,2,9) - A
     1   (N,IC,LC,-1)*A(N-1,LC,2,8)
      A(N,IC,2,8) = A(N,IC,2,8) - A(N,IC,LC,-2)*A(LLDG(N,-2),LC,2,9)
  501       CONTINUE
  400       CONTINUE
            DO 503 LC = 1, IC-1
CDIR$ IVDEP
