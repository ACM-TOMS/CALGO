...
Ccc PARAMETER SPECIFICATION:
     ...
     +   LENRWK, IWK(LENIWK), LENLWK, IERR
      LOGICAL LWK(LENLWK)
      REAL TN, TE, DT, DTMIN, DTMAX, XL, YF, ZD, XR, YB, ZU, DX, DY, DZ,
...
Ccc PARAMETER SPECIFICATION:
      ...
      REAL XL, YF, ZD, XR, YB, ZU, DX, DY, DZ, XYZ(*)
C
Ccc PURPOSE:
...
Ccc PARAMETER SPECIFICATION:
     ...
     +   LBLWY(0:NPTS), LABVY(0:NPTS), LBLWZ(0:NPTS), LABVZ(0:NPTS)
      ...
      REAL T, U(0:NPTS*NPDE), X(NPTS), Y(NPTS), Z(NPTS),
     +   SPCTOL(NPDE), TOLWGT,
...
C PARAMETER SPECIFICATION:
     ...
     +   LBLWY(0:*), LABVY(0:*), LBLWZ(0:*), LABVZ(0:*)
      REAL T, X(*), Y(*), Z(*), UNP1(0:*), UN(0:*), UNM1(0:*),
...
Ccc PARAMETER SPECIFICATION:
      ...
      REAL X(*), Y(*), Z(*), UIB(*), UNP1(0:*), UN(0:*), UNM1(0:*),
...
Ccc PARAMETER SPECIFICATION:
      INTEGER NPTS, NPDE, LLBND(0:*), ILBND(*), LBND(*)
      REAL F(*), T, X(*), Y(*), Z(*), DT, DTRAT, DX, DY, DZ,
     +   U(*), UIB(*), UT(*), UX(*), UY(*), UZ(*),
...
Ccc PARAMETER SPECIFICATION:
      ...
      REAL AD(NPTS,NPDE,NPDE,-9:9), X(NPTS,NPDE), Y(NPTS,NPDE)
C
Ccc PURPOSE:
...
C
      ...
      REAL FACX, FACY, FACZ, FACXX, FACYY, FACZZ, TOL
...
C
      INTEGER I, JC, LENU
      REAL FACX, FACY, FACZ, FACXX, FACYY, FACZZ
C
      LENU  = NPTS*NPDE
C
      FACXX = 1/DX**2
...
C
      INTEGER I, LENU
      REAL DG, EPS, FACX, FACY, FACZ, FACXX, FACYY, FACZZ
C
      EPS = SQRT(UROUND)
C
      LENU  = NPTS*NPDE
...
Ccc PARAMETER SPECIFICATION:
     ...
     +   LROW(*), IROW(*), ICOL(*)
      REAL T, XL, YF, ZD, DX, DY, DZ, U(NPTS,NPDE)
C
Ccc PURPOSE:
