...
*     nodes and weights necessary for the ordinary Laguerre
*     quadrature.
*
...
*
      ...
      REAL*16             deltaw(MAXPTS),           exact,       relavg
...
40000 FORMAT (2X, I5, 1P, 1X, E43.34, 1X, E43.34, 1X, E10.2, 2X, 0P, 1X,
     X    F9.2, 1X, F9.2)
50000 FORMAT (2X, I5, 1P, 1X, E43.34, 1X, E43.34, 1X, E10.2, 2X,
     X    1X, E9.2, 0P, 1X, F9.2)
60000 FORMAT (/, 2X, 'alpha = ', F20.16, '  nquad = ', I6)
70000 FORMAT (/, 2X, 'Done')
80000 FORMAT (I1, 1X, I3, 1X, 1P, E43.34, 1X, I10, 1X, E43.34,
     X    1X, E9.2, 1X, E9.2)
