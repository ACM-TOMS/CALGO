...
*     Local variables
*
      DOUBLE PRECISION    alpha,       exact,       factn,       mu
      DOUBLE PRECISION    mumax,       mumin,       munp2,       qp
      DOUBLE PRECISION    relavg,      relerr,      relmax,      relmin
      DOUBLE PRECISION    relulp,      result,      ulp
      DOUBLE PRECISION    v(2,MAXPTS), w(MAXPTS),   wxm1(MAXPTS)
      DOUBLE PRECISION    x(MAXPTS),   y(MAXPTS),   z(MAXPTS)
