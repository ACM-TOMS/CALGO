function [probs,funs,bcfuns,dfuns,dbcfuns,esolus,setoutputs,settolerancess]=bvpT23(ExtraArgs)
...
if nargin==1 && ~isempty(ExtraArgs)
    ...
    function Df = dfun(X,Z,ExtraArgs)
        ...
        Df(1,2,:) = 1.0e0;
        Df(2,1,:) = cosh(Z(1,1,:)/lambda)/(lambda*lambda);
    end
