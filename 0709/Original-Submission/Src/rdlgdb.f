      SUBROUTINE ZZRDLG ( UNIT, LIST, NDATA, NPERLN, RECNO )
...
C
C>RCS $HEADER: RDLG.F,V 1.10 91/11/19 16:17:14 BUCKLEY EXP $
C>RCS $LOG:     RDLG.F,V $
C>RCS REVISION 1.10  91/11/19  16:17:14  BUCKLEY
C>RCS FINAL SUBMISSION TO TOMS
C>RCS
C>RCS REVISION 1.9  89/06/30  13:29:03  BUCKLEY
C>RCS PREPARING SUBMITTED VERSION OF MT
C>RCS
C>RCS REVISION 1.3.1.1  89/05/20  13:39:39  BUCKLEY
C>RCS TEMP. TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.3  89/05/18  14:26:54  BUCKLEY
C>RCS FINAL TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.2  89/05/15  14:44:44  BUCKLEY
...
C
C## E N T R Y   P O I N T S: THE NATURAL ENTRY ZZRDLG.
