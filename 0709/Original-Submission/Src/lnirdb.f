...
C!!!! REAL             FP, FMIN, ALPHA, AP, DGLAST, DG0, ZZMPAR, ANGLE
      DOUBLE PRECISION DGP, DGAL, NRMD, NRMG, FLAST, EPS, ETA
C!!!! REAL             DGP, DGAL, NRMD, NRMG, FLAST, EPS, ETA
      DOUBLE PRECISION TP0, TP1, TP2, NRMX, ACOS, PI, RADS, WIDTH, DUMMY
C!!!! REAL             TP0, TP1, TP2, NRMX, ACOS, PI, RADS, WIDTH, DUMMY
      DOUBLE PRECISION STG, UTG, NU, SIGMA, GAMMA, MU
C!!!! REAL             STG, UTG, NU, SIGMA, GAMMA, MU
...
C!!!! NRMX   = MAX ( ONE, REAL(INNER (N,X,X,DONORM,IW,RW,DW)) )
      QUADON = F
