...
C-----OTHER DECLARATIONS.
      ...
      REAL             CUMERR, AVDIGS, DF, DX
C!!!! DOUBLE PRECISION CUMERR, AVDIGS, DF, DX

      REAL             ACC, FACTOR, CUMMTM, CUMFTM, CUMPTM, RD
C!!!! DOUBLE PRECISION ACC, FACTOR, CUMMTM, CUMFTM, CUMPTM, RD

      REAL             USER(NU), FARG(FNO), MING, MAXG
C!!!! DOUBLE PRECISION USER(NU), FARG(FNO), MING, MAXG

      REAL             F, GSQ, TMIN, TFUN, TPRINT, RATIO, MXERR, DIGS
C!!!! DOUBLE PRECISION F, GSQ, TMIN, TFUN, TPRINT, RATIO, MXERR, DIGS
...
99821 FORMAT (  1X, A70 / 1X, A70 /
     ...
     -       ' DERV= ', I2, 1X, '(', A10,')' /
     -       ' MEMORY:', I6, ' REAL VALUES;',
C!!!!-       ' MEMORY:', I6, ' D.P. VALUES;',
...
99907 FORMAT ( A,  18X, 'STORAGE USE IS ', I6,
     -                  ' SINGLE PRECISION REALS.', 13X, '!' )
C!!!!-                  ' DOUBLE PRECISION REALS.', 13X, '!' )
...
99935 FORMAT ( A, I3, I3, 1X, A8, I3, I4, I4, I4,
     -    E9.2, E8.2, F7.3, F7.3, I2, I4, I4 , I4, '!' )
C!!!!-    D9.2, D9.2, F7.3, F7.3, I2, I4, I4 , I4, '!' )
