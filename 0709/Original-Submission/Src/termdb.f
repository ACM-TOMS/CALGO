...
C## A R G U M E N T S:
                      ...
                      DOUBLE PRECISION EPS, G(N), XI(N), XIM1(N), FX
C!!!!                 REAL             EPS, G(N), XI(N), XIM1(N), FX
...
C-----DECLARATIONS FOR ENTRY POINT DUMMY ARGUMENTS.
      ...
      DOUBLE PRECISION   VGSQ, VXSQ, VDIFSQ, FX0, SF0, NG0, SNG0
C!!!! REAL               VGSQ, VXSQ, VDIFSQ, FX0, SF0, NG0, SNG0
