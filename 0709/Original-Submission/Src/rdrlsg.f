      SUBROUTINE ZZRDRL ( UNIT, LIST, NDATA, NPERLN, RECNO )

C## A R G U M E N T S:
                         INTEGER           UNIT, NDATA, NPERLN, RECNO

                         REAL              LIST(*)
C!!!!                    DOUBLE PRECISION  LIST(*)
...
C
C>RCS $HEADER: RDRL.F,V 1.10 91/11/19 16:17:15 BUCKLEY EXP $
C>RCS $LOG:     RDRL.F,V $
C>RCS REVISION 1.10  91/11/19  16:17:15  BUCKLEY
C>RCS FINAL SUBMISSION TO TOMS
C>RCS
C>RCS REVISION 1.9  89/06/30  13:29:05  BUCKLEY
C>RCS PREPARING SUBMITTED VERSION OF MT
C>RCS
C>RCS REVISION 1.3.1.1  89/05/20  13:39:40  BUCKLEY
C>RCS TEMP. TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.3  89/05/18  14:26:55  BUCKLEY
C>RCS FINAL TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.2  89/05/15  14:44:46  BUCKLEY
...
C
C     THIS ROUTINE READS THE INFORMATION FROM 'UNIT' INTO THE
...
C
C## E N T R Y   P O I N T S: THE NATURAL ENTRY ZZRDRL.
