      SUBROUTINE ZZWRLG ( UNIT, LIST, NDATA, NPERLN, RECNO )
...
C
C>RCS $HEADER: WRLG.F,V 1.10 91/11/19 16:19:03 BUCKLEY EXP $
C>RCS $LOG:     WRLG.F,V $
C>RCS REVISION 1.10  91/11/19  16:19:03  BUCKLEY
C>RCS FINAL SUBMISSION TO TOMS
C>RCS
C>RCS REVISION 1.9  89/06/30  13:29:11  BUCKLEY
C>RCS PREPARING SUBMITTED VERSION OF MT
C>RCS
C>RCS REVISION 1.3.1.1  89/05/20  13:39:45  BUCKLEY
C>RCS TEMP. TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.3  89/05/18  14:27:01  BUCKLEY
C>RCS FINAL TEST OF MT BEFORE SUBMITTING
C>RCS
C>RCS REVISION 1.2  89/05/15  14:45:04  BUCKLEY
...
C               WRITTEN.
C
C## E N T R Y   P O I N T S: THE NATURAL ENTRY ZZWRLG.
