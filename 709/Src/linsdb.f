...
C## A R G U M E N T S:
      ...
      DOUBLE PRECISION FV, DG, ALPHA, F0, DG0, DGP, FP, AP, WIDTH
C!!!! REAL             FV, DG, ALPHA, F0, DG0, DGP, FP, AP, WIDTH
...
C-----GENERAL DECLARATIONS.
      ...
      DOUBLE PRECISION LB, FLB, DGLB, UB, TP0, AT
C!!!! REAL             LB, FLB, DGLB, UB, TP0, AT
