...
*
        subroutine cgmres(n,m,b,x,H,w,r0,V,yCurrent,xCurrent,rotSin,
...
* ----------------------
       integer  irc(*)
       complex x(*), H(m+1,*), w(*), r0(*), V(n,*), yCurrent(*)
...
*
         call caxpy(jH,ONE,r0,1,H(1,jH),1)
         call cgemv('N',n,jH,-ONE,V(1,1),n,r0,1,ONE,w,1)
         dloo = scnrm2(jH,r0,1)**2
       endif
*
*         dnormw = scnrm2(n,w,1)
*
