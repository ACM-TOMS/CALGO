*     DHAPVB/DOSGPV EXAMPLE PROGRAM TEXT
*
*     .. Parameters ..
      IMPLICIT NONE
...
*     .. External Subroutines ..
      EXTERNAL         DGEMM, DHAPVB, DLACPY, DLASET, DOSGPV, DSCAL,
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DHAPVB( N, 1, A, LDA, QG, LDQG, CS, TAU, DWORK, LDWORK,
     $                INFO )
         INFO = 0
         IF ( INFO.NE.0 ) THEN
...
C
     ...
     $                LDRES, DWORK )
      ...
      END IF    
*
99999 FORMAT (' TDHAPVB EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHAPVB = ',I2)
