*     DGESUV/DOSGSU EXAMPLE PROGRAM TEXT
*
*     .. Parameters ..
      IMPLICIT NONE
...
*     .. External Functions ..
      ...
      EXTERNAL         DLANGE, DLAORS, DLAPY2, LSAME
*     .. External Subroutines ..
      EXTERNAL         DGEMM, DGESUV, DLACPY, DLASET, DOSGSU
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DGESUV( TRANA, TRANB, N, 1, A, LDA, B, LDB, G, LDG, Q,
     $                LDQ, CSL, CSR, TAUL, TAUR, DWORK, LDWORK, INFO )
         ...
         ELSE
            ...
            CALL DOSGSU( 'U', TRANA, N, 1, U1, LDU1, U2, LDU2, CSL,
     $                   TAUL, DWORK, LDWORK, INFO )
            ...
            ELSE
               ...
               CALL DOSGSU( 'V', TRANB, N, 1, V1, LDV1, V2, LDV2,
...
20                   CONTINUE
                     WRITE ( NOUT, FMT = 99991 ) DLAORS( .FALSE., 
...
40                   CONTINUE
                     WRITE ( NOUT, FMT = 99991 ) DLAORS( .TRUE., 
     $                       .FALSE., N, U1, LDU1, U2, LDU2,
     $                       RES(1,4*N+1), LDRES ) 
                  END IF
...
100                  CONTINUE
                     WRITE ( NOUT, FMT = 99989 ) DLAORS( .TRUE.,
...
120                  CONTINUE
                     WRITE ( NOUT, FMT = 99989 ) DLAORS( .FALSE.,
     $                       .TRUE., N, V1, LDV1, V2, LDV2,
     $                       RES(1,4*N+1), LDRES )
                  END IF
               END IF
...
*
      STOP
*
99999 FORMAT (' TDGESUV EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DGESUV = ',I2)
99997 FORMAT (' INFO on exit from DOSGSU = ',I2)
