...
*
         CALL DHASUB( WHICH, METH, STAB, BALANC, ORTBAL, SELECT, N, ILO,
     $                SCALE, S, LDS, T, LDT, G, LDG, U1, LDU1, U2,
     $                LDU2, V1, LDV1, V2, LDV2, WR, WI, US, LDUS,
     $                UU, LDUU, 2*N, M, LWORK, IWORK, DWORK, LDWORK,
     $                INFO )
*
         IF ( INFO.NE.0 ) THEN
...
60                CONTINUE
     ...
     $                 RES, LDRES, DWORK )
      ...
      END IF    
*
99999 FORMAT (' DHASUB EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHASUB = ',I2)
