*     DHAPVL/DOSGPV EXAMPLE PROGRAM TEXT
*
*     .. Parameters ..
      IMPLICIT NONE
...
*     .. External Subroutines ..
      EXTERNAL         DGEMM, DHAPVL, DLACPY, DLASET, DOSGPV, DSCAL,
     $                 DSYMM, DSYR, DSYR2K, DTRMM
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DHAPVL( N, 1, A, LDA, QG, LDQG, CS, TAU, DWORK, LDWORK,
     $                INFO )
         INFO = 0
         IF ( INFO.NE.0 ) THEN
...
70             CONTINUE
C
               WRITE ( NOUT, FMT = 99990 )  DLANHA( 'Hamiltonian',
     ...
     $                LDRES, DWORK )
      ...
      END IF    
*
99999 FORMAT (' TDHAPVL EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHAPVL = ',I2)
