...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DSHBAL( JOB, N, A, LDA, QG, LDQG, ILO, SCALE, INFO )
         IF ( INFO.NE.0 ) THEN
...
40          CONTINUE
     ...
     $                 N-1, ILO-1, QG(2,1), LDQG, DUMMY ) )
      ...
      END IF    
*
99999 FORMAT (' TDSHBAL EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DSHBAL = ',I2)
