*     DGESUB/DOSGSU EXAMPLE PROGRAM TEXT
*
*     .. Parameters ..
      IMPLICIT NONE
...
*     .. External Subroutines ..
      EXTERNAL         DGEMM, DGESUB, DLACPY, DLASET, DOSGSU
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DGESUB( TRANA, TRANB, N, 1, A, LDA, B, LDB, G, LDG, Q,
...
*
      STOP
*
99999 FORMAT (' TDGESUB EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DGESUB = ',I2)
