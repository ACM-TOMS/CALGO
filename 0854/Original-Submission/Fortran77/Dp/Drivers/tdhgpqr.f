...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DHGPQR( 'S', 'I', 'I', N, ILO, IHI, A, LDA, B, LDB, Q,
...
*
      STOP
*
99999 FORMAT (' TDHGPQR EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHGPQR = ',I2)
