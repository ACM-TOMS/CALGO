*     DSHPVL/DOSGPV EXAMPLE PROGRAM TEXT
*
*     .. Parameters ..
      IMPLICIT NONE
...
*     .. External Subroutines ..
      EXTERNAL         DGEMM, DLACPY, DLASET, DOSGPV, DSHPVL, DSKMV,
     $                 DSKR2K, DTRMM
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         CALL DSHPVL( N, 1, A, LDA, QG, LDQG, CS, TAU, DWORK, LDWORK,
     $                INFO )
         INFO = 0
         IF ( INFO.NE.0 ) THEN
...
C
     ...
     $                LDRES, DWORK )
      ...
      END IF    
*
99999 FORMAT (' TDSHPVL EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DSHPVL = ',I2)
