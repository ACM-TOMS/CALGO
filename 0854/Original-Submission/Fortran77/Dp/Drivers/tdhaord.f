...
*     .. External Functions ..
      LOGICAL          LSAME
      DOUBLE PRECISION DLAORS
      EXTERNAL         DLAORS, LSAME
...
*     Skip the heading in the data file and read the data.
      ...
      ELSE
         ...
         END IF
         CALL DHAORD( TYP, COMPU, SELECT, LOWER, N, A, LDA, G, LDG, U1,
...
50             CONTINUE
      ...
      END IF
*
99999 FORMAT (' DHAORD EXAMPLE PROGRAM RESULTS',/1X)
99998 FORMAT (' INFO on exit from DHAORD = ',I2)
