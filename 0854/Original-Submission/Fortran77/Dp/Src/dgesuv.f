      SUBROUTINE DGESUV( TRANA, TRANB, N, ILO, A, LDA, B, LDB, G, LDG,
...
C     .. Array Arguments ..
      DOUBLE PRECISION  A(LDA,*), B(LDB,*), G(LDG,*), Q(LDQ,*), CSL(*),
     $                  CSR(*), DWORK(*), TAUL(*), TAUR(*)
C     .. Local Scalars ..
      LOGICAL           LTRA, LTRB
      INTEGER           I
...
C
     ...
     $                     LDG, DWORK )
         ...
         ELSE
            TAUL(I) = ZERO
         END IF
         IF ( I.LT.N )  ALPHA = Q(I,I+1)
         IF ( I.LT.N-1 ) THEN
C
C           Generate elementary reflector HV(i) to annihilate Q(i,i+2:n)
C
            CALL DLARFG( N-I, ALPHA, Q(I,I+2), LDQ, Q(I,I+1) )
C
