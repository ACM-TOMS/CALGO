      DOUBLE PRECISION FUNCTION DLANSH( TYPE, NORM, N, A, LDA, QG,
     $                                  LDQG, DWORK )
      IMPLICIT NONE
C
C     PURPOSE
...
C             Specifies the value to be returned in DLANSH:
...
C     CONTRIBUTOR
C
C     D. Kressner, Technical Univ. Berlin, Germany, August 2002.
C
C     KEYWORDS
C
