      SUBROUTINE DHABAL( JOB, N, A, LDA, QG, LDQG, ILO, SCALE, INFO )
      IMPLICIT NONE
C
C     PURPOSE
C
C     DHABAL balances a real Hamiltonian matrix,
C
C                   [  A   G  ]
C              H =  [       T ] ,
C                   [  Q  -A  ]
...
C             with rows and columsn j and j+N, resprectively. If
...
C     .. External Subroutines ..
      EXTERNAL          DSCAL, DRSCL, DSWAP, XERBLA
