// $Id: APPSPACK_Executor_Interface.hpp,v 1.9 2004/11/23 22:26:01 tgkolda Exp $ 
...
public:
  ...
  /*!  
    ...
    \param isF_out - True if there was a valid, finite function value
    \param f_out - The function value (only has meaning if isF is true)
